...
function Quests___Talking_Points takes nothing returns nothing
	...
	set text = text + "- Adding replay value. This is rather open-ended, and there is plenty of room for more ideas. Some current ones: more game modes; randomized checkpoint locations; obstacles; new settings; additional round types; new slates; more strategies.\n"
