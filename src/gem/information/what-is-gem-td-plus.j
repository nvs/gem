...
function Gem_Information___What_Is_Gem_TD_Plus takes nothing returns nothing
	...
	set text = text + "For further information and discussion on the map, to view the leaderboards, or to report bugs and other issues, visit:|n"
	set text = text + "- " + Color__Link (Gem__WEBSITE_REPOSITORY) + "|n"
