function Quests___What_Is_Gem_TD_Plus takes nothing returns nothing
	...
	set text = text + "For general map discussion, or anything Gem related, please visit the Gem TD+ forum (located at the ENT Gaming website): " + Color__Link (Gem__WEBSITE_FORUM) + "\n\n"

	set text = text + "For more development centric information and discussion, or to report bugs and other issues, please see the Gem TD+ repository: " + Color__Link (Gem__WEBSITE_REPOSITORY) + "\n\n"
