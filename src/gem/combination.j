...
function Gem_Combination___Recipe takes nothing returns boolean
	...
	// Ensure that the new and old units share share the exact position.
	// Otherwise, the new unit will be aligned to `0.250` boundaries.  This
	// matters mostly for slates, which can be positioned anywhere.
