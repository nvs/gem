...
function Quests___Version_1_0_RC_1_Part_1 takes nothing returns nothing
	local quest the_quest = CreateQuest ()
	local string text = ""

	call QuestSetTitle (the_quest, Gem__NAME + " 1.0-rc.1 [1 of 3]")
...
function Quests___Version_1_0_RC_1_Part_2 takes nothing returns nothing
	local quest the_quest = CreateQuest ()
	local string text = ""

	call QuestSetTitle (the_quest, Gem__NAME + " 1.0-rc.1 [2 of 3]")
	call QuestSetIconPath (the_quest, Quests___CHANGELOG_ICON)
	call QuestSetRequired (the_quest, false)
	call QuestSetDiscovered (the_quest, true)
	call QuestSetCompleted (the_quest, false)
...
function Quests___Version_1_0_RC_1_Part_3 takes nothing returns nothing
	local quest the_quest = CreateQuest ()
	local string text = ""

	call QuestSetTitle (the_quest, Gem__NAME + " 1.0-rc.1 [3 of 3]")
	call QuestSetIconPath (the_quest, Quests___CHANGELOG_ICON)
	call QuestSetRequired (the_quest, false)
	call QuestSetDiscovered (the_quest, true)
	call QuestSetCompleted (the_quest, false)
...
function Quests__Setup takes nothing returns nothing
	...
	// Changelogs:
	call Quests___Version_1_0_RC_1_Part_1 ()
	call Quests___Version_1_0_RC_1_Part_2 ()
	call Quests___Version_1_0_RC_1_Part_3 ()
endfunction
