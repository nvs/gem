...
-- Damage:
FrameDef.DAMAGETIP_HERO = '180% damage to Red armor.                                80%  damage to Pink armor.                                 80%  damage to Blazed armor.                             50%  damage to Green armor.'
FrameDef.DAMAGETIP_MAGIC = '190% damage to Blazed armor.                            80%  damage to White armor.                              70%  damage to Green armor.                              40%  damage to Blue armor.'
FrameDef.DAMAGETIP_MELEE = '160% damage to White armor.                              120% damage to Red armor.                                 60%  damage to Yellow armor.                              20%  damage to Pink armor.'
FrameDef.DAMAGETIP_NORMAL = '175% damage to Blue armor.'
FrameDef.DAMAGETIP_PIERCE = '175% damage to Pink armor.                               80%  damage to other armors.'
FrameDef.DAMAGETIP_SIEGE = '170% damage to Green armor.                            150% damage to Pink armor.                                70%  damage to other armor types.'
FrameDef.DAMAGETIP_CHAOS = '160% damage to Yellow armor.                            120% damage to Pink armor.                                70%  damage to Green armor.                              60%  damage to White armor.                              50%  damage to Red armor.'
