function Gem_Changelog___1_5_1 takes nothing returns nothing
	...
	set text = text + "    - Reduced base chance to cast Blood Lightning from `40%` to `20%`.\n"
	set text = text + "    - Each additional Blood Stone or Ancient Blood Stone increases the chance to cast Blood Lightning by `10%`.\n"
	set text = text + "\n"
