...
function Settings_Window___Core takes nothing returns boolean
	...
	if not Settings_Window___Displayed_Information then
		...
		call DisplayTimedTextToPlayer (GetLocalPlayer (), Settings___TEXT_DISPLAY_X, Settings___TEXT_DISPLAY_Y, Settings___COUNTDOWN_TIME, "Please be patient, game settings are currently")
		call DisplayTimedTextToPlayer (GetLocalPlayer (), Settings___TEXT_DISPLAY_X, Settings___TEXT_DISPLAY_Y, Settings___COUNTDOWN_TIME, "being selecting and confirmed.")
	...
	if Settings_Window___Player_Index == Gem__MAXIMUM_PLAYERS then
		...
		call TimerDialogSetTitle (Settings_Window___Timer_Dialog, Player_Color__Text (Settings_Window___Player_Index, Player_Color__Word (Settings_Window___Player_Index, false)) + " is selecting:")
