function InitGlobals takes nothing returns nothing
	...
	loop
		exitwhen(i>10)
		set udg_WslotOccupied[i]=false
		set i=i+1
	endloop
	set i=0
	loop
		exitwhen(i>8)
		set udg_Wspinning[i]=false
		set i=i+1
	endloop
	set i=0
	loop
		exitwhen(i>4)
		set udg_Slot1Numbers[i]=0
		set i=i+1
	endloop
	set i=0
	loop
		exitwhen(i>4)
		set udg_Slot2Numbers[i]=0
		set i=i+1
	endloop
	set i=0
	loop
		exitwhen(i>4)
		set udg_Slot3Numbers[i]=0
		set i=i+1
	endloop
	set i=0
	loop
		exitwhen(i>4)
		set udg_Slot4Numbers[i]=0
		set i=i+1
	endloop
	set i=0
	loop
		exitwhen(i>8)
		set udg_BJPlaying[i]=false
		set i=i+1
	endloop
	set i=0
	loop
		exitwhen(i>8)
		set udg_BJDealersNO[i]=0
		set i=i+1
	endloop
	set i=0
	loop
		exitwhen(i>8)
		set udg_BJPlayerNO[i]=0
		set i=i+1
	endloop
	set i=0
	loop
		exitwhen(i>8)
		set udg_BJp1stcard[i]=0
		set i=i+1
	endloop
	set i=0
	loop
		exitwhen(i>8)
		set udg_BJp2ndcard[i]=0
		set i=i+1
	endloop
	set i=0
	loop
		exitwhen(i>8)
		set udg_BJpAnotherCard[i]=0
		set i=i+1
	endloop
	set i=0
	loop
		exitwhen(i>8)
		set udg_BJPfin[i]=false
		set i=i+1
	endloop
	set i=0
	loop
		exitwhen(i>8)
		set udg_BJdanothCard[i]=0
		set i=i+1
	endloop
	set i=0
	loop
		exitwhen(i>8)
		set udg_BJplayersTurnHit[i]=true
		set i=i+1
	endloop
	set i=0
	loop
		exitwhen(i>8)
		set udg_BJDfin[i]=false
		set i=i+1
	endloop
	set i=0
	loop
		exitwhen(i>8)
		set udg_BJhitTurnFIN[i]=false
		set i=i+1
	endloop
	set i=0
	loop
		exitwhen(i>8)
		set udg_BJDfinHit[i]=false
		set i=i+1
	endloop
	set i=0
	loop
		exitwhen(i>8)
		set udg_BJD1stHit[i]=true
		set i=i+1
	endloop
	set i=0
	loop
		exitwhen(i>8)
		set udg_BJCanHit[i]=true
		set i=i+1
	endloop
	set i=0
	loop
...
function InitSounds takes nothing returns nothing
	...
	set gg_snd_SlotStartSpin=CreateSound("Abilities\\Spells\\Human\\AerialShackles\\MagicLariatLoop1.wav",false,true,true,10,10,"SpellsEAX")
	call SetSoundParamsFromLabel(gg_snd_SlotStartSpin,"AerialShacklesLoop")
	call SetSoundDuration(gg_snd_SlotStartSpin,3230)
	set gg_snd_StopSlot=CreateSound("Abilities\\Spells\\Human\\Defend\\DefendCaster.wav",false,true,true,10,10,"SpellsEAX")
	call SetSoundParamsFromLabel(gg_snd_StopSlot,"Defend")
	call SetSoundDuration(gg_snd_StopSlot,1167)
	...
	set gg_snd_Gold2sym=CreateSound("Abilities\\Spells\\Items\\SpellShieldAmulet\\SpellShieldImpact1.wav",false,true,true,10,10,"SpellsEAX")
	call SetSoundParamsFromLabel(gg_snd_Gold2sym,"SpellShieldAmulet")
	call SetSoundDuration(gg_snd_Gold2sym,476)
	set gg_snd_Gold4sym=CreateSound("Units\\Orc\\BatTroll\\TrollbatriderYesAttack1.wav",false,true,true,10,10,"DefaultEAXON")
	call SetSoundParamsFromLabel(gg_snd_Gold4sym,"TrollBatriderYesAttack")
	call SetSoundDuration(gg_snd_Gold4sym,1625)
	...
	set gg_snd_PlayerBust=CreateSound("Units\\Undead\\Varimathras\\VarimathrasYesAttack3.wav",false,true,true,10,10,"HeroAcksEAX")
	call SetSoundParamsFromLabel(gg_snd_PlayerBust,"VarimathrasYesAttack")
	call SetSoundDuration(gg_snd_PlayerBust,2038)
	set gg_snd_Hit=CreateSound("Sound\\Interface\\InGameChatWhat1.wav",false,false,false,10,10,"DefaultEAXON")
	call SetSoundParamsFromLabel(gg_snd_Hit,"InGameChatWhat")
	call SetSoundDuration(gg_snd_Hit,208)
	set gg_snd_StandOff=CreateSound("Sound\\Interface\\ArrangedTeamInvitation.wav",false,false,false,10,10,"DefaultEAXON")
	call SetSoundParamsFromLabel(gg_snd_StandOff,"ArrangedTeamInvitation")
	call SetSoundDuration(gg_snd_StandOff,2914)
	set gg_snd_DealerGreet=CreateSound("Units\\Human\\MortarTeam\\MortarTeamWhat4.wav",false,true,true,10,10,"DefaultEAXON")
	call SetSoundParamsFromLabel(gg_snd_DealerGreet,"MortarTeamWhat")
	call SetSoundDuration(gg_snd_DealerGreet,566)
	set gg_snd_Stay=CreateSound("Abilities\\Spells\\NightElf\\FaerieDragonInvis\\PhaseShift1.wav",false,true,true,10,10,"SpellsEAX")
	call SetSoundParamsFromLabel(gg_snd_Stay,"PhaseShift")
	call SetSoundDuration(gg_snd_Stay,1251)
...
function CreateAllDestructables takes nothing returns nothing
	...
	local trigger t
	local real life
	set gg_dest_DTlv_0001=CreateDestructable('DTlv',-96.0,-992.0,289.240,1.019,0)
	set gg_dest_DTlv_0002=CreateDestructable('DTlv',800.0,416.0,93.545,1.019,0)
	set gg_dest_DTlv_0007=CreateDestructable('DTlv',736.0,-352.0,45.594,1.019,0)
	set gg_dest_DTlv_0009=CreateDestructable('DTlv',736.0,-1056.0,2.789,1.019,0)
	set gg_dest_DTlv_0010=CreateDestructable('DTlv',-800.0,-928.0,274.693,1.019,0)
	set gg_dest_DTlv_0011=CreateDestructable('DTlv',-736.0,-160.0,203.992,1.019,0)
	set gg_dest_DTlv_0000=CreateDestructable('DTlv',-672.0,480.0,165.690,1.019,0)
endfunction
...
function CreateBuildingsForPlayer8 takes nothing returns nothing
	...
	local trigger t
	local real life
	set gg_unit_h043_0035=CreateUnit(p,'h043',-896.0,640.0,270.000)
	set gg_unit_n007_0038=CreateUnit(p,'n007',-704.0,384.0,270.000)
	set gg_unit_h043_0039=CreateUnit(p,'h043',0.0,-1216.0,270.000)
	set gg_unit_n007_0040=CreateUnit(p,'n007',0.0,-960.0,270.000)
	set gg_unit_h043_0041=CreateUnit(p,'h043',960.0,-1216.0,270.000)
	set gg_unit_h043_0042=CreateUnit(p,'h043',896.0,640.0,270.000)
	set gg_unit_n007_0043=CreateUnit(p,'n007',704.0,384.0,270.000)
	set gg_unit_h047_0044=CreateUnit(p,'h047',-256.0,640.0,270.000)
	set gg_unit_n007_0046=CreateUnit(p,'n007',-256.0,384.0,270.000)
	set gg_unit_n007_0047=CreateUnit(p,'n007',704.0,-960.0,270.000)
	set gg_unit_h043_0048=CreateUnit(p,'h043',-960.0,-256.0,270.000)
	set gg_unit_h043_0049=CreateUnit(p,'h043',-960.0,-1216.0,270.000)
	set gg_unit_n007_0050=CreateUnit(p,'n007',-704.0,-256.0,270.000)
	set gg_unit_n007_0051=CreateUnit(p,'n007',-704.0,-960.0,270.000)
	set gg_unit_n007_0054=CreateUnit(p,'n007',256.0,384.0,270.000)
	set gg_unit_h047_0055=CreateUnit(p,'h047',256.0,640.0,270.000)
	set gg_unit_h043_0057=CreateUnit(p,'h043',960.0,-256.0,270.000)
	set gg_unit_n007_0058=CreateUnit(p,'n007',704.0,-256.0,270.000)
endfunction
function CreateUnitsForPlayer8 takes nothing returns nothing
	...
	local trigger t
	local real life
	set gg_unit_h048_0045=CreateUnit(p,'h048',-255.7,769.8,256.047)
	set gg_unit_h048_0056=CreateUnit(p,'h048',254.3,768.3,256.047)
endfunction
...
function CreateRegions takes nothing returns nothing
	...
	set gg_rct_Slot_BJRUN_1=Rect(-320.0,96.0,-192.0,192.0)
	set gg_rct_Slot_BJRUN_2=Rect(160.0,96.0,288.0,192.0)
	set gg_rct_Slot_Run_4=Rect(448.0,-320.0,544.0,-192.0)
	set gg_rct_Gambler_Spawn=Rect(-128.0,192.0,128.0,480.0)
	set gg_rct_Slot_Run_5=Rect(512.0,-896.0,608.0,-800.0)
...
function Trig_Player_Leaves_Func001Func001Func001002 takes nothing returns nothing
	call RemoveUnit(GetEnumUnit())
endfunction
function Trig_Player_Leaves_Func001Func001Func004001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[1])==GetTriggerPlayer())
endfunction
function Trig_Player_Leaves_Func001Func001Func005001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[1])==GetTriggerPlayer())
endfunction
function Trig_Player_Leaves_Func001Func001Func006001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[2])==GetTriggerPlayer())
endfunction
function Trig_Player_Leaves_Func001Func001Func007001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[2])==GetTriggerPlayer())
endfunction
function Trig_Player_Leaves_Func001Func001Func008001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[3])==GetTriggerPlayer())
endfunction
function Trig_Player_Leaves_Func001Func001Func009001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[3])==GetTriggerPlayer())
endfunction
function Trig_Player_Leaves_Func001Func001Func010001 takes nothing returns boolean
	return(GetOwningPlayer(udg_BJTable[1])==GetTriggerPlayer())
endfunction
function Trig_Player_Leaves_Func001Func001Func011001 takes nothing returns boolean
	return(GetOwningPlayer(udg_BJTable[1])==GetTriggerPlayer())
endfunction
function Trig_Player_Leaves_Func001Func001Func012001 takes nothing returns boolean
	return(GetOwningPlayer(udg_BJTable[2])==GetTriggerPlayer())
endfunction
function Trig_Player_Leaves_Func001Func001Func013001 takes nothing returns boolean
	return(GetOwningPlayer(udg_BJTable[2])==GetTriggerPlayer())
endfunction
function Trig_Player_Leaves_Func001Func001Func014001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[4])==GetTriggerPlayer())
endfunction
function Trig_Player_Leaves_Func001Func001Func015001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[4])==GetTriggerPlayer())
endfunction
function Trig_Player_Leaves_Func001Func001Func016001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[5])==GetTriggerPlayer())
endfunction
function Trig_Player_Leaves_Func001Func001Func017001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[5])==GetTriggerPlayer())
endfunction
function Trig_Player_Leaves_Func001Func001Func018001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[6])==GetTriggerPlayer())
endfunction
function Trig_Player_Leaves_Func001Func001Func019001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[6])==GetTriggerPlayer())
endfunction
function Trig_Player_Leaves_Func001Func001Func020001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[7])==GetTriggerPlayer())
endfunction
function Trig_Player_Leaves_Func001Func001Func021001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[7])==GetTriggerPlayer())
endfunction
function Trig_Player_Leaves_Func001Func001Func025002 takes nothing returns nothing
	call SetUnitOwner(GetEnumUnit(),Player(8),true)
endfunction
function Trig_Player_Leaves_Func001Func001Func026002 takes nothing returns nothing
	call SetUnitOwner(GetEnumUnit(),Player(8),true)
endfunction
...
function Trig_Player_Leaves_Actions takes nothing returns nothing
	...
	loop
		...
		if(Trig_Player_Leaves_Func001Func001C())then
			...
			if(Trig_Player_Leaves_Func001Func001Func005001())then
				set udg_WslotOccupied[1]=false
			else
				call DoNothing()
			endif
			if(Trig_Player_Leaves_Func001Func001Func006001())then
				call EnableTrigger(gg_trg_Slot_2_Enter)
			else
				call DoNothing()
			endif
			if(Trig_Player_Leaves_Func001Func001Func007001())then
				set udg_WslotOccupied[2]=false
			else
				call DoNothing()
			endif
			if(Trig_Player_Leaves_Func001Func001Func008001())then
				call EnableTrigger(gg_trg_Slot_3_Enter)
			else
				call DoNothing()
			endif
			if(Trig_Player_Leaves_Func001Func001Func009001())then
				set udg_WslotOccupied[3]=false
			else
				call DoNothing()
			endif
			if(Trig_Player_Leaves_Func001Func001Func010001())then
				call EnableTrigger(gg_trg_BJ_Enter)
			else
				call DoNothing()
			endif
			if(Trig_Player_Leaves_Func001Func001Func011001())then
				set udg_WslotOccupied[4]=false
			else
				call DoNothing()
			endif
			if(Trig_Player_Leaves_Func001Func001Func012001())then
				call EnableTrigger(gg_trg_BJ_Enter_2)
			else
				call DoNothing()
			endif
			if(Trig_Player_Leaves_Func001Func001Func013001())then
				set udg_WslotOccupied[5]=false
			else
				call DoNothing()
			endif
			if(Trig_Player_Leaves_Func001Func001Func014001())then
				call EnableTrigger(gg_trg_Slot_4_Enter)
			else
				call DoNothing()
			endif
			if(Trig_Player_Leaves_Func001Func001Func015001())then
				set udg_WslotOccupied[6]=false
			else
				call DoNothing()
			endif
			if(Trig_Player_Leaves_Func001Func001Func016001())then
				call EnableTrigger(gg_trg_Slot_5_Enter)
			else
				call DoNothing()
			endif
			if(Trig_Player_Leaves_Func001Func001Func017001())then
				set udg_WslotOccupied[7]=false
			else
				call DoNothing()
			endif
			if(Trig_Player_Leaves_Func001Func001Func018001())then
				call EnableTrigger(gg_trg_Slot_6_Enter)
			else
				call DoNothing()
			endif
			if(Trig_Player_Leaves_Func001Func001Func019001())then
				set udg_WslotOccupied[8]=false
			else
				call DoNothing()
			endif
			if(Trig_Player_Leaves_Func001Func001Func020001())then
				call EnableTrigger(gg_trg_Slot_7_Enter)
			else
				call DoNothing()
			endif
			if(Trig_Player_Leaves_Func001Func001Func021001())then
				set udg_WslotOccupied[9]=false
			else
				call DoNothing()
			endif
			...
			call ForGroupBJ(GetUnitsOfPlayerAndTypeId(GetTriggerPlayer(),'h043'),function Trig_Player_Leaves_Func001Func001Func025002)
			call ForGroupBJ(GetUnitsOfPlayerAndTypeId(GetTriggerPlayer(),'h047'),function Trig_Player_Leaves_Func001Func001Func026002)
...
function Trig_Maxed_out_quality_Upgrade_Actions takes nothing returns nothing
	...
	call DisplayTextToForce(GetPlayersAll(),(GetPlayerName(GetTriggerPlayer())+" has maxed out his/her Quality chance levels. A Gambler has been created in the center for him/her."))
	call CreateNUnitsAtLoc(1,'h045',GetTriggerPlayer(),GetRandomLocInRect(gg_rct_Gambler_Spawn),bj_UNIT_FACING)
endfunction
...
function Trig_General_Startup_Actions takes nothing returns nothing
	call SetDestructableInvulnerableBJ(gg_dest_DTlv_0000,true)
	call SetDestructableInvulnerableBJ(gg_dest_DTlv_0001,true)
	call SetDestructableInvulnerableBJ(gg_dest_DTlv_0002,true)
	call SetDestructableInvulnerableBJ(gg_dest_DTlv_0007,true)
	call SetDestructableInvulnerableBJ(gg_dest_DTlv_0009,true)
	call SetDestructableInvulnerableBJ(gg_dest_DTlv_0011,true)
	call SetDestructableInvulnerableBJ(gg_dest_DTlv_0010,true)
	set udg_WslotMachine[1]=gg_unit_h043_0035
	set udg_WslotMachine[2]=gg_unit_h043_0039
	set udg_WslotMachine[3]=gg_unit_h043_0042
	set udg_WslotMachine[4]=gg_unit_h043_0057
	set udg_WslotMachine[5]=gg_unit_h043_0041
	set udg_WslotMachine[6]=gg_unit_h043_0048
	set udg_WslotMachine[7]=gg_unit_h043_0049
	set udg_BJTable[1]=gg_unit_h047_0044
	set udg_BJTable[2]=gg_unit_h047_0055
	set udg_Wslot1[1]='A03R'
	set udg_Wslot1[2]='A03Z'
	set udg_Wslot1[3]='A043'
	set udg_Wslot1[4]='A03V'
	set udg_Wslot2[1]='A03S'
	set udg_Wslot2[2]='A040'
	set udg_Wslot2[3]='A044'
	set udg_Wslot2[4]='A03W'
	set udg_Wslot3[1]='A03T'
	set udg_Wslot3[2]='A041'
	set udg_Wslot3[3]='A045'
	set udg_Wslot3[4]='A03X'
	set udg_Wslot4[1]='A03U'
	set udg_Wslot4[2]='A042'
	set udg_Wslot4[3]='A046'
	set udg_Wslot4[4]='A03Y'
	call UnitAddAbilityBJ('A047',udg_WslotMachine[1])
	call UnitAddAbilityBJ('A048',udg_WslotMachine[2])
	call UnitAddAbilityBJ('A049',udg_WslotMachine[3])
	call UnitAddAbilityBJ('A05J',udg_WslotMachine[4])
	call UnitAddAbilityBJ('A065',udg_WslotMachine[5])
	call UnitAddAbilityBJ('A066',udg_WslotMachine[6])
	call UnitAddAbilityBJ('A067',udg_WslotMachine[7])
endfunction
function InitTrig_General_Startup takes nothing returns nothing
	set gg_trg_General_Startup=CreateTrigger()
	call TriggerRegisterTimerEventSingle(gg_trg_General_Startup,3.00)
	call TriggerAddAction(gg_trg_General_Startup,function Trig_General_Startup_Actions)
endfunction
function Trig_BJ_General_Actions takes nothing returns nothing
	set udg_CardsP[21]='A053'
	set udg_CardsP[20]='A052'
	set udg_CardsP[19]='A051'
	set udg_CardsP[18]='A050'
	set udg_CardsP[17]='A04Z'
	set udg_CardsP[16]='A04Y'
	set udg_CardsP[15]='A04X'
	set udg_CardsP[14]='A04W'
	set udg_CardsP[13]='A04V'
	set udg_CardsP[12]='A04U'
	set udg_CardsP[11]='A04T'
	set udg_CardsP[10]='A04S'
	set udg_CardsP[9]='A04R'
	set udg_CardsP[8]='A04Q'
	set udg_CardsP[7]='A04P'
	set udg_CardsP[6]='A04O'
	set udg_CardsP[5]='A04N'
	set udg_CardsP[4]='A04M'
	set udg_CardsP[3]='A055'
	set udg_CardsP[2]='A054'
	set udg_CardsD[1]='A04J'
	set udg_CardsD[2]='A04A'
	set udg_CardsD[3]='A04B'
	set udg_CardsD[4]='A04C'
	set udg_CardsD[5]='A04D'
	set udg_CardsD[6]='A04E'
	set udg_CardsD[7]='A04F'
	set udg_CardsD[8]='A04G'
	set udg_CardsD[9]='A04H'
	set udg_CardsD[10]='A04I'
	set udg_CardsD[11]='A057'
	set udg_CardsD[12]='A058'
	set udg_CardsD[13]='A059'
	set udg_CardsD[14]='A05A'
	set udg_CardsD[15]='A05B'
	set udg_CardsD[16]='A05C'
	set udg_CardsD[17]='A05D'
	set udg_CardsD[18]='A05E'
	set udg_CardsD[19]='A05F'
	set udg_CardsD[20]='A05G'
	set udg_CardsD[21]='A05H'
	set udg_CardsD[22]='A056'
	set udg_CardsD[23]='A05I'
endfunction
function InitTrig_BJ_General takes nothing returns nothing
	set gg_trg_BJ_General=CreateTrigger()
	call TriggerRegisterTimerEventSingle(gg_trg_BJ_General,1.00)
	call TriggerAddAction(gg_trg_BJ_General,function Trig_BJ_General_Actions)
endfunction
function Trig_Slot_1_Enter_Conditions takes nothing returns boolean
	if(not(GetUnitTypeId(GetTriggerUnit())=='h045'))then
		return false
	endif
	if(not(udg_WslotOccupied[1]==false))then
		return false
	endif
	return true
endfunction
function Trig_Slot_1_Enter_Actions takes nothing returns nothing
	call DisableTrigger(GetTriggeringTrigger())
	set udg_WslotOccupied[1]=true
	call SetUnitOwner(udg_WslotMachine[1],GetOwningPlayer(GetTriggerUnit()),true)
	call SetUnitPositionLocFacingLocBJ(GetTriggerUnit(),GetUnitLoc(gg_unit_n007_0038),GetUnitLoc(gg_unit_h043_0035))
	call PauseUnitBJ(true,GetTriggerUnit())
endfunction
function InitTrig_Slot_1_Enter takes nothing returns nothing
	set gg_trg_Slot_1_Enter=CreateTrigger()
	call TriggerRegisterUnitInRangeSimple(gg_trg_Slot_1_Enter,50.00,gg_unit_n007_0038)
	call TriggerAddCondition(gg_trg_Slot_1_Enter,Condition(function Trig_Slot_1_Enter_Conditions))
	call TriggerAddAction(gg_trg_Slot_1_Enter,function Trig_Slot_1_Enter_Actions)
endfunction
function Trig_Slot_1_Spin_main_Conditions takes nothing returns boolean
	if(not(GetUnitTypeId(GetTrainedUnit())=='h044'))then
		return false
	endif
	return true
endfunction
function Trig_Slot_1_Spin_main_Func002Func001001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[1])==GetFilterPlayer())
endfunction
function Trig_Slot_1_Spin_main_Func002C takes nothing returns boolean
	if(not(udg_Wspinning[1]==true))then
		return false
	endif
	return true
endfunction
function Trig_Slot_1_Spin_main_Func003Func001003001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[1])==udg_Player[GetForLoopIndexA()])
endfunction
function Trig_Slot_1_Spin_main_Func003Func028003001 takes nothing returns boolean
	return(udg_Slot1Numbers[1]!=GetForLoopIndexA())
endfunction
function Trig_Slot_1_Spin_main_Func003Func029003001 takes nothing returns boolean
	return(udg_Slot2Numbers[1]!=GetForLoopIndexA())
endfunction
function Trig_Slot_1_Spin_main_Func003Func030003001 takes nothing returns boolean
	return(udg_Slot3Numbers[1]!=GetForLoopIndexA())
endfunction
function Trig_Slot_1_Spin_main_Func003Func031003001 takes nothing returns boolean
	return(udg_Slot4Numbers[1]!=GetForLoopIndexA())
endfunction
function Trig_Slot_1_Spin_main_Func003Func032Func001001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[1])==GetFilterPlayer())
endfunction
function Trig_Slot_1_Spin_main_Func003Func032C takes nothing returns boolean
	if(not(udg_Slot1Numbers[1]==udg_Slot2Numbers[1]))then
		return false
	endif
	if(not(udg_Slot2Numbers[1]!=udg_Slot3Numbers[1]))then
		return false
	endif
	return true
endfunction
function Trig_Slot_1_Spin_main_Func003Func033Func004001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[1])==GetFilterPlayer())
endfunction
function Trig_Slot_1_Spin_main_Func003Func033C takes nothing returns boolean
	if(not(udg_Slot1Numbers[1]==udg_Slot2Numbers[1]))then
		return false
	endif
	if(not(udg_Slot2Numbers[1]==udg_Slot3Numbers[1]))then
	...
	if(not(udg_Slot3Numbers[1]!=udg_Slot4Numbers[1]))then
		return false
	endif
	return true
endfunction
function Trig_Slot_1_Spin_main_Func003Func034Func004001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[1])==GetFilterPlayer())
endfunction
function Trig_Slot_1_Spin_main_Func003Func034C takes nothing returns boolean
	if(not(udg_Slot1Numbers[1]==udg_Slot2Numbers[1]))then
		return false
	endif
	if(not(udg_Slot2Numbers[1]==udg_Slot3Numbers[1]))then
...
function Trig_Slot_1_Spin_main_Func003C takes nothing returns boolean
	if(not(udg_Wspinning[1]==false))then
		return false
	endif
	return true
endfunction
function Trig_Slot_1_Spin_main_Actions takes nothing returns nothing
	call RemoveUnit(GetTrainedUnit())
	if(Trig_Slot_1_Spin_main_Func002C())then
		call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Slot_1_Spin_main_Func002Func001001001)),"Already Spinning, Adding Back 10 gold")
		call AdjustPlayerStateBJ(10,GetOwningPlayer(udg_WslotMachine[1]),PLAYER_STATE_RESOURCE_GOLD)
	else
	endif
	if(Trig_Slot_1_Spin_main_Func003C())then
		set bj_forLoopAIndex=1
		set bj_forLoopAIndexEnd=8
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_1_Spin_main_Func003Func001003001())then
				set udg_CountGambler[GetForLoopIndexA()]=(udg_CountGambler[GetForLoopIndexA()]+1)
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		endloop
		call KillDestructable(gg_dest_DTlv_0000)
		set udg_Wspinning[1]=true
		call PlaySoundOnUnitBJ(gg_snd_Lever,100,gg_unit_h043_0035)
		call PlaySoundOnUnitBJ(gg_snd_SlotStartSpin,100,gg_unit_h043_0035)
		call EnableTrigger(gg_trg_Slot_1_Spin_1)
		call EnableTrigger(gg_trg_Slot_1_Spin_2)
		call EnableTrigger(gg_trg_Slot_1_Spin_3)
		call EnableTrigger(gg_trg_Slot_1_Spin_4)
		call TriggerSleepAction(2)
		call DestructableRestoreLife(gg_dest_DTlv_0000,GetDestructableMaxLife(gg_dest_DTlv_0000),true)
		call SetDestructableInvulnerableBJ(gg_dest_DTlv_0000,true)
		call TriggerSleepAction(GetRandomReal(0.10,1.00))
		call DisableTrigger(gg_trg_Slot_1_Spin_1)
		call PlaySoundOnUnitBJ(gg_snd_StopSlot,100,gg_unit_h043_0035)
		call TriggerSleepAction(GetRandomReal(0.10,1.00))
		call DisableTrigger(gg_trg_Slot_1_Spin_2)
		call PlaySoundOnUnitBJ(gg_snd_StopSlot,100,gg_unit_h043_0035)
		call TriggerSleepAction(GetRandomReal(0.10,1.00))
		call DisableTrigger(gg_trg_Slot_1_Spin_3)
		call PlaySoundOnUnitBJ(gg_snd_StopSlot,100,gg_unit_h043_0035)
		call TriggerSleepAction(GetRandomReal(0.10,1.00))
		call DisableTrigger(gg_trg_Slot_1_Spin_4)
		call PlaySoundOnUnitBJ(gg_snd_StopSlot,100,gg_unit_h043_0035)
		call TriggerSleepAction(1.00)
		set bj_forLoopAIndex=1
		...
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_1_Spin_main_Func003Func028003001())then
				call UnitRemoveAbilityBJ(udg_Wslot1[GetForLoopIndexA()],udg_WslotMachine[1])
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		...
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_1_Spin_main_Func003Func029003001())then
				call UnitRemoveAbilityBJ(udg_Wslot2[GetForLoopIndexA()],udg_WslotMachine[1])
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		...
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_1_Spin_main_Func003Func030003001())then
				call UnitRemoveAbilityBJ(udg_Wslot3[GetForLoopIndexA()],udg_WslotMachine[1])
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		...
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_1_Spin_main_Func003Func031003001())then
				call UnitRemoveAbilityBJ(udg_Wslot4[GetForLoopIndexA()],udg_WslotMachine[1])
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		endloop
		if(Trig_Slot_1_Spin_main_Func003Func032C())then
			call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Slot_1_Spin_main_Func003Func032Func001001001)),"2 Symbols! +15 Gold")
			call AdjustPlayerStateBJ(15,GetOwningPlayer(udg_WslotMachine[1]),PLAYER_STATE_RESOURCE_GOLD)
			call PlaySoundOnUnitBJ(gg_snd_Gold2sym,100,gg_unit_h043_0035)
			call CreateTextTagLocBJ("+15 Gold",GetUnitLoc(gg_unit_n007_0038),0,10,100,100,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
		else
		endif
		if(Trig_Slot_1_Spin_main_Func003Func033C())then
			call CreateTextTagLocBJ("+75 Gold!",GetUnitLoc(gg_unit_n007_0038),0,10,100,100,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
			call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Slot_1_Spin_main_Func003Func033Func004001001)),"3 Symbols! +75 Gold!")
			call AdjustPlayerStateBJ(75,GetOwningPlayer(udg_WslotMachine[1]),PLAYER_STATE_RESOURCE_GOLD)
			call PlaySoundOnUnitBJ(gg_snd_Gold3sym,100,gg_unit_h043_0035)
		else
		endif
		if(Trig_Slot_1_Spin_main_Func003Func034C())then
			call CreateTextTagLocBJ("+200 Gold!!",GetUnitLoc(gg_unit_n007_0038),0,10,100,100,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
			call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Slot_1_Spin_main_Func003Func034Func004001001)),"4 Symbols!! +200 Gold!!!")
			call DisplayTextToForce(GetPlayersAll(),(GetPlayerName(GetOwningPlayer(udg_WslotMachine[1]))+" has just won 200 gold on the slot machines!"))
			call AdjustPlayerStateBJ(200,GetOwningPlayer(udg_WslotMachine[1]),PLAYER_STATE_RESOURCE_GOLD)
			call PlaySoundOnUnitBJ(gg_snd_Gold4sym,100,gg_unit_h043_0035)
		else
		endif
		set udg_Wspinning[1]=false
	else
	endif
endfunction
function InitTrig_Slot_1_Spin_main takes nothing returns nothing
	set gg_trg_Slot_1_Spin_main=CreateTrigger()
	call TriggerRegisterUnitEvent(gg_trg_Slot_1_Spin_main,gg_unit_h043_0035,EVENT_UNIT_TRAIN_FINISH)
	call TriggerAddCondition(gg_trg_Slot_1_Spin_main,Condition(function Trig_Slot_1_Spin_main_Conditions))
	call TriggerAddAction(gg_trg_Slot_1_Spin_main,function Trig_Slot_1_Spin_main_Actions)
endfunction
function Trig_Leave_Machine_Conditions takes nothing returns boolean
	if(not(GetUnitTypeId(GetTrainedUnit())=='h046'))then
		return false
	endif
	return true
endfunction
function Trig_Leave_Machine_Func002Func002002 takes nothing returns nothing
	call PauseUnitBJ(false,GetEnumUnit())
endfunction
function Trig_Leave_Machine_Func002Func004002 takes nothing returns nothing
	call IssuePointOrderLocBJ(GetEnumUnit(),"move",GetRectCenter(gg_rct_Slot_Run_1))
endfunction
function Trig_Leave_Machine_Func002C takes nothing returns boolean
	if(not(udg_Wspinning[1]==false))then
		return false
	endif
	return true
endfunction
function Trig_Leave_Machine_Func003Func001001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[1])==GetFilterPlayer())
endfunction
function Trig_Leave_Machine_Func003C takes nothing returns boolean
	if(not(udg_Wspinning[1]==true))then
		return false
	endif
	return true
endfunction
function Trig_Leave_Machine_Actions takes nothing returns nothing
	call RemoveUnit(GetTrainedUnit())
	if(Trig_Leave_Machine_Func002C())then
		set udg_WslotOccupied[1]=false
		call ForGroupBJ(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_WslotMachine[1]),'h045'),function Trig_Leave_Machine_Func002Func002002)
		call TriggerSleepAction(0.10)
		call ForGroupBJ(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_WslotMachine[1]),'h045'),function Trig_Leave_Machine_Func002Func004002)
		call TriggerSleepAction(0.40)
		call SetUnitOwner(udg_WslotMachine[1],Player(8),true)
		call EnableTrigger(gg_trg_Slot_1_Enter)
	else
	endif
	if(Trig_Leave_Machine_Func003C())then
		call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Leave_Machine_Func003Func001001001)),"Can't Leave while Spinning")
	else
	endif
endfunction
function InitTrig_Leave_Machine takes nothing returns nothing
	set gg_trg_Leave_Machine=CreateTrigger()
	call TriggerRegisterUnitEvent(gg_trg_Leave_Machine,gg_unit_h043_0035,EVENT_UNIT_TRAIN_FINISH)
	call TriggerAddCondition(gg_trg_Leave_Machine,Condition(function Trig_Leave_Machine_Conditions))
	call TriggerAddAction(gg_trg_Leave_Machine,function Trig_Leave_Machine_Actions)
endfunction
function Trig_Slot_1_Spin_1_Func005003001 takes nothing returns boolean
	return(udg_Slot1Numbers[1]!=GetForLoopIndexA())
endfunction
function Trig_Slot_1_Spin_1_Actions takes nothing returns nothing
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
	...
	endloop
	call TriggerSleepAction(0.10)
	set udg_Slot1Numbers[1]=GetRandomInt(1,4)
	call UnitAddAbilityBJ(udg_Wslot1[udg_Slot1Numbers[1]],udg_WslotMachine[1])
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
		if(Trig_Slot_1_Spin_1_Func005003001())then
			call UnitRemoveAbilityBJ(udg_Wslot1[GetForLoopIndexA()],udg_WslotMachine[1])
		else
			call DoNothing()
		endif
...
function InitTrig_Slot_1_Spin_1 takes nothing returns nothing
	set gg_trg_Slot_1_Spin_1=CreateTrigger()
	call DisableTrigger(gg_trg_Slot_1_Spin_1)
	call TriggerRegisterTimerEventPeriodic(gg_trg_Slot_1_Spin_1,0.30)
	call TriggerAddAction(gg_trg_Slot_1_Spin_1,function Trig_Slot_1_Spin_1_Actions)
endfunction
function Trig_Slot_1_Spin_2_Func005003001 takes nothing returns boolean
	return(udg_Slot2Numbers[1]!=GetForLoopIndexA())
endfunction
function Trig_Slot_1_Spin_2_Actions takes nothing returns nothing
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
	...
	endloop
	call TriggerSleepAction(0.10)
	set udg_Slot2Numbers[1]=GetRandomInt(1,4)
	call UnitAddAbilityBJ(udg_Wslot2[udg_Slot2Numbers[1]],udg_WslotMachine[1])
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
		if(Trig_Slot_1_Spin_2_Func005003001())then
			call UnitRemoveAbilityBJ(udg_Wslot2[GetForLoopIndexA()],udg_WslotMachine[1])
		else
			call DoNothing()
		endif
...
function InitTrig_Slot_1_Spin_2 takes nothing returns nothing
	set gg_trg_Slot_1_Spin_2=CreateTrigger()
	call DisableTrigger(gg_trg_Slot_1_Spin_2)
	call TriggerRegisterTimerEventPeriodic(gg_trg_Slot_1_Spin_2,0.30)
	call TriggerAddAction(gg_trg_Slot_1_Spin_2,function Trig_Slot_1_Spin_2_Actions)
endfunction
function Trig_Slot_1_Spin_3_Func005003001 takes nothing returns boolean
	return(udg_Slot3Numbers[1]!=GetForLoopIndexA())
endfunction
function Trig_Slot_1_Spin_3_Actions takes nothing returns nothing
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
	...
	endloop
	call TriggerSleepAction(0.10)
	set udg_Slot3Numbers[1]=GetRandomInt(1,4)
	call UnitAddAbilityBJ(udg_Wslot3[udg_Slot3Numbers[1]],udg_WslotMachine[1])
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
		if(Trig_Slot_1_Spin_3_Func005003001())then
			call UnitRemoveAbilityBJ(udg_Wslot3[GetForLoopIndexA()],udg_WslotMachine[1])
		else
			call DoNothing()
		endif
...
function InitTrig_Slot_1_Spin_3 takes nothing returns nothing
	set gg_trg_Slot_1_Spin_3=CreateTrigger()
	call DisableTrigger(gg_trg_Slot_1_Spin_3)
	call TriggerRegisterTimerEventPeriodic(gg_trg_Slot_1_Spin_3,0.30)
	call TriggerAddAction(gg_trg_Slot_1_Spin_3,function Trig_Slot_1_Spin_3_Actions)
endfunction
function Trig_Slot_1_Spin_4_Func005003001 takes nothing returns boolean
	return(udg_Slot4Numbers[1]!=GetForLoopIndexA())
endfunction
function Trig_Slot_1_Spin_4_Actions takes nothing returns nothing
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
	...
	endloop
	call TriggerSleepAction(0.10)
	set udg_Slot4Numbers[1]=GetRandomInt(1,4)
	call UnitAddAbilityBJ(udg_Wslot4[udg_Slot4Numbers[1]],udg_WslotMachine[1])
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
		if(Trig_Slot_1_Spin_4_Func005003001())then
			call UnitRemoveAbilityBJ(udg_Wslot4[GetForLoopIndexA()],udg_WslotMachine[1])
		else
			call DoNothing()
		endif
...
function InitTrig_Slot_1_Spin_4 takes nothing returns nothing
	set gg_trg_Slot_1_Spin_4=CreateTrigger()
	call DisableTrigger(gg_trg_Slot_1_Spin_4)
	call TriggerRegisterTimerEventPeriodic(gg_trg_Slot_1_Spin_4,0.30)
	call TriggerAddAction(gg_trg_Slot_1_Spin_4,function Trig_Slot_1_Spin_4_Actions)
endfunction
function Trig_Slot_2_Enter_Conditions takes nothing returns boolean
	if(not(GetUnitTypeId(GetTriggerUnit())=='h045'))then
		return false
	endif
	if(not(udg_WslotOccupied[2]==false))then
		return false
	endif
	return true
endfunction
function Trig_Slot_2_Enter_Actions takes nothing returns nothing
	call DisableTrigger(GetTriggeringTrigger())
	set udg_WslotOccupied[2]=true
	call SetUnitOwner(udg_WslotMachine[2],GetOwningPlayer(GetTriggerUnit()),true)
	call SetUnitPositionLocFacingLocBJ(GetTriggerUnit(),GetUnitLoc(gg_unit_n007_0040),GetUnitLoc(gg_unit_h043_0039))
	call PauseUnitBJ(true,GetTriggerUnit())
endfunction
function InitTrig_Slot_2_Enter takes nothing returns nothing
	set gg_trg_Slot_2_Enter=CreateTrigger()
	call TriggerRegisterUnitInRangeSimple(gg_trg_Slot_2_Enter,50.00,gg_unit_n007_0040)
	call TriggerAddCondition(gg_trg_Slot_2_Enter,Condition(function Trig_Slot_2_Enter_Conditions))
	call TriggerAddAction(gg_trg_Slot_2_Enter,function Trig_Slot_2_Enter_Actions)
endfunction
function Trig_Slot_2_Spin_main_Conditions takes nothing returns boolean
	if(not(GetUnitTypeId(GetTrainedUnit())=='h044'))then
		return false
	endif
	return true
endfunction
function Trig_Slot_2_Spin_main_Func002Func001001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[2])==GetFilterPlayer())
endfunction
function Trig_Slot_2_Spin_main_Func002C takes nothing returns boolean
	if(not(udg_Wspinning[2]==true))then
		return false
	endif
	return true
endfunction
function Trig_Slot_2_Spin_main_Func003Func001003001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[2])==udg_Player[GetForLoopIndexA()])
endfunction
function Trig_Slot_2_Spin_main_Func003Func028003001 takes nothing returns boolean
	return(udg_Slot1Numbers[2]!=GetForLoopIndexA())
endfunction
function Trig_Slot_2_Spin_main_Func003Func029003001 takes nothing returns boolean
	return(udg_Slot2Numbers[2]!=GetForLoopIndexA())
endfunction
function Trig_Slot_2_Spin_main_Func003Func030003001 takes nothing returns boolean
	return(udg_Slot3Numbers[2]!=GetForLoopIndexA())
endfunction
function Trig_Slot_2_Spin_main_Func003Func031003001 takes nothing returns boolean
	return(udg_Slot4Numbers[2]!=GetForLoopIndexA())
endfunction
function Trig_Slot_2_Spin_main_Func003Func032Func001001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[2])==GetFilterPlayer())
endfunction
function Trig_Slot_2_Spin_main_Func003Func032C takes nothing returns boolean
	if(not(udg_Slot1Numbers[2]==udg_Slot2Numbers[2]))then
		return false
	endif
	if(not(udg_Slot2Numbers[2]!=udg_Slot3Numbers[2]))then
		return false
	endif
	return true
endfunction
function Trig_Slot_2_Spin_main_Func003Func033Func004001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[2])==GetFilterPlayer())
endfunction
function Trig_Slot_2_Spin_main_Func003Func033C takes nothing returns boolean
	if(not(udg_Slot1Numbers[2]==udg_Slot2Numbers[2]))then
		return false
	endif
	if(not(udg_Slot2Numbers[2]==udg_Slot3Numbers[2]))then
	...
	if(not(udg_Slot3Numbers[2]!=udg_Slot4Numbers[2]))then
		return false
	endif
	return true
endfunction
function Trig_Slot_2_Spin_main_Func003Func034Func004001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[2])==GetFilterPlayer())
endfunction
function Trig_Slot_2_Spin_main_Func003Func034C takes nothing returns boolean
	if(not(udg_Slot1Numbers[2]==udg_Slot2Numbers[2]))then
		return false
	endif
	if(not(udg_Slot2Numbers[2]==udg_Slot3Numbers[2]))then
...
function Trig_Slot_2_Spin_main_Func003C takes nothing returns boolean
	if(not(udg_Wspinning[2]==false))then
		return false
	endif
	return true
endfunction
function Trig_Slot_2_Spin_main_Actions takes nothing returns nothing
	call RemoveUnit(GetTrainedUnit())
	if(Trig_Slot_2_Spin_main_Func002C())then
		call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Slot_2_Spin_main_Func002Func001001001)),"Already Spinning, Adding Back 10 gold")
		call AdjustPlayerStateBJ(10,GetOwningPlayer(udg_WslotMachine[2]),PLAYER_STATE_RESOURCE_GOLD)
	else
	endif
	if(Trig_Slot_2_Spin_main_Func003C())then
		set bj_forLoopAIndex=1
		set bj_forLoopAIndexEnd=8
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_2_Spin_main_Func003Func001003001())then
				set udg_CountGambler[GetForLoopIndexA()]=(udg_CountGambler[GetForLoopIndexA()]+1)
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		endloop
		call KillDestructable(gg_dest_DTlv_0001)
		set udg_Wspinning[2]=true
		call PlaySoundOnUnitBJ(gg_snd_Lever,100,udg_WslotMachine[2])
		call PlaySoundOnUnitBJ(gg_snd_SlotStartSpin,100,udg_WslotMachine[2])
		call EnableTrigger(gg_trg_Slot_2_Spin_1)
		call EnableTrigger(gg_trg_Slot_2_Spin_2)
		call EnableTrigger(gg_trg_Slot_2_Spin_3)
		call EnableTrigger(gg_trg_Slot_2_Spin_4)
		call TriggerSleepAction(2)
		call DestructableRestoreLife(gg_dest_DTlv_0001,GetDestructableMaxLife(gg_dest_DTlv_0000),true)
		call SetDestructableInvulnerableBJ(gg_dest_DTlv_0001,true)
		call TriggerSleepAction(GetRandomReal(0.10,1.00))
		call DisableTrigger(gg_trg_Slot_2_Spin_1)
		call PlaySoundOnUnitBJ(gg_snd_StopSlot,100,gg_unit_h043_0039)
		call TriggerSleepAction(GetRandomReal(0.10,1.00))
		call DisableTrigger(gg_trg_Slot_2_Spin_2)
		call PlaySoundOnUnitBJ(gg_snd_StopSlot,100,gg_unit_h043_0039)
		call TriggerSleepAction(GetRandomReal(0.10,1.00))
		call DisableTrigger(gg_trg_Slot_2_Spin_3)
		call PlaySoundOnUnitBJ(gg_snd_StopSlot,100,gg_unit_h043_0039)
		call TriggerSleepAction(GetRandomReal(0.10,1.00))
		call DisableTrigger(gg_trg_Slot_2_Spin_4)
		call PlaySoundOnUnitBJ(gg_snd_StopSlot,100,gg_unit_h043_0039)
		call TriggerSleepAction(1.00)
		set bj_forLoopAIndex=1
		set bj_forLoopAIndexEnd=4
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_2_Spin_main_Func003Func028003001())then
				call UnitRemoveAbilityBJ(udg_Wslot1[GetForLoopIndexA()],udg_WslotMachine[2])
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		...
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_2_Spin_main_Func003Func029003001())then
				call UnitRemoveAbilityBJ(udg_Wslot2[GetForLoopIndexA()],udg_WslotMachine[2])
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		...
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_2_Spin_main_Func003Func030003001())then
				call UnitRemoveAbilityBJ(udg_Wslot3[GetForLoopIndexA()],udg_WslotMachine[2])
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		...
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_2_Spin_main_Func003Func031003001())then
				call UnitRemoveAbilityBJ(udg_Wslot4[GetForLoopIndexA()],udg_WslotMachine[2])
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		endloop
		if(Trig_Slot_2_Spin_main_Func003Func032C())then
			call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Slot_2_Spin_main_Func003Func032Func001001001)),"2 Symbols! +10 Gold")
			call AdjustPlayerStateBJ(10,GetOwningPlayer(udg_WslotMachine[2]),PLAYER_STATE_RESOURCE_GOLD)
			call PlaySoundOnUnitBJ(gg_snd_Gold2sym,100,udg_WslotMachine[2])
			call CreateTextTagLocBJ("+10 Gold",GetUnitLoc(gg_unit_n007_0040),0,10,100,100,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
		else
		endif
		if(Trig_Slot_2_Spin_main_Func003Func033C())then
			call CreateTextTagLocBJ("+70 Gold!",GetUnitLoc(gg_unit_n007_0040),0,10,100,100,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
			call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Slot_2_Spin_main_Func003Func033Func004001001)),"3 Symbols! +70 Gold!")
			call AdjustPlayerStateBJ(70,GetOwningPlayer(udg_WslotMachine[2]),PLAYER_STATE_RESOURCE_GOLD)
			call PlaySoundOnUnitBJ(gg_snd_Gold3sym,100,udg_WslotMachine[2])
		else
		endif
		if(Trig_Slot_2_Spin_main_Func003Func034C())then
			call CreateTextTagLocBJ("+275 Gold!!",GetUnitLoc(gg_unit_n007_0040),0,10,100,100,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
			call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Slot_2_Spin_main_Func003Func034Func004001001)),"4 Symbols!! +275 Gold!!!")
			call DisplayTextToForce(GetPlayersAll(),(GetPlayerName(GetOwningPlayer(udg_WslotMachine[2]))+" has just won 275 gold on the slot machines!"))
			call AdjustPlayerStateBJ(275,GetOwningPlayer(udg_WslotMachine[2]),PLAYER_STATE_RESOURCE_GOLD)
			call PlaySoundOnUnitBJ(gg_snd_Gold4sym,100,udg_WslotMachine[2])
		else
		endif
		set udg_Wspinning[2]=false
	else
	endif
endfunction
function InitTrig_Slot_2_Spin_main takes nothing returns nothing
	set gg_trg_Slot_2_Spin_main=CreateTrigger()
	call TriggerRegisterUnitEvent(gg_trg_Slot_2_Spin_main,gg_unit_h043_0039,EVENT_UNIT_TRAIN_FINISH)
	call TriggerAddCondition(gg_trg_Slot_2_Spin_main,Condition(function Trig_Slot_2_Spin_main_Conditions))
	call TriggerAddAction(gg_trg_Slot_2_Spin_main,function Trig_Slot_2_Spin_main_Actions)
endfunction
function Trig_Leave_Machine_2_Conditions takes nothing returns boolean
	if(not(GetUnitTypeId(GetTrainedUnit())=='h046'))then
		return false
	endif
	return true
endfunction
function Trig_Leave_Machine_2_Func002Func002002 takes nothing returns nothing
	call PauseUnitBJ(false,GetEnumUnit())
endfunction
function Trig_Leave_Machine_2_Func002Func004002 takes nothing returns nothing
	call IssuePointOrderLocBJ(GetEnumUnit(),"move",GetRectCenter(gg_rct_Slot_Run_2))
endfunction
function Trig_Leave_Machine_2_Func002C takes nothing returns boolean
	if(not(udg_Wspinning[2]==false))then
		return false
	endif
	return true
endfunction
function Trig_Leave_Machine_2_Func003Func001001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[2])==GetFilterPlayer())
endfunction
function Trig_Leave_Machine_2_Func003C takes nothing returns boolean
	if(not(udg_Wspinning[2]==true))then
		return false
	endif
	return true
endfunction
function Trig_Leave_Machine_2_Actions takes nothing returns nothing
	call RemoveUnit(GetTrainedUnit())
	if(Trig_Leave_Machine_2_Func002C())then
		set udg_WslotOccupied[2]=false
		call ForGroupBJ(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_WslotMachine[2]),'h045'),function Trig_Leave_Machine_2_Func002Func002002)
		call TriggerSleepAction(0.10)
		call ForGroupBJ(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_WslotMachine[2]),'h045'),function Trig_Leave_Machine_2_Func002Func004002)
		call TriggerSleepAction(0.40)
		call SetUnitOwner(udg_WslotMachine[2],Player(8),true)
		call EnableTrigger(gg_trg_Slot_2_Enter)
	else
	endif
	if(Trig_Leave_Machine_2_Func003C())then
		call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Leave_Machine_2_Func003Func001001001)),"Can't Leave while Spinning")
	else
	endif
endfunction
function InitTrig_Leave_Machine_2 takes nothing returns nothing
	set gg_trg_Leave_Machine_2=CreateTrigger()
	call TriggerRegisterUnitEvent(gg_trg_Leave_Machine_2,gg_unit_h043_0039,EVENT_UNIT_TRAIN_FINISH)
	call TriggerAddCondition(gg_trg_Leave_Machine_2,Condition(function Trig_Leave_Machine_2_Conditions))
	call TriggerAddAction(gg_trg_Leave_Machine_2,function Trig_Leave_Machine_2_Actions)
endfunction
function Trig_Slot_2_Spin_1_Func005003001 takes nothing returns boolean
	return(udg_Slot1Numbers[2]!=GetForLoopIndexA())
endfunction
function Trig_Slot_2_Spin_1_Actions takes nothing returns nothing
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
	...
	endloop
	call TriggerSleepAction(0.10)
	set udg_Slot1Numbers[2]=GetRandomInt(1,4)
	call UnitAddAbilityBJ(udg_Wslot1[udg_Slot1Numbers[2]],udg_WslotMachine[2])
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
		if(Trig_Slot_2_Spin_1_Func005003001())then
			call UnitRemoveAbilityBJ(udg_Wslot1[GetForLoopIndexA()],udg_WslotMachine[2])
		else
			call DoNothing()
		endif
...
function InitTrig_Slot_2_Spin_1 takes nothing returns nothing
	set gg_trg_Slot_2_Spin_1=CreateTrigger()
	call DisableTrigger(gg_trg_Slot_2_Spin_1)
	call TriggerRegisterTimerEventPeriodic(gg_trg_Slot_2_Spin_1,0.30)
	call TriggerAddAction(gg_trg_Slot_2_Spin_1,function Trig_Slot_2_Spin_1_Actions)
endfunction
function Trig_Slot_2_Spin_2_Func005003001 takes nothing returns boolean
	return(udg_Slot2Numbers[2]!=GetForLoopIndexA())
endfunction
function Trig_Slot_2_Spin_2_Actions takes nothing returns nothing
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
	...
	endloop
	call TriggerSleepAction(0.10)
	set udg_Slot2Numbers[2]=GetRandomInt(1,4)
	call UnitAddAbilityBJ(udg_Wslot2[udg_Slot2Numbers[2]],udg_WslotMachine[2])
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
		if(Trig_Slot_2_Spin_2_Func005003001())then
			call UnitRemoveAbilityBJ(udg_Wslot2[GetForLoopIndexA()],udg_WslotMachine[2])
		else
			call DoNothing()
		endif
...
function InitTrig_Slot_2_Spin_2 takes nothing returns nothing
	set gg_trg_Slot_2_Spin_2=CreateTrigger()
	call DisableTrigger(gg_trg_Slot_2_Spin_2)
	call TriggerRegisterTimerEventPeriodic(gg_trg_Slot_2_Spin_2,0.30)
	call TriggerAddAction(gg_trg_Slot_2_Spin_2,function Trig_Slot_2_Spin_2_Actions)
endfunction
function Trig_Slot_2_Spin_3_Func005003001 takes nothing returns boolean
	return(udg_Slot3Numbers[2]!=GetForLoopIndexA())
endfunction
function Trig_Slot_2_Spin_3_Actions takes nothing returns nothing
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
	...
	endloop
	call TriggerSleepAction(0.10)
	set udg_Slot3Numbers[2]=GetRandomInt(1,4)
	call UnitAddAbilityBJ(udg_Wslot3[udg_Slot3Numbers[2]],udg_WslotMachine[2])
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
		if(Trig_Slot_2_Spin_3_Func005003001())then
			call UnitRemoveAbilityBJ(udg_Wslot3[GetForLoopIndexA()],udg_WslotMachine[2])
		else
			call DoNothing()
		endif
...
function InitTrig_Slot_2_Spin_3 takes nothing returns nothing
	set gg_trg_Slot_2_Spin_3=CreateTrigger()
	call DisableTrigger(gg_trg_Slot_2_Spin_3)
	call TriggerRegisterTimerEventPeriodic(gg_trg_Slot_2_Spin_3,0.30)
	call TriggerAddAction(gg_trg_Slot_2_Spin_3,function Trig_Slot_2_Spin_3_Actions)
endfunction
function Trig_Slot_2_Spin_4_Func005003001 takes nothing returns boolean
	return(udg_Slot4Numbers[2]!=GetForLoopIndexA())
endfunction
function Trig_Slot_2_Spin_4_Actions takes nothing returns nothing
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
	...
	endloop
	call TriggerSleepAction(0.10)
	set udg_Slot4Numbers[2]=GetRandomInt(1,4)
	call UnitAddAbilityBJ(udg_Wslot4[udg_Slot4Numbers[2]],udg_WslotMachine[2])
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
		if(Trig_Slot_2_Spin_4_Func005003001())then
			call UnitRemoveAbilityBJ(udg_Wslot4[GetForLoopIndexA()],udg_WslotMachine[2])
		else
			call DoNothing()
		endif
...
function InitTrig_Slot_2_Spin_4 takes nothing returns nothing
	set gg_trg_Slot_2_Spin_4=CreateTrigger()
	call DisableTrigger(gg_trg_Slot_2_Spin_4)
	call TriggerRegisterTimerEventPeriodic(gg_trg_Slot_2_Spin_4,0.30)
	call TriggerAddAction(gg_trg_Slot_2_Spin_4,function Trig_Slot_2_Spin_4_Actions)
endfunction
function Trig_Slot_3_Enter_Conditions takes nothing returns boolean
	if(not(GetUnitTypeId(GetTriggerUnit())=='h045'))then
		return false
	endif
	if(not(udg_WslotOccupied[3]==false))then
		return false
	endif
	return true
endfunction
function Trig_Slot_3_Enter_Actions takes nothing returns nothing
	call DisableTrigger(GetTriggeringTrigger())
	set udg_WslotOccupied[3]=true
	call SetUnitOwner(udg_WslotMachine[3],GetOwningPlayer(GetTriggerUnit()),true)
	call SetUnitPositionLocFacingLocBJ(GetTriggerUnit(),GetUnitLoc(gg_unit_n007_0043),GetUnitLoc(udg_WslotMachine[3]))
	call PauseUnitBJ(true,GetTriggerUnit())
endfunction
function InitTrig_Slot_3_Enter takes nothing returns nothing
	set gg_trg_Slot_3_Enter=CreateTrigger()
	call TriggerRegisterUnitInRangeSimple(gg_trg_Slot_3_Enter,50.00,gg_unit_n007_0043)
	call TriggerAddCondition(gg_trg_Slot_3_Enter,Condition(function Trig_Slot_3_Enter_Conditions))
	call TriggerAddAction(gg_trg_Slot_3_Enter,function Trig_Slot_3_Enter_Actions)
endfunction
function Trig_Slot_3_Spin_main_Conditions takes nothing returns boolean
	if(not(GetUnitTypeId(GetTrainedUnit())=='h044'))then
		return false
	endif
	return true
endfunction
function Trig_Slot_3_Spin_main_Func002Func001001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[3])==GetFilterPlayer())
endfunction
function Trig_Slot_3_Spin_main_Func002C takes nothing returns boolean
	if(not(udg_Wspinning[3]==true))then
		return false
	endif
	return true
endfunction
function Trig_Slot_3_Spin_main_Func003Func001003001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[3])==udg_Player[GetForLoopIndexA()])
endfunction
function Trig_Slot_3_Spin_main_Func003Func028003001 takes nothing returns boolean
	return(udg_Slot1Numbers[3]!=GetForLoopIndexA())
endfunction
function Trig_Slot_3_Spin_main_Func003Func029003001 takes nothing returns boolean
	return(udg_Slot2Numbers[3]!=GetForLoopIndexA())
endfunction
function Trig_Slot_3_Spin_main_Func003Func030003001 takes nothing returns boolean
	return(udg_Slot3Numbers[3]!=GetForLoopIndexA())
endfunction
function Trig_Slot_3_Spin_main_Func003Func031003001 takes nothing returns boolean
	return(udg_Slot4Numbers[3]!=GetForLoopIndexA())
endfunction
function Trig_Slot_3_Spin_main_Func003Func032Func001001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[3])==GetFilterPlayer())
endfunction
function Trig_Slot_3_Spin_main_Func003Func032C takes nothing returns boolean
	if(not(udg_Slot1Numbers[3]==udg_Slot2Numbers[3]))then
		return false
	endif
	if(not(udg_Slot2Numbers[3]!=udg_Slot3Numbers[3]))then
		return false
	endif
	return true
endfunction
function Trig_Slot_3_Spin_main_Func003Func033Func004001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[3])==GetFilterPlayer())
endfunction
function Trig_Slot_3_Spin_main_Func003Func033C takes nothing returns boolean
	if(not(udg_Slot1Numbers[3]==udg_Slot2Numbers[3]))then
		return false
	endif
	if(not(udg_Slot2Numbers[3]==udg_Slot3Numbers[3]))then
	...
	if(not(udg_Slot3Numbers[3]!=udg_Slot4Numbers[3]))then
		return false
	endif
	return true
endfunction
function Trig_Slot_3_Spin_main_Func003Func034Func004001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[3])==GetFilterPlayer())
endfunction
function Trig_Slot_3_Spin_main_Func003Func034C takes nothing returns boolean
	if(not(udg_Slot1Numbers[3]==udg_Slot2Numbers[3]))then
		return false
	endif
	if(not(udg_Slot2Numbers[3]==udg_Slot3Numbers[3]))then
...
function Trig_Slot_3_Spin_main_Func003C takes nothing returns boolean
	if(not(udg_Wspinning[3]==false))then
		return false
	endif
	return true
endfunction
function Trig_Slot_3_Spin_main_Actions takes nothing returns nothing
	call RemoveUnit(GetTrainedUnit())
	if(Trig_Slot_3_Spin_main_Func002C())then
		call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Slot_3_Spin_main_Func002Func001001001)),"Already Spinning, Adding Back 10 gold")
		call AdjustPlayerStateBJ(10,GetOwningPlayer(udg_WslotMachine[3]),PLAYER_STATE_RESOURCE_GOLD)
	else
	endif
	if(Trig_Slot_3_Spin_main_Func003C())then
		set bj_forLoopAIndex=1
		set bj_forLoopAIndexEnd=8
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_3_Spin_main_Func003Func001003001())then
				set udg_CountGambler[GetForLoopIndexA()]=(udg_CountGambler[GetForLoopIndexA()]+1)
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		endloop
		call KillDestructable(gg_dest_DTlv_0002)
		set udg_Wspinning[3]=true
		call PlaySoundOnUnitBJ(gg_snd_Lever,100,udg_WslotMachine[3])
		call PlaySoundOnUnitBJ(gg_snd_SlotStartSpin,100,udg_WslotMachine[3])
		call EnableTrigger(gg_trg_Slot_3_Spin_1)
		call EnableTrigger(gg_trg_Slot_3_Spin_2)
		call EnableTrigger(gg_trg_Slot_3_Spin_3)
		call EnableTrigger(gg_trg_Slot_3_Spin_4)
		call TriggerSleepAction(2)
		call DestructableRestoreLife(gg_dest_DTlv_0002,GetDestructableMaxLife(gg_dest_DTlv_0002),true)
		call SetDestructableInvulnerableBJ(gg_dest_DTlv_0002,true)
		call TriggerSleepAction(GetRandomReal(0.10,1.00))
		call DisableTrigger(gg_trg_Slot_3_Spin_1)
		call PlaySoundOnUnitBJ(gg_snd_StopSlot,100,udg_WslotMachine[3])
		call TriggerSleepAction(GetRandomReal(0.10,1.00))
		call DisableTrigger(gg_trg_Slot_3_Spin_2)
		call PlaySoundOnUnitBJ(gg_snd_StopSlot,100,udg_WslotMachine[3])
		call TriggerSleepAction(GetRandomReal(0.10,1.00))
		call DisableTrigger(gg_trg_Slot_3_Spin_3)
		call PlaySoundOnUnitBJ(gg_snd_StopSlot,100,udg_WslotMachine[3])
		call TriggerSleepAction(GetRandomReal(0.10,1.00))
		call DisableTrigger(gg_trg_Slot_3_Spin_4)
		call PlaySoundOnUnitBJ(gg_snd_StopSlot,100,udg_WslotMachine[3])
		call TriggerSleepAction(1.00)
		set bj_forLoopAIndex=1
		set bj_forLoopAIndexEnd=4
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_3_Spin_main_Func003Func028003001())then
				call UnitRemoveAbilityBJ(udg_Wslot1[GetForLoopIndexA()],udg_WslotMachine[3])
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		...
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_3_Spin_main_Func003Func029003001())then
				call UnitRemoveAbilityBJ(udg_Wslot2[GetForLoopIndexA()],udg_WslotMachine[3])
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		...
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_3_Spin_main_Func003Func030003001())then
				call UnitRemoveAbilityBJ(udg_Wslot3[GetForLoopIndexA()],udg_WslotMachine[3])
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		...
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_3_Spin_main_Func003Func031003001())then
				call UnitRemoveAbilityBJ(udg_Wslot4[GetForLoopIndexA()],udg_WslotMachine[3])
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		endloop
		if(Trig_Slot_3_Spin_main_Func003Func032C())then
			call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Slot_3_Spin_main_Func003Func032Func001001001)),"2 Symbols! +20 Gold")
			call AdjustPlayerStateBJ(20,GetOwningPlayer(udg_WslotMachine[3]),PLAYER_STATE_RESOURCE_GOLD)
			call PlaySoundOnUnitBJ(gg_snd_Gold2sym,100,udg_WslotMachine[3])
			call CreateTextTagLocBJ("+20 Gold",GetUnitLoc(gg_unit_n007_0043),0,10,100,100,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
		else
		endif
		if(Trig_Slot_3_Spin_main_Func003Func033C())then
			call CreateTextTagLocBJ("+50 Gold!",GetUnitLoc(gg_unit_n007_0043),0,10,100,100,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
			call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Slot_3_Spin_main_Func003Func033Func004001001)),"3 Symbols! +50 Gold!")
			call AdjustPlayerStateBJ(50,GetOwningPlayer(udg_WslotMachine[3]),PLAYER_STATE_RESOURCE_GOLD)
			call PlaySoundOnUnitBJ(gg_snd_Gold3sym,100,udg_WslotMachine[3])
		else
		endif
		if(Trig_Slot_3_Spin_main_Func003Func034C())then
			call CreateTextTagLocBJ("+215 Gold!!",GetUnitLoc(gg_unit_n007_0043),0,10,100,100,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
			call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Slot_3_Spin_main_Func003Func034Func004001001)),"4 Symbols!! +215 Gold!!!")
			call DisplayTextToForce(GetPlayersAll(),(GetPlayerName(GetOwningPlayer(udg_WslotMachine[3]))+" has just won 215 gold on the slot machines!"))
			call AdjustPlayerStateBJ(215,GetOwningPlayer(udg_WslotMachine[3]),PLAYER_STATE_RESOURCE_GOLD)
			call PlaySoundOnUnitBJ(gg_snd_Gold4sym,100,udg_WslotMachine[3])
		else
		endif
		set udg_Wspinning[3]=false
	else
	endif
endfunction
function InitTrig_Slot_3_Spin_main takes nothing returns nothing
	set gg_trg_Slot_3_Spin_main=CreateTrigger()
	call TriggerRegisterUnitEvent(gg_trg_Slot_3_Spin_main,gg_unit_h043_0042,EVENT_UNIT_TRAIN_FINISH)
	call TriggerAddCondition(gg_trg_Slot_3_Spin_main,Condition(function Trig_Slot_3_Spin_main_Conditions))
	call TriggerAddAction(gg_trg_Slot_3_Spin_main,function Trig_Slot_3_Spin_main_Actions)
endfunction
function Trig_Leave_Machine_3_Conditions takes nothing returns boolean
	if(not(GetUnitTypeId(GetTrainedUnit())=='h046'))then
		return false
	endif
	return true
endfunction
function Trig_Leave_Machine_3_Func002Func002002 takes nothing returns nothing
	call PauseUnitBJ(false,GetEnumUnit())
endfunction
function Trig_Leave_Machine_3_Func002Func004002 takes nothing returns nothing
	call IssuePointOrderLocBJ(GetEnumUnit(),"move",GetRectCenter(gg_rct_Slot_Run_3))
endfunction
function Trig_Leave_Machine_3_Func002C takes nothing returns boolean
	if(not(udg_Wspinning[3]==false))then
		return false
	endif
	return true
endfunction
function Trig_Leave_Machine_3_Func003Func001001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[3])==GetFilterPlayer())
endfunction
function Trig_Leave_Machine_3_Func003C takes nothing returns boolean
	if(not(udg_Wspinning[3]==true))then
		return false
	endif
	return true
endfunction
function Trig_Leave_Machine_3_Actions takes nothing returns nothing
	call RemoveUnit(GetTrainedUnit())
	if(Trig_Leave_Machine_3_Func002C())then
		set udg_WslotOccupied[3]=false
		call ForGroupBJ(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_WslotMachine[3]),'h045'),function Trig_Leave_Machine_3_Func002Func002002)
		call TriggerSleepAction(0.10)
		call ForGroupBJ(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_WslotMachine[3]),'h045'),function Trig_Leave_Machine_3_Func002Func004002)
		call TriggerSleepAction(0.40)
		call SetUnitOwner(udg_WslotMachine[3],Player(8),true)
		call EnableTrigger(gg_trg_Slot_3_Enter)
	else
	endif
	if(Trig_Leave_Machine_3_Func003C())then
		call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Leave_Machine_3_Func003Func001001001)),"Can't Leave while Spinning")
	else
	endif
endfunction
function InitTrig_Leave_Machine_3 takes nothing returns nothing
	set gg_trg_Leave_Machine_3=CreateTrigger()
	call TriggerRegisterUnitEvent(gg_trg_Leave_Machine_3,gg_unit_h043_0042,EVENT_UNIT_TRAIN_FINISH)
	call TriggerAddCondition(gg_trg_Leave_Machine_3,Condition(function Trig_Leave_Machine_3_Conditions))
	call TriggerAddAction(gg_trg_Leave_Machine_3,function Trig_Leave_Machine_3_Actions)
endfunction
function Trig_Slot_3_Spin_1_Func005003001 takes nothing returns boolean
	return(udg_Slot1Numbers[3]!=GetForLoopIndexA())
endfunction
function Trig_Slot_3_Spin_1_Actions takes nothing returns nothing
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
	...
	endloop
	call TriggerSleepAction(0.10)
	set udg_Slot1Numbers[3]=GetRandomInt(1,4)
	call UnitAddAbilityBJ(udg_Wslot1[udg_Slot1Numbers[3]],udg_WslotMachine[3])
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
		if(Trig_Slot_3_Spin_1_Func005003001())then
			call UnitRemoveAbilityBJ(udg_Wslot1[GetForLoopIndexA()],udg_WslotMachine[3])
		else
			call DoNothing()
		endif
...
function InitTrig_Slot_3_Spin_1 takes nothing returns nothing
	set gg_trg_Slot_3_Spin_1=CreateTrigger()
	call DisableTrigger(gg_trg_Slot_3_Spin_1)
	call TriggerRegisterTimerEventPeriodic(gg_trg_Slot_3_Spin_1,0.30)
	call TriggerAddAction(gg_trg_Slot_3_Spin_1,function Trig_Slot_3_Spin_1_Actions)
endfunction
function Trig_Slot_3_Spin_2_Func005003001 takes nothing returns boolean
	return(udg_Slot2Numbers[3]!=GetForLoopIndexA())
endfunction
function Trig_Slot_3_Spin_2_Actions takes nothing returns nothing
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
	...
	endloop
	call TriggerSleepAction(0.10)
	set udg_Slot2Numbers[3]=GetRandomInt(1,4)
	call UnitAddAbilityBJ(udg_Wslot2[udg_Slot2Numbers[3]],udg_WslotMachine[3])
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
		if(Trig_Slot_3_Spin_2_Func005003001())then
			call UnitRemoveAbilityBJ(udg_Wslot2[GetForLoopIndexA()],udg_WslotMachine[3])
		else
			call DoNothing()
		endif
...
function InitTrig_Slot_3_Spin_2 takes nothing returns nothing
	set gg_trg_Slot_3_Spin_2=CreateTrigger()
	call DisableTrigger(gg_trg_Slot_3_Spin_2)
	call TriggerRegisterTimerEventPeriodic(gg_trg_Slot_3_Spin_2,0.30)
	call TriggerAddAction(gg_trg_Slot_3_Spin_2,function Trig_Slot_3_Spin_2_Actions)
endfunction
function Trig_Slot_3_Spin_3_Func005003001 takes nothing returns boolean
	return(udg_Slot3Numbers[3]!=GetForLoopIndexA())
endfunction
function Trig_Slot_3_Spin_3_Actions takes nothing returns nothing
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
	...
	endloop
	call TriggerSleepAction(0.10)
	set udg_Slot3Numbers[3]=GetRandomInt(1,4)
	call UnitAddAbilityBJ(udg_Wslot3[udg_Slot3Numbers[3]],udg_WslotMachine[3])
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
		if(Trig_Slot_3_Spin_3_Func005003001())then
			call UnitRemoveAbilityBJ(udg_Wslot3[GetForLoopIndexA()],udg_WslotMachine[3])
		else
			call DoNothing()
		endif
...
function InitTrig_Slot_3_Spin_3 takes nothing returns nothing
	set gg_trg_Slot_3_Spin_3=CreateTrigger()
	call DisableTrigger(gg_trg_Slot_3_Spin_3)
	call TriggerRegisterTimerEventPeriodic(gg_trg_Slot_3_Spin_3,0.30)
	call TriggerAddAction(gg_trg_Slot_3_Spin_3,function Trig_Slot_3_Spin_3_Actions)
endfunction
function Trig_Slot_3_Spin_4_Func005003001 takes nothing returns boolean
	return(udg_Slot4Numbers[3]!=GetForLoopIndexA())
endfunction
function Trig_Slot_3_Spin_4_Actions takes nothing returns nothing
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
	...
	endloop
	call TriggerSleepAction(0.10)
	set udg_Slot4Numbers[3]=GetRandomInt(1,4)
	call UnitAddAbilityBJ(udg_Wslot4[udg_Slot4Numbers[3]],udg_WslotMachine[3])
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
		if(Trig_Slot_3_Spin_4_Func005003001())then
			call UnitRemoveAbilityBJ(udg_Wslot4[GetForLoopIndexA()],udg_WslotMachine[3])
		else
			call DoNothing()
		endif
...
function InitTrig_Slot_3_Spin_4 takes nothing returns nothing
	set gg_trg_Slot_3_Spin_4=CreateTrigger()
	call DisableTrigger(gg_trg_Slot_3_Spin_4)
	call TriggerRegisterTimerEventPeriodic(gg_trg_Slot_3_Spin_4,0.30)
	call TriggerAddAction(gg_trg_Slot_3_Spin_4,function Trig_Slot_3_Spin_4_Actions)
endfunction
function Trig_Slot_4_Enter_Conditions takes nothing returns boolean
	if(not(GetUnitTypeId(GetTriggerUnit())=='h045'))then
		return false
	endif
	if(not(udg_WslotOccupied[6]==false))then
		return false
	endif
	return true
endfunction
function Trig_Slot_4_Enter_Actions takes nothing returns nothing
	call DisableTrigger(GetTriggeringTrigger())
	set udg_WslotOccupied[6]=true
	call SetUnitOwner(udg_WslotMachine[4],GetOwningPlayer(GetTriggerUnit()),true)
	call SetUnitPositionLocFacingLocBJ(GetTriggerUnit(),GetUnitLoc(gg_unit_n007_0058),GetUnitLoc(udg_WslotMachine[4]))
	call PauseUnitBJ(true,GetTriggerUnit())
endfunction
function InitTrig_Slot_4_Enter takes nothing returns nothing
	set gg_trg_Slot_4_Enter=CreateTrigger()
	call TriggerRegisterUnitInRangeSimple(gg_trg_Slot_4_Enter,50.00,gg_unit_n007_0058)
	call TriggerAddCondition(gg_trg_Slot_4_Enter,Condition(function Trig_Slot_4_Enter_Conditions))
	call TriggerAddAction(gg_trg_Slot_4_Enter,function Trig_Slot_4_Enter_Actions)
endfunction
function Trig_Slot_4_Spin_Main_Conditions takes nothing returns boolean
	if(not(GetUnitTypeId(GetTrainedUnit())=='h044'))then
		return false
	endif
	return true
endfunction
function Trig_Slot_4_Spin_Main_Func002Func001001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[4])==GetFilterPlayer())
endfunction
function Trig_Slot_4_Spin_Main_Func002C takes nothing returns boolean
	if(not(udg_Wspinning[4]==true))then
		return false
	endif
	return true
endfunction
function Trig_Slot_4_Spin_Main_Func003Func001003001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[4])==udg_Player[GetForLoopIndexA()])
endfunction
function Trig_Slot_4_Spin_Main_Func003Func028003001 takes nothing returns boolean
	return(udg_Slot1Numbers[4]!=GetForLoopIndexA())
endfunction
function Trig_Slot_4_Spin_Main_Func003Func029003001 takes nothing returns boolean
	return(udg_Slot2Numbers[4]!=GetForLoopIndexA())
endfunction
function Trig_Slot_4_Spin_Main_Func003Func030003001 takes nothing returns boolean
	return(udg_Slot3Numbers[4]!=GetForLoopIndexA())
endfunction
function Trig_Slot_4_Spin_Main_Func003Func031003001 takes nothing returns boolean
	return(udg_Slot4Numbers[4]!=GetForLoopIndexA())
endfunction
function Trig_Slot_4_Spin_Main_Func003Func032Func001001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[4])==GetFilterPlayer())
endfunction
function Trig_Slot_4_Spin_Main_Func003Func032C takes nothing returns boolean
	if(not(udg_Slot1Numbers[4]==udg_Slot2Numbers[4]))then
		return false
	endif
	if(not(udg_Slot2Numbers[4]!=udg_Slot3Numbers[4]))then
		return false
	endif
	return true
endfunction
function Trig_Slot_4_Spin_Main_Func003Func033Func004001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[4])==GetFilterPlayer())
endfunction
function Trig_Slot_4_Spin_Main_Func003Func033C takes nothing returns boolean
	if(not(udg_Slot1Numbers[4]==udg_Slot2Numbers[4]))then
		return false
	endif
	if(not(udg_Slot2Numbers[4]==udg_Slot3Numbers[4]))then
	...
	if(not(udg_Slot3Numbers[4]!=udg_Slot4Numbers[4]))then
		return false
	endif
	return true
endfunction
function Trig_Slot_4_Spin_Main_Func003Func034Func004001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[4])==GetFilterPlayer())
endfunction
function Trig_Slot_4_Spin_Main_Func003Func034C takes nothing returns boolean
	if(not(udg_Slot1Numbers[4]==udg_Slot2Numbers[4]))then
		return false
	endif
	if(not(udg_Slot2Numbers[4]==udg_Slot3Numbers[4]))then
...
function Trig_Slot_4_Spin_Main_Func003C takes nothing returns boolean
	if(not(udg_Wspinning[4]==false))then
		return false
	endif
	return true
endfunction
function Trig_Slot_4_Spin_Main_Actions takes nothing returns nothing
	call RemoveUnit(GetTrainedUnit())
	if(Trig_Slot_4_Spin_Main_Func002C())then
		call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Slot_4_Spin_Main_Func002Func001001001)),"Already Spinning, Adding Back 10 gold")
		call AdjustPlayerStateBJ(10,GetOwningPlayer(udg_WslotMachine[4]),PLAYER_STATE_RESOURCE_GOLD)
	else
	endif
	if(Trig_Slot_4_Spin_Main_Func003C())then
		set bj_forLoopAIndex=1
		set bj_forLoopAIndexEnd=8
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_4_Spin_Main_Func003Func001003001())then
				set udg_CountGambler[GetForLoopIndexA()]=(udg_CountGambler[GetForLoopIndexA()]+1)
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		endloop
		call KillDestructable(gg_dest_DTlv_0007)
		set udg_Wspinning[4]=true
		call PlaySoundOnUnitBJ(gg_snd_Lever,100,udg_WslotMachine[4])
		call PlaySoundOnUnitBJ(gg_snd_SlotStartSpin,100,udg_WslotMachine[4])
		call EnableTrigger(gg_trg_Slot_4_Spin_1)
		call EnableTrigger(gg_trg_Slot_4_Spin_2)
		call EnableTrigger(gg_trg_Slot_4_Spin_3)
		call EnableTrigger(gg_trg_Slot_4_Spin_4)
		call TriggerSleepAction(2)
		call DestructableRestoreLife(gg_dest_DTlv_0007,GetDestructableMaxLife(gg_dest_DTlv_0007),true)
		call SetDestructableInvulnerableBJ(gg_dest_DTlv_0007,true)
		call TriggerSleepAction(GetRandomReal(0.10,1.00))
		call DisableTrigger(gg_trg_Slot_4_Spin_1)
		call PlaySoundOnUnitBJ(gg_snd_StopSlot,100,udg_WslotMachine[4])
		call TriggerSleepAction(GetRandomReal(0.10,1.00))
		call DisableTrigger(gg_trg_Slot_4_Spin_2)
		call PlaySoundOnUnitBJ(gg_snd_StopSlot,100,udg_WslotMachine[4])
		call TriggerSleepAction(GetRandomReal(0.10,1.00))
		call DisableTrigger(gg_trg_Slot_4_Spin_3)
		call PlaySoundOnUnitBJ(gg_snd_StopSlot,100,udg_WslotMachine[4])
		call TriggerSleepAction(GetRandomReal(0.10,1.00))
		call DisableTrigger(gg_trg_Slot_4_Spin_4)
		call PlaySoundOnUnitBJ(gg_snd_StopSlot,100,udg_WslotMachine[4])
		call TriggerSleepAction(1.00)
		set bj_forLoopAIndex=1
		set bj_forLoopAIndexEnd=4
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_4_Spin_Main_Func003Func028003001())then
				call UnitRemoveAbilityBJ(udg_Wslot1[GetForLoopIndexA()],udg_WslotMachine[4])
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		...
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_4_Spin_Main_Func003Func029003001())then
				call UnitRemoveAbilityBJ(udg_Wslot2[GetForLoopIndexA()],udg_WslotMachine[4])
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		...
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_4_Spin_Main_Func003Func030003001())then
				call UnitRemoveAbilityBJ(udg_Wslot3[GetForLoopIndexA()],udg_WslotMachine[4])
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		...
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_4_Spin_Main_Func003Func031003001())then
				call UnitRemoveAbilityBJ(udg_Wslot4[GetForLoopIndexA()],udg_WslotMachine[4])
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		endloop
		if(Trig_Slot_4_Spin_Main_Func003Func032C())then
			call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Slot_4_Spin_Main_Func003Func032Func001001001)),"2 Symbols! +12 Gold")
			call AdjustPlayerStateBJ(12,GetOwningPlayer(udg_WslotMachine[4]),PLAYER_STATE_RESOURCE_GOLD)
			call PlaySoundOnUnitBJ(gg_snd_Gold2sym,100,udg_WslotMachine[4])
			call CreateTextTagLocBJ("+12 Gold",GetUnitLoc(gg_unit_n007_0058),0,10,100,100,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
		else
		endif
		if(Trig_Slot_4_Spin_Main_Func003Func033C())then
			call CreateTextTagLocBJ("+60 Gold!",GetUnitLoc(gg_unit_n007_0058),0,10,100,100,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
			call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Slot_4_Spin_Main_Func003Func033Func004001001)),"3 Symbols! +60 Gold!")
			call AdjustPlayerStateBJ(60,GetOwningPlayer(udg_WslotMachine[4]),PLAYER_STATE_RESOURCE_GOLD)
			call PlaySoundOnUnitBJ(gg_snd_Gold3sym,100,udg_WslotMachine[4])
		else
		endif
		if(Trig_Slot_4_Spin_Main_Func003Func034C())then
			call CreateTextTagLocBJ("+281 Gold!!",GetUnitLoc(gg_unit_n007_0058),0,10,100,100,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
			call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Slot_4_Spin_Main_Func003Func034Func004001001)),"4 Symbols!! +281 Gold!!!")
			call DisplayTextToForce(GetPlayersAll(),(GetPlayerName(GetOwningPlayer(udg_WslotMachine[4]))+" has just won 281 gold on the slot machines!"))
			call AdjustPlayerStateBJ(281,GetOwningPlayer(udg_WslotMachine[4]),PLAYER_STATE_RESOURCE_GOLD)
			call PlaySoundOnUnitBJ(gg_snd_Gold4sym,100,udg_WslotMachine[4])
		else
		endif
		set udg_Wspinning[4]=false
	else
	endif
endfunction
function InitTrig_Slot_4_Spin_Main takes nothing returns nothing
	set gg_trg_Slot_4_Spin_Main=CreateTrigger()
	call TriggerRegisterUnitEvent(gg_trg_Slot_4_Spin_Main,gg_unit_h043_0057,EVENT_UNIT_TRAIN_FINISH)
	call TriggerAddCondition(gg_trg_Slot_4_Spin_Main,Condition(function Trig_Slot_4_Spin_Main_Conditions))
	call TriggerAddAction(gg_trg_Slot_4_Spin_Main,function Trig_Slot_4_Spin_Main_Actions)
endfunction
function Trig_Leave_Machine_4_Conditions takes nothing returns boolean
	if(not(GetUnitTypeId(GetTrainedUnit())=='h046'))then
		return false
	endif
	return true
endfunction
function Trig_Leave_Machine_4_Func002Func002002 takes nothing returns nothing
	call PauseUnitBJ(false,GetEnumUnit())
endfunction
function Trig_Leave_Machine_4_Func002Func004002 takes nothing returns nothing
	call IssuePointOrderLocBJ(GetEnumUnit(),"move",GetRectCenter(gg_rct_Slot_Run_4))
endfunction
function Trig_Leave_Machine_4_Func002C takes nothing returns boolean
	if(not(udg_Wspinning[4]==false))then
		return false
	endif
	return true
endfunction
function Trig_Leave_Machine_4_Func003Func001001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[4])==GetFilterPlayer())
endfunction
function Trig_Leave_Machine_4_Func003C takes nothing returns boolean
	if(not(udg_Wspinning[4]==true))then
		return false
	endif
	return true
endfunction
function Trig_Leave_Machine_4_Actions takes nothing returns nothing
	call RemoveUnit(GetTrainedUnit())
	if(Trig_Leave_Machine_4_Func002C())then
		set udg_WslotOccupied[6]=false
		call ForGroupBJ(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_WslotMachine[4]),'h045'),function Trig_Leave_Machine_4_Func002Func002002)
		call TriggerSleepAction(0.10)
		call ForGroupBJ(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_WslotMachine[4]),'h045'),function Trig_Leave_Machine_4_Func002Func004002)
		call TriggerSleepAction(0.40)
		call SetUnitOwner(udg_WslotMachine[4],Player(8),true)
		call EnableTrigger(gg_trg_Slot_4_Enter)
	else
	endif
	if(Trig_Leave_Machine_4_Func003C())then
		call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Leave_Machine_4_Func003Func001001001)),"Can't Leave while Spinning")
	else
	endif
endfunction
function InitTrig_Leave_Machine_4 takes nothing returns nothing
	set gg_trg_Leave_Machine_4=CreateTrigger()
	call TriggerRegisterUnitEvent(gg_trg_Leave_Machine_4,gg_unit_h043_0057,EVENT_UNIT_TRAIN_FINISH)
	call TriggerAddCondition(gg_trg_Leave_Machine_4,Condition(function Trig_Leave_Machine_4_Conditions))
	call TriggerAddAction(gg_trg_Leave_Machine_4,function Trig_Leave_Machine_4_Actions)
endfunction
function Trig_Slot_4_Spin_1_Func005003001 takes nothing returns boolean
	return(udg_Slot1Numbers[4]!=GetForLoopIndexA())
endfunction
function Trig_Slot_4_Spin_1_Actions takes nothing returns nothing
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
	...
	endloop
	call TriggerSleepAction(0.10)
	set udg_Slot1Numbers[4]=GetRandomInt(1,4)
	call UnitAddAbilityBJ(udg_Wslot1[udg_Slot1Numbers[4]],udg_WslotMachine[4])
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
		if(Trig_Slot_4_Spin_1_Func005003001())then
			call UnitRemoveAbilityBJ(udg_Wslot1[GetForLoopIndexA()],udg_WslotMachine[4])
		else
			call DoNothing()
		endif
...
function InitTrig_Slot_4_Spin_1 takes nothing returns nothing
	set gg_trg_Slot_4_Spin_1=CreateTrigger()
	call DisableTrigger(gg_trg_Slot_4_Spin_1)
	call TriggerRegisterTimerEventPeriodic(gg_trg_Slot_4_Spin_1,0.30)
	call TriggerAddAction(gg_trg_Slot_4_Spin_1,function Trig_Slot_4_Spin_1_Actions)
endfunction
function Trig_Slot_4_Spin_2_Func005003001 takes nothing returns boolean
	return(udg_Slot2Numbers[4]!=GetForLoopIndexA())
endfunction
function Trig_Slot_4_Spin_2_Actions takes nothing returns nothing
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
	...
	endloop
	call TriggerSleepAction(0.10)
	set udg_Slot2Numbers[4]=GetRandomInt(1,4)
	call UnitAddAbilityBJ(udg_Wslot2[udg_Slot2Numbers[4]],udg_WslotMachine[4])
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
		if(Trig_Slot_4_Spin_2_Func005003001())then
			call UnitRemoveAbilityBJ(udg_Wslot2[GetForLoopIndexA()],udg_WslotMachine[4])
		else
			call DoNothing()
		endif
...
function InitTrig_Slot_4_Spin_2 takes nothing returns nothing
	set gg_trg_Slot_4_Spin_2=CreateTrigger()
	call DisableTrigger(gg_trg_Slot_4_Spin_2)
	call TriggerRegisterTimerEventPeriodic(gg_trg_Slot_4_Spin_2,0.30)
	call TriggerAddAction(gg_trg_Slot_4_Spin_2,function Trig_Slot_4_Spin_2_Actions)
endfunction
function Trig_Slot_4_Spin_3_Func005003001 takes nothing returns boolean
	return(udg_Slot3Numbers[4]!=GetForLoopIndexA())
endfunction
function Trig_Slot_4_Spin_3_Actions takes nothing returns nothing
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
	...
	endloop
	call TriggerSleepAction(0.10)
	set udg_Slot3Numbers[4]=GetRandomInt(1,4)
	call UnitAddAbilityBJ(udg_Wslot3[udg_Slot3Numbers[4]],udg_WslotMachine[4])
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
		if(Trig_Slot_4_Spin_3_Func005003001())then
			call UnitRemoveAbilityBJ(udg_Wslot3[GetForLoopIndexA()],udg_WslotMachine[4])
		else
			call DoNothing()
		endif
...
function InitTrig_Slot_4_Spin_3 takes nothing returns nothing
	set gg_trg_Slot_4_Spin_3=CreateTrigger()
	call DisableTrigger(gg_trg_Slot_4_Spin_3)
	call TriggerRegisterTimerEventPeriodic(gg_trg_Slot_4_Spin_3,0.30)
	call TriggerAddAction(gg_trg_Slot_4_Spin_3,function Trig_Slot_4_Spin_3_Actions)
endfunction
function Trig_Slot_4_Spin_4_Func005003001 takes nothing returns boolean
	return(udg_Slot4Numbers[4]!=GetForLoopIndexA())
endfunction
function Trig_Slot_4_Spin_4_Actions takes nothing returns nothing
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
	...
	endloop
	call TriggerSleepAction(0.10)
	set udg_Slot4Numbers[4]=GetRandomInt(1,4)
	call UnitAddAbilityBJ(udg_Wslot4[udg_Slot4Numbers[4]],udg_WslotMachine[4])
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
		if(Trig_Slot_4_Spin_4_Func005003001())then
			call UnitRemoveAbilityBJ(udg_Wslot4[GetForLoopIndexA()],udg_WslotMachine[4])
		else
			call DoNothing()
		endif
...
function InitTrig_Slot_4_Spin_4 takes nothing returns nothing
	set gg_trg_Slot_4_Spin_4=CreateTrigger()
	call DisableTrigger(gg_trg_Slot_4_Spin_4)
	call TriggerRegisterTimerEventPeriodic(gg_trg_Slot_4_Spin_4,0.30)
	call TriggerAddAction(gg_trg_Slot_4_Spin_4,function Trig_Slot_4_Spin_4_Actions)
endfunction
function Trig_Slot_5_Enter_Conditions takes nothing returns boolean
	if(not(GetUnitTypeId(GetTriggerUnit())=='h045'))then
		return false
	endif
	if(not(udg_WslotOccupied[7]==false))then
		return false
	endif
	return true
endfunction
function Trig_Slot_5_Enter_Actions takes nothing returns nothing
	call DisableTrigger(GetTriggeringTrigger())
	set udg_WslotOccupied[7]=true
	call SetUnitOwner(udg_WslotMachine[5],GetOwningPlayer(GetTriggerUnit()),true)
	call SetUnitPositionLocFacingLocBJ(GetTriggerUnit(),GetUnitLoc(gg_unit_n007_0047),GetUnitLoc(udg_WslotMachine[5]))
	call PauseUnitBJ(true,GetTriggerUnit())
endfunction
function InitTrig_Slot_5_Enter takes nothing returns nothing
	set gg_trg_Slot_5_Enter=CreateTrigger()
	call TriggerRegisterUnitInRangeSimple(gg_trg_Slot_5_Enter,50.00,gg_unit_n007_0047)
	call TriggerAddCondition(gg_trg_Slot_5_Enter,Condition(function Trig_Slot_5_Enter_Conditions))
	call TriggerAddAction(gg_trg_Slot_5_Enter,function Trig_Slot_5_Enter_Actions)
endfunction
function Trig_Slot_5_Spin_Main_Conditions takes nothing returns boolean
	if(not(GetUnitTypeId(GetTrainedUnit())=='h044'))then
		return false
	endif
	return true
endfunction
function Trig_Slot_5_Spin_Main_Func002Func001001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[5])==GetFilterPlayer())
endfunction
function Trig_Slot_5_Spin_Main_Func002C takes nothing returns boolean
	if(not(udg_Wspinning[5]==true))then
		return false
	endif
	return true
endfunction
function Trig_Slot_5_Spin_Main_Func003Func001003001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[5])==udg_Player[GetForLoopIndexA()])
endfunction
function Trig_Slot_5_Spin_Main_Func003Func028003001 takes nothing returns boolean
	return(udg_Slot1Numbers[5]!=GetForLoopIndexA())
endfunction
function Trig_Slot_5_Spin_Main_Func003Func029003001 takes nothing returns boolean
	return(udg_Slot2Numbers[5]!=GetForLoopIndexA())
endfunction
function Trig_Slot_5_Spin_Main_Func003Func030003001 takes nothing returns boolean
	return(udg_Slot3Numbers[5]!=GetForLoopIndexA())
endfunction
function Trig_Slot_5_Spin_Main_Func003Func031003001 takes nothing returns boolean
	return(udg_Slot4Numbers[5]!=GetForLoopIndexA())
endfunction
function Trig_Slot_5_Spin_Main_Func003Func032Func001001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[5])==GetFilterPlayer())
endfunction
function Trig_Slot_5_Spin_Main_Func003Func032C takes nothing returns boolean
	if(not(udg_Slot1Numbers[5]==udg_Slot2Numbers[5]))then
		return false
	endif
	if(not(udg_Slot2Numbers[5]!=udg_Slot3Numbers[5]))then
		return false
	endif
	return true
endfunction
function Trig_Slot_5_Spin_Main_Func003Func033Func004001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[5])==GetFilterPlayer())
endfunction
function Trig_Slot_5_Spin_Main_Func003Func033C takes nothing returns boolean
	if(not(udg_Slot1Numbers[5]==udg_Slot2Numbers[5]))then
		return false
	endif
	if(not(udg_Slot2Numbers[5]==udg_Slot3Numbers[5]))then
	...
	if(not(udg_Slot3Numbers[5]!=udg_Slot4Numbers[5]))then
		return false
	endif
	return true
endfunction
function Trig_Slot_5_Spin_Main_Func003Func034Func004001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[5])==GetFilterPlayer())
endfunction
function Trig_Slot_5_Spin_Main_Func003Func034C takes nothing returns boolean
	if(not(udg_Slot1Numbers[5]==udg_Slot2Numbers[5]))then
		return false
	endif
	if(not(udg_Slot2Numbers[5]==udg_Slot3Numbers[5]))then
...
function Trig_Slot_5_Spin_Main_Func003C takes nothing returns boolean
	if(not(udg_Wspinning[5]==false))then
		return false
	endif
	return true
endfunction
function Trig_Slot_5_Spin_Main_Actions takes nothing returns nothing
	call RemoveUnit(GetTrainedUnit())
	if(Trig_Slot_5_Spin_Main_Func002C())then
		call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Slot_5_Spin_Main_Func002Func001001001)),"Already Spinning, Adding Back 10 gold")
		call AdjustPlayerStateBJ(10,GetOwningPlayer(udg_WslotMachine[5]),PLAYER_STATE_RESOURCE_GOLD)
	else
	endif
	if(Trig_Slot_5_Spin_Main_Func003C())then
		set bj_forLoopAIndex=1
		set bj_forLoopAIndexEnd=8
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_5_Spin_Main_Func003Func001003001())then
				set udg_CountGambler[GetForLoopIndexA()]=(udg_CountGambler[GetForLoopIndexA()]+1)
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		endloop
		call KillDestructable(gg_dest_DTlv_0009)
		set udg_Wspinning[5]=true
		call PlaySoundOnUnitBJ(gg_snd_Lever,100,udg_WslotMachine[5])
		call PlaySoundOnUnitBJ(gg_snd_SlotStartSpin,100,udg_WslotMachine[5])
		call EnableTrigger(gg_trg_Slot_5_Spin_1)
		call EnableTrigger(gg_trg_Slot_5_Spin_2)
		call EnableTrigger(gg_trg_Slot_5_Spin_3)
		call EnableTrigger(gg_trg_Slot_5_Spin_4)
		call TriggerSleepAction(2)
		call DestructableRestoreLife(gg_dest_DTlv_0009,GetDestructableMaxLife(gg_dest_DTlv_0009),true)
		call SetDestructableInvulnerableBJ(gg_dest_DTlv_0009,true)
		call TriggerSleepAction(GetRandomReal(0.10,1.00))
		call DisableTrigger(gg_trg_Slot_5_Spin_1)
		call PlaySoundOnUnitBJ(gg_snd_StopSlot,100,udg_WslotMachine[5])
		call TriggerSleepAction(GetRandomReal(0.10,1.00))
		call DisableTrigger(gg_trg_Slot_5_Spin_2)
		call PlaySoundOnUnitBJ(gg_snd_StopSlot,100,udg_WslotMachine[5])
		call TriggerSleepAction(GetRandomReal(0.10,1.00))
		call DisableTrigger(gg_trg_Slot_5_Spin_3)
		call PlaySoundOnUnitBJ(gg_snd_StopSlot,100,udg_WslotMachine[5])
		call TriggerSleepAction(GetRandomReal(0.10,1.00))
		call DisableTrigger(gg_trg_Slot_5_Spin_4)
		call PlaySoundOnUnitBJ(gg_snd_StopSlot,100,udg_WslotMachine[5])
		call TriggerSleepAction(1.00)
		set bj_forLoopAIndex=1
		set bj_forLoopAIndexEnd=4
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_5_Spin_Main_Func003Func028003001())then
				call UnitRemoveAbilityBJ(udg_Wslot1[GetForLoopIndexA()],udg_WslotMachine[5])
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		...
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_5_Spin_Main_Func003Func029003001())then
				call UnitRemoveAbilityBJ(udg_Wslot2[GetForLoopIndexA()],udg_WslotMachine[5])
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		...
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_5_Spin_Main_Func003Func030003001())then
				call UnitRemoveAbilityBJ(udg_Wslot3[GetForLoopIndexA()],udg_WslotMachine[5])
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		...
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_5_Spin_Main_Func003Func031003001())then
				call UnitRemoveAbilityBJ(udg_Wslot4[GetForLoopIndexA()],udg_WslotMachine[5])
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		endloop
		if(Trig_Slot_5_Spin_Main_Func003Func032C())then
			call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Slot_5_Spin_Main_Func003Func032Func001001001)),"2 Symbols! +17 Gold")
			call AdjustPlayerStateBJ(17,GetOwningPlayer(udg_WslotMachine[5]),PLAYER_STATE_RESOURCE_GOLD)
			call PlaySoundOnUnitBJ(gg_snd_Gold2sym,100,udg_WslotMachine[5])
			call CreateTextTagLocBJ("+17 Gold",GetUnitLoc(gg_unit_n007_0047),0,10,100,100,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
		else
		endif
		if(Trig_Slot_5_Spin_Main_Func003Func033C())then
			call CreateTextTagLocBJ("+67 Gold!",GetUnitLoc(gg_unit_n007_0047),0,10,100,100,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
			call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Slot_5_Spin_Main_Func003Func033Func004001001)),"3 Symbols! +67 Gold!")
			call AdjustPlayerStateBJ(67,GetOwningPlayer(udg_WslotMachine[5]),PLAYER_STATE_RESOURCE_GOLD)
			call PlaySoundOnUnitBJ(gg_snd_Gold3sym,100,udg_WslotMachine[5])
		else
		endif
		if(Trig_Slot_5_Spin_Main_Func003Func034C())then
			call CreateTextTagLocBJ("+200 Gold!!",GetUnitLoc(gg_unit_n007_0047),0,10,100,100,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
			call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Slot_5_Spin_Main_Func003Func034Func004001001)),"4 Symbols!! +200 Gold!!!")
			call DisplayTextToForce(GetPlayersAll(),(GetPlayerName(GetOwningPlayer(udg_WslotMachine[5]))+" has just won 200 gold on the slot machines!"))
			call AdjustPlayerStateBJ(200,GetOwningPlayer(udg_WslotMachine[5]),PLAYER_STATE_RESOURCE_GOLD)
			call PlaySoundOnUnitBJ(gg_snd_Gold4sym,100,udg_WslotMachine[5])
		else
		endif
		set udg_Wspinning[5]=false
	else
	endif
endfunction
function InitTrig_Slot_5_Spin_Main takes nothing returns nothing
	set gg_trg_Slot_5_Spin_Main=CreateTrigger()
	call TriggerRegisterUnitEvent(gg_trg_Slot_5_Spin_Main,gg_unit_h043_0041,EVENT_UNIT_TRAIN_FINISH)
	call TriggerAddCondition(gg_trg_Slot_5_Spin_Main,Condition(function Trig_Slot_5_Spin_Main_Conditions))
	call TriggerAddAction(gg_trg_Slot_5_Spin_Main,function Trig_Slot_5_Spin_Main_Actions)
endfunction
function Trig_Leave_Machine_5_Conditions takes nothing returns boolean
	if(not(GetUnitTypeId(GetTrainedUnit())=='h046'))then
		return false
	endif
	return true
endfunction
function Trig_Leave_Machine_5_Func002Func002002 takes nothing returns nothing
	call PauseUnitBJ(false,GetEnumUnit())
endfunction
function Trig_Leave_Machine_5_Func002Func004002 takes nothing returns nothing
	call IssuePointOrderLocBJ(GetEnumUnit(),"move",GetRectCenter(gg_rct_Slot_Run_5))
endfunction
function Trig_Leave_Machine_5_Func002C takes nothing returns boolean
	if(not(udg_Wspinning[5]==false))then
		return false
	endif
	return true
endfunction
function Trig_Leave_Machine_5_Func003Func001001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[5])==GetFilterPlayer())
endfunction
function Trig_Leave_Machine_5_Func003C takes nothing returns boolean
	if(not(udg_Wspinning[5]==true))then
		return false
	endif
	return true
endfunction
function Trig_Leave_Machine_5_Actions takes nothing returns nothing
	call RemoveUnit(GetTrainedUnit())
	if(Trig_Leave_Machine_5_Func002C())then
		set udg_WslotOccupied[7]=false
		call ForGroupBJ(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_WslotMachine[5]),'h045'),function Trig_Leave_Machine_5_Func002Func002002)
		call TriggerSleepAction(0.10)
		call ForGroupBJ(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_WslotMachine[5]),'h045'),function Trig_Leave_Machine_5_Func002Func004002)
		call TriggerSleepAction(0.40)
		call SetUnitOwner(udg_WslotMachine[5],Player(8),true)
		call EnableTrigger(gg_trg_Slot_5_Enter)
	else
	endif
	if(Trig_Leave_Machine_5_Func003C())then
		call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Leave_Machine_5_Func003Func001001001)),"Can't Leave while Spinning")
	else
	endif
endfunction
function InitTrig_Leave_Machine_5 takes nothing returns nothing
	set gg_trg_Leave_Machine_5=CreateTrigger()
	call TriggerRegisterUnitEvent(gg_trg_Leave_Machine_5,gg_unit_h043_0041,EVENT_UNIT_TRAIN_FINISH)
	call TriggerAddCondition(gg_trg_Leave_Machine_5,Condition(function Trig_Leave_Machine_5_Conditions))
	call TriggerAddAction(gg_trg_Leave_Machine_5,function Trig_Leave_Machine_5_Actions)
endfunction
function Trig_Slot_5_Spin_1_Func005003001 takes nothing returns boolean
	return(udg_Slot1Numbers[5]!=GetForLoopIndexA())
endfunction
function Trig_Slot_5_Spin_1_Actions takes nothing returns nothing
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
	...
	endloop
	call TriggerSleepAction(0.10)
	set udg_Slot1Numbers[5]=GetRandomInt(1,4)
	call UnitAddAbilityBJ(udg_Wslot1[udg_Slot1Numbers[5]],udg_WslotMachine[5])
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
		if(Trig_Slot_5_Spin_1_Func005003001())then
			call UnitRemoveAbilityBJ(udg_Wslot1[GetForLoopIndexA()],udg_WslotMachine[5])
		else
			call DoNothing()
		endif
...
function InitTrig_Slot_5_Spin_1 takes nothing returns nothing
	set gg_trg_Slot_5_Spin_1=CreateTrigger()
	call DisableTrigger(gg_trg_Slot_5_Spin_1)
	call TriggerRegisterTimerEventPeriodic(gg_trg_Slot_5_Spin_1,0.30)
	call TriggerAddAction(gg_trg_Slot_5_Spin_1,function Trig_Slot_5_Spin_1_Actions)
endfunction
function Trig_Slot_5_Spin_2_Func005003001 takes nothing returns boolean
	return(udg_Slot2Numbers[5]!=GetForLoopIndexA())
endfunction
function Trig_Slot_5_Spin_2_Actions takes nothing returns nothing
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
	...
	endloop
	call TriggerSleepAction(0.10)
	set udg_Slot2Numbers[5]=GetRandomInt(1,4)
	call UnitAddAbilityBJ(udg_Wslot2[udg_Slot2Numbers[5]],udg_WslotMachine[5])
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
		if(Trig_Slot_5_Spin_2_Func005003001())then
			call UnitRemoveAbilityBJ(udg_Wslot2[GetForLoopIndexA()],udg_WslotMachine[5])
		else
			call DoNothing()
		endif
...
function InitTrig_Slot_5_Spin_2 takes nothing returns nothing
	set gg_trg_Slot_5_Spin_2=CreateTrigger()
	call DisableTrigger(gg_trg_Slot_5_Spin_2)
	call TriggerRegisterTimerEventPeriodic(gg_trg_Slot_5_Spin_2,0.30)
	call TriggerAddAction(gg_trg_Slot_5_Spin_2,function Trig_Slot_5_Spin_2_Actions)
endfunction
function Trig_Slot_5_Spin_3_Func005003001 takes nothing returns boolean
	return(udg_Slot3Numbers[5]!=GetForLoopIndexA())
endfunction
function Trig_Slot_5_Spin_3_Actions takes nothing returns nothing
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
	...
	endloop
	call TriggerSleepAction(0.10)
	set udg_Slot3Numbers[5]=GetRandomInt(1,4)
	call UnitAddAbilityBJ(udg_Wslot3[udg_Slot3Numbers[5]],udg_WslotMachine[5])
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
		if(Trig_Slot_5_Spin_3_Func005003001())then
			call UnitRemoveAbilityBJ(udg_Wslot3[GetForLoopIndexA()],udg_WslotMachine[5])
		else
			call DoNothing()
		endif
...
function InitTrig_Slot_5_Spin_3 takes nothing returns nothing
	set gg_trg_Slot_5_Spin_3=CreateTrigger()
	call DisableTrigger(gg_trg_Slot_5_Spin_3)
	call TriggerRegisterTimerEventPeriodic(gg_trg_Slot_5_Spin_3,0.30)
	call TriggerAddAction(gg_trg_Slot_5_Spin_3,function Trig_Slot_5_Spin_3_Actions)
endfunction
function Trig_Slot_5_Spin_4_Func005003001 takes nothing returns boolean
	return(udg_Slot4Numbers[5]!=GetForLoopIndexA())
endfunction
function Trig_Slot_5_Spin_4_Actions takes nothing returns nothing
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
	...
	endloop
	call TriggerSleepAction(0.10)
	set udg_Slot4Numbers[5]=GetRandomInt(1,4)
	call UnitAddAbilityBJ(udg_Wslot4[udg_Slot4Numbers[5]],udg_WslotMachine[5])
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
		if(Trig_Slot_5_Spin_4_Func005003001())then
			call UnitRemoveAbilityBJ(udg_Wslot4[GetForLoopIndexA()],udg_WslotMachine[5])
		else
			call DoNothing()
		endif
...
function InitTrig_Slot_5_Spin_4 takes nothing returns nothing
	set gg_trg_Slot_5_Spin_4=CreateTrigger()
	call DisableTrigger(gg_trg_Slot_5_Spin_4)
	call TriggerRegisterTimerEventPeriodic(gg_trg_Slot_5_Spin_4,0.30)
	call TriggerAddAction(gg_trg_Slot_5_Spin_4,function Trig_Slot_5_Spin_4_Actions)
endfunction
function Trig_Slot_6_Enter_Conditions takes nothing returns boolean
	if(not(GetUnitTypeId(GetTriggerUnit())=='h045'))then
		return false
	endif
	if(not(udg_WslotOccupied[8]==false))then
		return false
	endif
	return true
endfunction
function Trig_Slot_6_Enter_Actions takes nothing returns nothing
	call DisableTrigger(GetTriggeringTrigger())
	set udg_WslotOccupied[8]=true
	call SetUnitOwner(udg_WslotMachine[6],GetOwningPlayer(GetTriggerUnit()),true)
	call SetUnitPositionLocFacingLocBJ(GetTriggerUnit(),GetUnitLoc(gg_unit_n007_0050),GetUnitLoc(udg_WslotMachine[6]))
	call PauseUnitBJ(true,GetTriggerUnit())
endfunction
function InitTrig_Slot_6_Enter takes nothing returns nothing
	set gg_trg_Slot_6_Enter=CreateTrigger()
	call TriggerRegisterUnitInRangeSimple(gg_trg_Slot_6_Enter,50.00,gg_unit_n007_0050)
	call TriggerAddCondition(gg_trg_Slot_6_Enter,Condition(function Trig_Slot_6_Enter_Conditions))
	call TriggerAddAction(gg_trg_Slot_6_Enter,function Trig_Slot_6_Enter_Actions)
endfunction
function Trig_Slot_6_Spin_Main_Conditions takes nothing returns boolean
	if(not(GetUnitTypeId(GetTrainedUnit())=='h044'))then
		return false
	endif
	return true
endfunction
function Trig_Slot_6_Spin_Main_Func002Func001001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[6])==GetFilterPlayer())
endfunction
function Trig_Slot_6_Spin_Main_Func002C takes nothing returns boolean
	if(not(udg_Wspinning[6]==true))then
		return false
	endif
	return true
endfunction
function Trig_Slot_6_Spin_Main_Func003Func001003001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[6])==udg_Player[GetForLoopIndexA()])
endfunction
function Trig_Slot_6_Spin_Main_Func003Func028003001 takes nothing returns boolean
	return(udg_Slot1Numbers[6]!=GetForLoopIndexA())
endfunction
function Trig_Slot_6_Spin_Main_Func003Func029003001 takes nothing returns boolean
	return(udg_Slot2Numbers[6]!=GetForLoopIndexA())
endfunction
function Trig_Slot_6_Spin_Main_Func003Func030003001 takes nothing returns boolean
	return(udg_Slot3Numbers[6]!=GetForLoopIndexA())
endfunction
function Trig_Slot_6_Spin_Main_Func003Func031003001 takes nothing returns boolean
	return(udg_Slot4Numbers[6]!=GetForLoopIndexA())
endfunction
function Trig_Slot_6_Spin_Main_Func003Func032Func001001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[6])==GetFilterPlayer())
endfunction
function Trig_Slot_6_Spin_Main_Func003Func032C takes nothing returns boolean
	if(not(udg_Slot1Numbers[6]==udg_Slot2Numbers[6]))then
		return false
	endif
	if(not(udg_Slot2Numbers[6]!=udg_Slot3Numbers[6]))then
		return false
	endif
	return true
endfunction
function Trig_Slot_6_Spin_Main_Func003Func033Func004001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[6])==GetFilterPlayer())
endfunction
function Trig_Slot_6_Spin_Main_Func003Func033C takes nothing returns boolean
	if(not(udg_Slot1Numbers[6]==udg_Slot2Numbers[6]))then
		return false
	endif
	if(not(udg_Slot2Numbers[6]==udg_Slot3Numbers[6]))then
	...
	if(not(udg_Slot3Numbers[6]!=udg_Slot4Numbers[6]))then
		return false
	endif
	return true
endfunction
function Trig_Slot_6_Spin_Main_Func003Func034Func004001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[6])==GetFilterPlayer())
endfunction
function Trig_Slot_6_Spin_Main_Func003Func034C takes nothing returns boolean
	if(not(udg_Slot1Numbers[6]==udg_Slot2Numbers[6]))then
		return false
	endif
	if(not(udg_Slot2Numbers[6]==udg_Slot3Numbers[6]))then
...
function Trig_Slot_6_Spin_Main_Func003C takes nothing returns boolean
	if(not(udg_Wspinning[6]==false))then
		return false
	endif
	return true
endfunction
function Trig_Slot_6_Spin_Main_Actions takes nothing returns nothing
	call RemoveUnit(GetTrainedUnit())
	if(Trig_Slot_6_Spin_Main_Func002C())then
		call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Slot_6_Spin_Main_Func002Func001001001)),"Already Spinning, Adding Back 10 gold")
		call AdjustPlayerStateBJ(10,GetOwningPlayer(udg_WslotMachine[6]),PLAYER_STATE_RESOURCE_GOLD)
	else
	endif
	if(Trig_Slot_6_Spin_Main_Func003C())then
		set bj_forLoopAIndex=1
		set bj_forLoopAIndexEnd=8
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_6_Spin_Main_Func003Func001003001())then
				set udg_CountGambler[GetForLoopIndexA()]=(udg_CountGambler[GetForLoopIndexA()]+1)
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		endloop
		call KillDestructable(gg_dest_DTlv_0011)
		set udg_Wspinning[6]=true
		call PlaySoundOnUnitBJ(gg_snd_Lever,100,udg_WslotMachine[6])
		call PlaySoundOnUnitBJ(gg_snd_SlotStartSpin,100,udg_WslotMachine[6])
		call EnableTrigger(gg_trg_Slot_6_Spin_1)
		call EnableTrigger(gg_trg_Slot_6_Spin_2)
		call EnableTrigger(gg_trg_Slot_6_Spin_3)
		call EnableTrigger(gg_trg_Slot_6_Spin_4)
		call TriggerSleepAction(2)
		call DestructableRestoreLife(gg_dest_DTlv_0011,GetDestructableMaxLife(gg_dest_DTlv_0011),true)
		call SetDestructableInvulnerableBJ(gg_dest_DTlv_0011,true)
		call TriggerSleepAction(GetRandomReal(0.10,1.00))
		call DisableTrigger(gg_trg_Slot_6_Spin_1)
		call PlaySoundOnUnitBJ(gg_snd_StopSlot,100,udg_WslotMachine[6])
		call TriggerSleepAction(GetRandomReal(0.10,1.00))
		call DisableTrigger(gg_trg_Slot_6_Spin_2)
		call PlaySoundOnUnitBJ(gg_snd_StopSlot,100,udg_WslotMachine[6])
		call TriggerSleepAction(GetRandomReal(0.10,1.00))
		call DisableTrigger(gg_trg_Slot_6_Spin_3)
		call PlaySoundOnUnitBJ(gg_snd_StopSlot,100,udg_WslotMachine[6])
		call TriggerSleepAction(GetRandomReal(0.10,1.00))
		call DisableTrigger(gg_trg_Slot_6_Spin_4)
		call PlaySoundOnUnitBJ(gg_snd_StopSlot,100,udg_WslotMachine[6])
		call TriggerSleepAction(1.00)
		set bj_forLoopAIndex=1
		set bj_forLoopAIndexEnd=4
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_6_Spin_Main_Func003Func028003001())then
				call UnitRemoveAbilityBJ(udg_Wslot1[GetForLoopIndexA()],udg_WslotMachine[6])
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		...
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_6_Spin_Main_Func003Func029003001())then
				call UnitRemoveAbilityBJ(udg_Wslot2[GetForLoopIndexA()],udg_WslotMachine[6])
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		...
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_6_Spin_Main_Func003Func030003001())then
				call UnitRemoveAbilityBJ(udg_Wslot3[GetForLoopIndexA()],udg_WslotMachine[6])
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		...
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_6_Spin_Main_Func003Func031003001())then
				call UnitRemoveAbilityBJ(udg_Wslot4[GetForLoopIndexA()],udg_WslotMachine[6])
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		endloop
		if(Trig_Slot_6_Spin_Main_Func003Func032C())then
			call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Slot_6_Spin_Main_Func003Func032Func001001001)),"2 Symbols! +13 Gold")
			call AdjustPlayerStateBJ(13,GetOwningPlayer(udg_WslotMachine[6]),PLAYER_STATE_RESOURCE_GOLD)
			call PlaySoundOnUnitBJ(gg_snd_Gold2sym,100,udg_WslotMachine[6])
			call CreateTextTagLocBJ("+13 Gold",GetUnitLoc(gg_unit_n007_0050),0,10,100,100,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
		else
		endif
		if(Trig_Slot_6_Spin_Main_Func003Func033C())then
			call CreateTextTagLocBJ("+83 Gold!",GetUnitLoc(gg_unit_n007_0050),0,10,100,100,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
			call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Slot_6_Spin_Main_Func003Func033Func004001001)),"3 Symbols! +83 Gold!")
			call AdjustPlayerStateBJ(83,GetOwningPlayer(udg_WslotMachine[6]),PLAYER_STATE_RESOURCE_GOLD)
			call PlaySoundOnUnitBJ(gg_snd_Gold3sym,100,udg_WslotMachine[6])
		else
		endif
		if(Trig_Slot_6_Spin_Main_Func003Func034C())then
			call CreateTextTagLocBJ("+200 Gold!!",GetUnitLoc(gg_unit_n007_0050),0,10,100,100,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
			call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Slot_6_Spin_Main_Func003Func034Func004001001)),"4 Symbols!! +200 Gold!!!")
			call DisplayTextToForce(GetPlayersAll(),(GetPlayerName(GetOwningPlayer(udg_WslotMachine[6]))+" has just won 200 gold on the slot machines!"))
			call AdjustPlayerStateBJ(200,GetOwningPlayer(udg_WslotMachine[6]),PLAYER_STATE_RESOURCE_GOLD)
			call PlaySoundOnUnitBJ(gg_snd_Gold4sym,100,udg_WslotMachine[6])
		else
		endif
		set udg_Wspinning[6]=false
	else
	endif
endfunction
function InitTrig_Slot_6_Spin_Main takes nothing returns nothing
	set gg_trg_Slot_6_Spin_Main=CreateTrigger()
	call TriggerRegisterUnitEvent(gg_trg_Slot_6_Spin_Main,gg_unit_h043_0048,EVENT_UNIT_TRAIN_FINISH)
	call TriggerAddCondition(gg_trg_Slot_6_Spin_Main,Condition(function Trig_Slot_6_Spin_Main_Conditions))
	call TriggerAddAction(gg_trg_Slot_6_Spin_Main,function Trig_Slot_6_Spin_Main_Actions)
endfunction
function Trig_Leave_Machine_6_Conditions takes nothing returns boolean
	if(not(GetUnitTypeId(GetTrainedUnit())=='h046'))then
		return false
	endif
	return true
endfunction
function Trig_Leave_Machine_6_Func002Func002002 takes nothing returns nothing
	call PauseUnitBJ(false,GetEnumUnit())
endfunction
function Trig_Leave_Machine_6_Func002Func004002 takes nothing returns nothing
	call IssuePointOrderLocBJ(GetEnumUnit(),"move",GetRectCenter(gg_rct_Slot_Run_6))
endfunction
function Trig_Leave_Machine_6_Func002C takes nothing returns boolean
	if(not(udg_Wspinning[6]==false))then
		return false
	endif
	return true
endfunction
function Trig_Leave_Machine_6_Func003Func001001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[6])==GetFilterPlayer())
endfunction
function Trig_Leave_Machine_6_Func003C takes nothing returns boolean
	if(not(udg_Wspinning[6]==true))then
		return false
	endif
	return true
endfunction
function Trig_Leave_Machine_6_Actions takes nothing returns nothing
	call RemoveUnit(GetTrainedUnit())
	if(Trig_Leave_Machine_6_Func002C())then
		set udg_WslotOccupied[8]=false
		call ForGroupBJ(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_WslotMachine[6]),'h045'),function Trig_Leave_Machine_6_Func002Func002002)
		call TriggerSleepAction(0.10)
		call ForGroupBJ(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_WslotMachine[6]),'h045'),function Trig_Leave_Machine_6_Func002Func004002)
		call TriggerSleepAction(0.40)
		call SetUnitOwner(udg_WslotMachine[6],Player(8),true)
		call EnableTrigger(gg_trg_Slot_6_Enter)
	else
	endif
	if(Trig_Leave_Machine_6_Func003C())then
		call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Leave_Machine_6_Func003Func001001001)),"Can't Leave while Spinning")
	else
	endif
endfunction
function InitTrig_Leave_Machine_6 takes nothing returns nothing
	set gg_trg_Leave_Machine_6=CreateTrigger()
	call TriggerRegisterUnitEvent(gg_trg_Leave_Machine_6,gg_unit_h043_0048,EVENT_UNIT_TRAIN_FINISH)
	call TriggerAddCondition(gg_trg_Leave_Machine_6,Condition(function Trig_Leave_Machine_6_Conditions))
	call TriggerAddAction(gg_trg_Leave_Machine_6,function Trig_Leave_Machine_6_Actions)
endfunction
function Trig_Slot_6_Spin_1_Func005003001 takes nothing returns boolean
	return(udg_Slot1Numbers[6]!=GetForLoopIndexA())
endfunction
function Trig_Slot_6_Spin_1_Actions takes nothing returns nothing
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
	...
	endloop
	call TriggerSleepAction(0.10)
	set udg_Slot1Numbers[6]=GetRandomInt(1,4)
	call UnitAddAbilityBJ(udg_Wslot1[udg_Slot1Numbers[6]],udg_WslotMachine[6])
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
		if(Trig_Slot_6_Spin_1_Func005003001())then
			call UnitRemoveAbilityBJ(udg_Wslot1[GetForLoopIndexA()],udg_WslotMachine[6])
		else
			call DoNothing()
		endif
...
function InitTrig_Slot_6_Spin_1 takes nothing returns nothing
	set gg_trg_Slot_6_Spin_1=CreateTrigger()
	call DisableTrigger(gg_trg_Slot_6_Spin_1)
	call TriggerRegisterTimerEventPeriodic(gg_trg_Slot_6_Spin_1,0.30)
	call TriggerAddAction(gg_trg_Slot_6_Spin_1,function Trig_Slot_6_Spin_1_Actions)
endfunction
function Trig_Slot_6_Spin_2_Func005003001 takes nothing returns boolean
	return(udg_Slot2Numbers[6]!=GetForLoopIndexA())
endfunction
function Trig_Slot_6_Spin_2_Actions takes nothing returns nothing
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
	...
	endloop
	call TriggerSleepAction(0.10)
	set udg_Slot2Numbers[6]=GetRandomInt(1,4)
	call UnitAddAbilityBJ(udg_Wslot2[udg_Slot2Numbers[6]],udg_WslotMachine[6])
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
		if(Trig_Slot_6_Spin_2_Func005003001())then
			call UnitRemoveAbilityBJ(udg_Wslot2[GetForLoopIndexA()],udg_WslotMachine[6])
		else
			call DoNothing()
		endif
...
function InitTrig_Slot_6_Spin_2 takes nothing returns nothing
	set gg_trg_Slot_6_Spin_2=CreateTrigger()
	call DisableTrigger(gg_trg_Slot_6_Spin_2)
	call TriggerRegisterTimerEventPeriodic(gg_trg_Slot_6_Spin_2,0.30)
	call TriggerAddAction(gg_trg_Slot_6_Spin_2,function Trig_Slot_6_Spin_2_Actions)
endfunction
function Trig_Slot_6_Spin_3_Func005003001 takes nothing returns boolean
	return(udg_Slot3Numbers[6]!=GetForLoopIndexA())
endfunction
function Trig_Slot_6_Spin_3_Actions takes nothing returns nothing
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
	...
	endloop
	call TriggerSleepAction(0.10)
	set udg_Slot3Numbers[6]=GetRandomInt(1,4)
	call UnitAddAbilityBJ(udg_Wslot3[udg_Slot3Numbers[6]],udg_WslotMachine[6])
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
		if(Trig_Slot_6_Spin_3_Func005003001())then
			call UnitRemoveAbilityBJ(udg_Wslot3[GetForLoopIndexA()],udg_WslotMachine[6])
		else
			call DoNothing()
		endif
...
function InitTrig_Slot_6_Spin_3 takes nothing returns nothing
	set gg_trg_Slot_6_Spin_3=CreateTrigger()
	call DisableTrigger(gg_trg_Slot_6_Spin_3)
	call TriggerRegisterTimerEventPeriodic(gg_trg_Slot_6_Spin_3,0.30)
	call TriggerAddAction(gg_trg_Slot_6_Spin_3,function Trig_Slot_6_Spin_3_Actions)
endfunction
function Trig_Slot_6_Spin_4_Func005003001 takes nothing returns boolean
	return(udg_Slot4Numbers[6]!=GetForLoopIndexA())
endfunction
function Trig_Slot_6_Spin_4_Actions takes nothing returns nothing
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
	...
	endloop
	call TriggerSleepAction(0.10)
	set udg_Slot4Numbers[6]=GetRandomInt(1,4)
	call UnitAddAbilityBJ(udg_Wslot4[udg_Slot4Numbers[6]],udg_WslotMachine[6])
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
		if(Trig_Slot_6_Spin_4_Func005003001())then
			call UnitRemoveAbilityBJ(udg_Wslot4[GetForLoopIndexA()],udg_WslotMachine[6])
		else
			call DoNothing()
		endif
...
function InitTrig_Slot_6_Spin_4 takes nothing returns nothing
	set gg_trg_Slot_6_Spin_4=CreateTrigger()
	call DisableTrigger(gg_trg_Slot_6_Spin_4)
	call TriggerRegisterTimerEventPeriodic(gg_trg_Slot_6_Spin_4,0.30)
	call TriggerAddAction(gg_trg_Slot_6_Spin_4,function Trig_Slot_6_Spin_4_Actions)
endfunction
function Trig_Slot_7_Enter_Conditions takes nothing returns boolean
	if(not(GetUnitTypeId(GetTriggerUnit())=='h045'))then
		return false
	endif
	if(not(udg_WslotOccupied[9]==false))then
		return false
	endif
	return true
endfunction
function Trig_Slot_7_Enter_Actions takes nothing returns nothing
	call DisableTrigger(GetTriggeringTrigger())
	set udg_WslotOccupied[9]=true
	call SetUnitOwner(udg_WslotMachine[7],GetOwningPlayer(GetTriggerUnit()),true)
	call SetUnitPositionLocFacingLocBJ(GetTriggerUnit(),GetUnitLoc(gg_unit_n007_0051),GetUnitLoc(udg_WslotMachine[7]))
	call PauseUnitBJ(true,GetTriggerUnit())
endfunction
function InitTrig_Slot_7_Enter takes nothing returns nothing
	set gg_trg_Slot_7_Enter=CreateTrigger()
	call TriggerRegisterUnitInRangeSimple(gg_trg_Slot_7_Enter,50.00,gg_unit_n007_0051)
	call TriggerAddCondition(gg_trg_Slot_7_Enter,Condition(function Trig_Slot_7_Enter_Conditions))
	call TriggerAddAction(gg_trg_Slot_7_Enter,function Trig_Slot_7_Enter_Actions)
endfunction
function Trig_Slot_7_Spin_Main_Conditions takes nothing returns boolean
	if(not(GetUnitTypeId(GetTrainedUnit())=='h044'))then
		return false
	endif
	return true
endfunction
function Trig_Slot_7_Spin_Main_Func002Func001001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[7])==GetFilterPlayer())
endfunction
function Trig_Slot_7_Spin_Main_Func002C takes nothing returns boolean
	if(not(udg_Wspinning[7]==true))then
		return false
	endif
	return true
endfunction
function Trig_Slot_7_Spin_Main_Func003Func001003001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[7])==udg_Player[GetForLoopIndexA()])
endfunction
function Trig_Slot_7_Spin_Main_Func003Func028003001 takes nothing returns boolean
	return(udg_Slot1Numbers[7]!=GetForLoopIndexA())
endfunction
function Trig_Slot_7_Spin_Main_Func003Func029003001 takes nothing returns boolean
	return(udg_Slot2Numbers[7]!=GetForLoopIndexA())
endfunction
function Trig_Slot_7_Spin_Main_Func003Func030003001 takes nothing returns boolean
	return(udg_Slot3Numbers[7]!=GetForLoopIndexA())
endfunction
function Trig_Slot_7_Spin_Main_Func003Func031003001 takes nothing returns boolean
	return(udg_Slot4Numbers[7]!=GetForLoopIndexA())
endfunction
function Trig_Slot_7_Spin_Main_Func003Func032Func001001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[7])==GetFilterPlayer())
endfunction
function Trig_Slot_7_Spin_Main_Func003Func032C takes nothing returns boolean
	if(not(udg_Slot1Numbers[7]==udg_Slot2Numbers[7]))then
		return false
	endif
	if(not(udg_Slot2Numbers[7]!=udg_Slot3Numbers[7]))then
		return false
	endif
	return true
endfunction
function Trig_Slot_7_Spin_Main_Func003Func033Func004001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[7])==GetFilterPlayer())
endfunction
function Trig_Slot_7_Spin_Main_Func003Func033C takes nothing returns boolean
	if(not(udg_Slot1Numbers[7]==udg_Slot2Numbers[7]))then
		return false
	endif
	if(not(udg_Slot2Numbers[7]==udg_Slot3Numbers[7]))then
	...
	if(not(udg_Slot3Numbers[7]!=udg_Slot4Numbers[7]))then
		return false
	endif
	return true
endfunction
function Trig_Slot_7_Spin_Main_Func003Func034Func004001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[7])==GetFilterPlayer())
endfunction
function Trig_Slot_7_Spin_Main_Func003Func034C takes nothing returns boolean
	if(not(udg_Slot1Numbers[7]==udg_Slot2Numbers[7]))then
		return false
	endif
	if(not(udg_Slot2Numbers[7]==udg_Slot3Numbers[7]))then
...
function Trig_Slot_7_Spin_Main_Func003C takes nothing returns boolean
	if(not(udg_Wspinning[7]==false))then
		return false
	endif
	return true
endfunction
function Trig_Slot_7_Spin_Main_Actions takes nothing returns nothing
	call RemoveUnit(GetTrainedUnit())
	if(Trig_Slot_7_Spin_Main_Func002C())then
		call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Slot_7_Spin_Main_Func002Func001001001)),"Already Spinning, Adding Back 10 gold")
		call AdjustPlayerStateBJ(10,GetOwningPlayer(udg_WslotMachine[7]),PLAYER_STATE_RESOURCE_GOLD)
	else
	endif
	if(Trig_Slot_7_Spin_Main_Func003C())then
		set bj_forLoopAIndex=1
		set bj_forLoopAIndexEnd=8
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_7_Spin_Main_Func003Func001003001())then
				set udg_CountGambler[GetForLoopIndexA()]=(udg_CountGambler[GetForLoopIndexA()]+1)
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		endloop
		call KillDestructable(gg_dest_DTlv_0010)
		set udg_Wspinning[7]=true
		call PlaySoundOnUnitBJ(gg_snd_Lever,100,udg_WslotMachine[7])
		call PlaySoundOnUnitBJ(gg_snd_SlotStartSpin,100,udg_WslotMachine[7])
		call EnableTrigger(gg_trg_Slot_7_Spin_1)
		call EnableTrigger(gg_trg_Slot_7_Spin_2)
		call EnableTrigger(gg_trg_Slot_7_Spin_3)
		call EnableTrigger(gg_trg_Slot_7_Spin_4)
		call TriggerSleepAction(2)
		call DestructableRestoreLife(gg_dest_DTlv_0010,GetDestructableMaxLife(gg_dest_DTlv_0011),true)
		call SetDestructableInvulnerableBJ(gg_dest_DTlv_0010,true)
		call TriggerSleepAction(GetRandomReal(0.10,1.00))
		call DisableTrigger(gg_trg_Slot_7_Spin_1)
		call PlaySoundOnUnitBJ(gg_snd_StopSlot,100,udg_WslotMachine[7])
		call TriggerSleepAction(GetRandomReal(0.10,1.00))
		call DisableTrigger(gg_trg_Slot_7_Spin_2)
		call PlaySoundOnUnitBJ(gg_snd_StopSlot,100,udg_WslotMachine[7])
		call TriggerSleepAction(GetRandomReal(0.10,1.00))
		call DisableTrigger(gg_trg_Slot_7_Spin_3)
		call PlaySoundOnUnitBJ(gg_snd_StopSlot,100,udg_WslotMachine[7])
		call TriggerSleepAction(GetRandomReal(0.10,1.00))
		call DisableTrigger(gg_trg_Slot_7_Spin_4)
		call PlaySoundOnUnitBJ(gg_snd_StopSlot,100,udg_WslotMachine[7])
		call TriggerSleepAction(1.00)
		set bj_forLoopAIndex=1
		set bj_forLoopAIndexEnd=4
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_7_Spin_Main_Func003Func028003001())then
				call UnitRemoveAbilityBJ(udg_Wslot1[GetForLoopIndexA()],udg_WslotMachine[7])
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		...
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_7_Spin_Main_Func003Func029003001())then
				call UnitRemoveAbilityBJ(udg_Wslot2[GetForLoopIndexA()],udg_WslotMachine[7])
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		...
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_7_Spin_Main_Func003Func030003001())then
				call UnitRemoveAbilityBJ(udg_Wslot3[GetForLoopIndexA()],udg_WslotMachine[7])
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		...
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_Slot_7_Spin_Main_Func003Func031003001())then
				call UnitRemoveAbilityBJ(udg_Wslot4[GetForLoopIndexA()],udg_WslotMachine[7])
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		endloop
		if(Trig_Slot_7_Spin_Main_Func003Func032C())then
			call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Slot_7_Spin_Main_Func003Func032Func001001001)),"2 Symbols! +15 Gold")
			call AdjustPlayerStateBJ(15,GetOwningPlayer(udg_WslotMachine[7]),PLAYER_STATE_RESOURCE_GOLD)
			call PlaySoundOnUnitBJ(gg_snd_Gold2sym,100,udg_WslotMachine[7])
			call CreateTextTagLocBJ("+15 Gold",GetUnitLoc(gg_unit_n007_0051),0,10,100,100,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
		else
		endif
		if(Trig_Slot_7_Spin_Main_Func003Func033C())then
			call CreateTextTagLocBJ("+55 Gold!",GetUnitLoc(gg_unit_n007_0051),0,10,100,100,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
			call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Slot_7_Spin_Main_Func003Func033Func004001001)),"3 Symbols! +55 Gold!")
			call AdjustPlayerStateBJ(55,GetOwningPlayer(udg_WslotMachine[7]),PLAYER_STATE_RESOURCE_GOLD)
			call PlaySoundOnUnitBJ(gg_snd_Gold3sym,100,udg_WslotMachine[7])
		else
		endif
		if(Trig_Slot_7_Spin_Main_Func003Func034C())then
			call CreateTextTagLocBJ("+260 Gold!!",GetUnitLoc(gg_unit_n007_0051),0,10,100,100,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
			call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Slot_7_Spin_Main_Func003Func034Func004001001)),"4 Symbols!! +260 Gold!!!")
			call DisplayTextToForce(GetPlayersAll(),(GetPlayerName(GetOwningPlayer(udg_WslotMachine[7]))+" has just won 260 gold on the slot machines!"))
			call AdjustPlayerStateBJ(260,GetOwningPlayer(udg_WslotMachine[7]),PLAYER_STATE_RESOURCE_GOLD)
			call PlaySoundOnUnitBJ(gg_snd_Gold4sym,100,udg_WslotMachine[7])
		else
		endif
		set udg_Wspinning[7]=false
	else
	endif
endfunction
function InitTrig_Slot_7_Spin_Main takes nothing returns nothing
	set gg_trg_Slot_7_Spin_Main=CreateTrigger()
	call TriggerRegisterUnitEvent(gg_trg_Slot_7_Spin_Main,gg_unit_h043_0049,EVENT_UNIT_TRAIN_FINISH)
	call TriggerAddCondition(gg_trg_Slot_7_Spin_Main,Condition(function Trig_Slot_7_Spin_Main_Conditions))
	call TriggerAddAction(gg_trg_Slot_7_Spin_Main,function Trig_Slot_7_Spin_Main_Actions)
endfunction
function Trig_Leave_Machine_7_Conditions takes nothing returns boolean
	if(not(GetUnitTypeId(GetTrainedUnit())=='h046'))then
		return false
	endif
	return true
endfunction
function Trig_Leave_Machine_7_Func002Func002002 takes nothing returns nothing
	call PauseUnitBJ(false,GetEnumUnit())
endfunction
function Trig_Leave_Machine_7_Func002Func004002 takes nothing returns nothing
	call IssuePointOrderLocBJ(GetEnumUnit(),"move",GetRectCenter(gg_rct_Slot_Run_7))
endfunction
function Trig_Leave_Machine_7_Func002C takes nothing returns boolean
	if(not(udg_Wspinning[7]==false))then
		return false
	endif
	return true
endfunction
function Trig_Leave_Machine_7_Func003Func001001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_WslotMachine[7])==GetFilterPlayer())
endfunction
function Trig_Leave_Machine_7_Func003C takes nothing returns boolean
	if(not(udg_Wspinning[7]==true))then
		return false
	endif
	return true
endfunction
function Trig_Leave_Machine_7_Actions takes nothing returns nothing
	call RemoveUnit(GetTrainedUnit())
	if(Trig_Leave_Machine_7_Func002C())then
		set udg_WslotOccupied[9]=false
		call ForGroupBJ(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_WslotMachine[7]),'h045'),function Trig_Leave_Machine_7_Func002Func002002)
		call TriggerSleepAction(0.10)
		call ForGroupBJ(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_WslotMachine[7]),'h045'),function Trig_Leave_Machine_7_Func002Func004002)
		call TriggerSleepAction(0.40)
		call SetUnitOwner(udg_WslotMachine[7],Player(8),true)
		call EnableTrigger(gg_trg_Slot_7_Enter)
	else
	endif
	if(Trig_Leave_Machine_7_Func003C())then
		call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_Leave_Machine_7_Func003Func001001001)),"Can't Leave while Spinning")
	else
	endif
endfunction
function InitTrig_Leave_Machine_7 takes nothing returns nothing
	set gg_trg_Leave_Machine_7=CreateTrigger()
	call TriggerRegisterUnitEvent(gg_trg_Leave_Machine_7,gg_unit_h043_0049,EVENT_UNIT_TRAIN_FINISH)
	call TriggerAddCondition(gg_trg_Leave_Machine_7,Condition(function Trig_Leave_Machine_7_Conditions))
	call TriggerAddAction(gg_trg_Leave_Machine_7,function Trig_Leave_Machine_7_Actions)
endfunction
function Trig_Slot_7_Spin_1_Func005003001 takes nothing returns boolean
	return(udg_Slot1Numbers[7]!=GetForLoopIndexA())
endfunction
function Trig_Slot_7_Spin_1_Actions takes nothing returns nothing
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
	...
	endloop
	call TriggerSleepAction(0.10)
	set udg_Slot1Numbers[7]=GetRandomInt(1,4)
	call UnitAddAbilityBJ(udg_Wslot1[udg_Slot1Numbers[7]],udg_WslotMachine[7])
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
		if(Trig_Slot_7_Spin_1_Func005003001())then
			call UnitRemoveAbilityBJ(udg_Wslot1[GetForLoopIndexA()],udg_WslotMachine[7])
		else
			call DoNothing()
		endif
...
function InitTrig_Slot_7_Spin_1 takes nothing returns nothing
	set gg_trg_Slot_7_Spin_1=CreateTrigger()
	call DisableTrigger(gg_trg_Slot_7_Spin_1)
	call TriggerRegisterTimerEventPeriodic(gg_trg_Slot_7_Spin_1,0.30)
	call TriggerAddAction(gg_trg_Slot_7_Spin_1,function Trig_Slot_7_Spin_1_Actions)
endfunction
function Trig_Slot_7_Spin_2_Func005003001 takes nothing returns boolean
	return(udg_Slot2Numbers[7]!=GetForLoopIndexA())
endfunction
function Trig_Slot_7_Spin_2_Actions takes nothing returns nothing
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
	...
	endloop
	call TriggerSleepAction(0.10)
	set udg_Slot2Numbers[7]=GetRandomInt(1,4)
	call UnitAddAbilityBJ(udg_Wslot2[udg_Slot2Numbers[7]],udg_WslotMachine[7])
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
		if(Trig_Slot_7_Spin_2_Func005003001())then
			call UnitRemoveAbilityBJ(udg_Wslot2[GetForLoopIndexA()],udg_WslotMachine[7])
		else
			call DoNothing()
		endif
...
function InitTrig_Slot_7_Spin_2 takes nothing returns nothing
	set gg_trg_Slot_7_Spin_2=CreateTrigger()
	call DisableTrigger(gg_trg_Slot_7_Spin_2)
	call TriggerRegisterTimerEventPeriodic(gg_trg_Slot_7_Spin_2,0.30)
	call TriggerAddAction(gg_trg_Slot_7_Spin_2,function Trig_Slot_7_Spin_2_Actions)
endfunction
function Trig_Slot_7_Spin_3_Func005003001 takes nothing returns boolean
	return(udg_Slot3Numbers[7]!=GetForLoopIndexA())
endfunction
function Trig_Slot_7_Spin_3_Actions takes nothing returns nothing
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
	...
	endloop
	call TriggerSleepAction(0.10)
	set udg_Slot3Numbers[7]=GetRandomInt(1,4)
	call UnitAddAbilityBJ(udg_Wslot3[udg_Slot3Numbers[7]],udg_WslotMachine[7])
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
		if(Trig_Slot_7_Spin_3_Func005003001())then
			call UnitRemoveAbilityBJ(udg_Wslot3[GetForLoopIndexA()],udg_WslotMachine[7])
		else
			call DoNothing()
		endif
...
function InitTrig_Slot_7_Spin_3 takes nothing returns nothing
	set gg_trg_Slot_7_Spin_3=CreateTrigger()
	call DisableTrigger(gg_trg_Slot_7_Spin_3)
	call TriggerRegisterTimerEventPeriodic(gg_trg_Slot_7_Spin_3,0.30)
	call TriggerAddAction(gg_trg_Slot_7_Spin_3,function Trig_Slot_7_Spin_3_Actions)
endfunction
function Trig_Slot_7_Spin_4_Func005003001 takes nothing returns boolean
	return(udg_Slot4Numbers[7]!=GetForLoopIndexA())
endfunction
function Trig_Slot_7_Spin_4_Actions takes nothing returns nothing
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
	...
	endloop
	call TriggerSleepAction(0.10)
	set udg_Slot4Numbers[7]=GetRandomInt(1,4)
	call UnitAddAbilityBJ(udg_Wslot4[udg_Slot4Numbers[7]],udg_WslotMachine[7])
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=4
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
		if(Trig_Slot_7_Spin_4_Func005003001())then
			call UnitRemoveAbilityBJ(udg_Wslot4[GetForLoopIndexA()],udg_WslotMachine[7])
		else
			call DoNothing()
		endif
...
function InitTrig_Slot_7_Spin_4 takes nothing returns nothing
	set gg_trg_Slot_7_Spin_4=CreateTrigger()
	call DisableTrigger(gg_trg_Slot_7_Spin_4)
	call TriggerRegisterTimerEventPeriodic(gg_trg_Slot_7_Spin_4,0.30)
	call TriggerAddAction(gg_trg_Slot_7_Spin_4,function Trig_Slot_7_Spin_4_Actions)
endfunction
function Trig_BJ_Leave_Conditions takes nothing returns boolean
	if(not(GetUnitTypeId(GetTrainedUnit())=='h046'))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Leave_Func002Func002002 takes nothing returns nothing
	call PauseUnitBJ(false,GetEnumUnit())
endfunction
function Trig_BJ_Leave_Func002Func004002 takes nothing returns nothing
	call IssuePointOrderLocBJ(GetEnumUnit(),"move",GetRectCenter(gg_rct_Slot_BJRUN_1))
endfunction
function Trig_BJ_Leave_Func002C takes nothing returns boolean
	if(not(udg_BJPlaying[1]==false))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Leave_Func003Func001001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_BJTable[1])==GetFilterPlayer())
endfunction
function Trig_BJ_Leave_Func003C takes nothing returns boolean
	if(not(udg_BJPlaying[1]==true))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Leave_Actions takes nothing returns nothing
	call RemoveUnit(GetTrainedUnit())
	if(Trig_BJ_Leave_Func002C())then
		set udg_WslotOccupied[4]=false
		call ForGroupBJ(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_BJTable[1]),'h045'),function Trig_BJ_Leave_Func002Func002002)
		call TriggerSleepAction(0.10)
		call ForGroupBJ(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_BJTable[1]),'h045'),function Trig_BJ_Leave_Func002Func004002)
		call TriggerSleepAction(0.40)
		call SetUnitOwner(udg_BJTable[1],Player(8),true)
		call EnableTrigger(gg_trg_BJ_Enter)
	else
	endif
	if(Trig_BJ_Leave_Func003C())then
		call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_BJ_Leave_Func003Func001001001)),"Can't Leave while Playing")
	else
	endif
endfunction
function InitTrig_BJ_Leave takes nothing returns nothing
	set gg_trg_BJ_Leave=CreateTrigger()
	call TriggerRegisterUnitEvent(gg_trg_BJ_Leave,gg_unit_h047_0044,EVENT_UNIT_TRAIN_FINISH)
	call TriggerAddCondition(gg_trg_BJ_Leave,Condition(function Trig_BJ_Leave_Conditions))
	call TriggerAddAction(gg_trg_BJ_Leave,function Trig_BJ_Leave_Actions)
endfunction
function Trig_BJ_Enter_Conditions takes nothing returns boolean
	if(not(GetUnitTypeId(GetTriggerUnit())=='h045'))then
		return false
	endif
	if(not(udg_WslotOccupied[4]==false))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Enter_Actions takes nothing returns nothing
	call DisableTrigger(GetTriggeringTrigger())
	set udg_WslotOccupied[4]=true
	call PlaySoundOnUnitBJ(gg_snd_DealerGreet,100,gg_unit_h048_0045)
	call SetUnitOwner(udg_BJTable[1],GetOwningPlayer(GetTriggerUnit()),true)
	call SetUnitPositionLocFacingLocBJ(GetTriggerUnit(),GetUnitLoc(gg_unit_n007_0046),GetUnitLoc(udg_BJTable[1]))
	call PauseUnitBJ(true,GetTriggerUnit())
endfunction
function InitTrig_BJ_Enter takes nothing returns nothing
	set gg_trg_BJ_Enter=CreateTrigger()
	call TriggerRegisterUnitInRangeSimple(gg_trg_BJ_Enter,50.00,gg_unit_n007_0046)
	call TriggerAddCondition(gg_trg_BJ_Enter,Condition(function Trig_BJ_Enter_Conditions))
	call TriggerAddAction(gg_trg_BJ_Enter,function Trig_BJ_Enter_Actions)
endfunction
function Trig_BJ_Start_up_Conditions takes nothing returns boolean
	if(not(GetUnitTypeId(GetTrainedUnit())=='h049'))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Start_up_Func002Func001001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_BJTable[1])==GetFilterPlayer())
endfunction
function Trig_BJ_Start_up_Func002C takes nothing returns boolean
	if(not(udg_BJPlaying[1]==true))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Start_up_Func003Func001003001 takes nothing returns boolean
	return(GetOwningPlayer(udg_BJTable[1])==udg_Player[GetForLoopIndexA()])
endfunction
function Trig_BJ_Start_up_Func003Func005001 takes nothing returns boolean
	return(udg_BJDealersNO[1]==1)
endfunction
function Trig_BJ_Start_up_Func003Func006001 takes nothing returns boolean
	return(udg_BJDealersNO[1]==2)
endfunction
function Trig_BJ_Start_up_Func003Func007001 takes nothing returns boolean
	return(udg_BJDealersNO[1]==3)
endfunction
function Trig_BJ_Start_up_Func003Func008001 takes nothing returns boolean
	return(udg_BJDealersNO[1]==4)
endfunction
function Trig_BJ_Start_up_Func003Func009001 takes nothing returns boolean
	return(udg_BJDealersNO[1]==5)
endfunction
function Trig_BJ_Start_up_Func003Func010001 takes nothing returns boolean
	return(udg_BJDealersNO[1]==6)
endfunction
function Trig_BJ_Start_up_Func003Func011001 takes nothing returns boolean
	return(udg_BJDealersNO[1]==7)
endfunction
function Trig_BJ_Start_up_Func003Func012001 takes nothing returns boolean
	return(udg_BJDealersNO[1]==8)
endfunction
function Trig_BJ_Start_up_Func003Func013001 takes nothing returns boolean
	return(udg_BJDealersNO[1]==9)
endfunction
function Trig_BJ_Start_up_Func003Func014001 takes nothing returns boolean
	return(udg_BJDealersNO[1]>=10)
endfunction
function Trig_BJ_Start_up_Func003Func015001 takes nothing returns boolean
	return(udg_BJDealersNO[1]>=10)
endfunction
function Trig_BJ_Start_up_Func003Func020C takes nothing returns boolean
	if(not(udg_BJp1stcard[1]==1))then
		return false
	endif
	if(not(udg_BJp2ndcard[1]>=10))then
		return false
	endif
	if(not(udg_BJp2ndcard[1]<=13))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Start_up_Func003Func021C takes nothing returns boolean
	if(not(udg_BJp2ndcard[1]==1))then
		return false
	endif
	if(not(udg_BJp1stcard[1]>=10))then
		return false
	endif
	if(not(udg_BJp1stcard[1]<=13))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Start_up_Func003Func023Func001001001 takes nothing returns boolean
	return(udg_BJp1stcard[1]>=1)
endfunction
function Trig_BJ_Start_up_Func003Func023Func001001002 takes nothing returns boolean
	return(udg_BJp1stcard[1]<=9)
endfunction
function Trig_BJ_Start_up_Func003Func023Func001001 takes nothing returns boolean
	return GetBooleanAnd(Trig_BJ_Start_up_Func003Func023Func001001001(),Trig_BJ_Start_up_Func003Func023Func001001002())
endfunction
function Trig_BJ_Start_up_Func003Func023Func002001001 takes nothing returns boolean
	return(udg_BJp2ndcard[1]>=2)
endfunction
function Trig_BJ_Start_up_Func003Func023Func002001002 takes nothing returns boolean
	return(udg_BJp2ndcard[1]<=9)
endfunction
function Trig_BJ_Start_up_Func003Func023Func002001 takes nothing returns boolean
	return GetBooleanAnd(Trig_BJ_Start_up_Func003Func023Func002001001(),Trig_BJ_Start_up_Func003Func023Func002001002())
endfunction
function Trig_BJ_Start_up_Func003Func023Func003001 takes nothing returns boolean
	return(udg_BJp2ndcard[1]==1)
endfunction
function Trig_BJ_Start_up_Func003Func023Func005001 takes nothing returns boolean
	return(udg_BJp1stcard[1]>=10)
endfunction
function Trig_BJ_Start_up_Func003Func023Func006001 takes nothing returns boolean
	return(udg_BJp2ndcard[1]>=10)
endfunction
function Trig_BJ_Start_up_Func003Func023Func007001 takes nothing returns boolean
	return(udg_BJPlayerNO[1]==3)
endfunction
function Trig_BJ_Start_up_Func003Func023Func009003001 takes nothing returns boolean
	return(udg_BJPlayerNO[1]==GetForLoopIndexA())
endfunction
function Trig_BJ_Start_up_Func003Func023C takes nothing returns boolean
	if(not(udg_BJPfin[1]==false))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Start_up_Func003Func024C takes nothing returns boolean
	if(not(udg_BJPlayerNO[1]<=21))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Start_up_Func003Func025C takes nothing returns boolean
	if(not(udg_BJDealersNO[1]>=2))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Start_up_Func003Func026C takes nothing returns boolean
	if(not(udg_BJDealersNO[1]==1))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Start_up_Func003C takes nothing returns boolean
	if(not(udg_BJPlaying[1]==false))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Start_up_Actions takes nothing returns nothing
	call RemoveUnit(GetTrainedUnit())
	if(Trig_BJ_Start_up_Func002C())then
		call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_BJ_Start_up_Func002Func001001001)),"Already Playing, Adding Back 10 gold")
		call AdjustPlayerStateBJ(10,GetOwningPlayer(udg_BJTable[1]),PLAYER_STATE_RESOURCE_GOLD)
	else
	endif
	if(Trig_BJ_Start_up_Func003C())then
		set bj_forLoopAIndex=1
		set bj_forLoopAIndexEnd=8
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_BJ_Start_up_Func003Func001003001())then
				set udg_CountGambler[GetForLoopIndexA()]=(udg_CountGambler[GetForLoopIndexA()]+1)
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		endloop
		set udg_BJPlaying[1]=true
		set udg_BJDealersNO[1]=GetRandomInt(1,13)
		if(Trig_BJ_Start_up_Func003Func005001())then
			call UnitAddAbilityBJ('A04J',udg_BJTable[1])
		else
			call DoNothing()
		endif
		if(Trig_BJ_Start_up_Func003Func006001())then
			call UnitAddAbilityBJ('A04A',udg_BJTable[1])
		else
			call DoNothing()
		endif
		if(Trig_BJ_Start_up_Func003Func007001())then
			call UnitAddAbilityBJ('A04B',udg_BJTable[1])
		else
			call DoNothing()
		endif
		if(Trig_BJ_Start_up_Func003Func008001())then
			call UnitAddAbilityBJ('A04C',udg_BJTable[1])
		else
			call DoNothing()
		endif
		if(Trig_BJ_Start_up_Func003Func009001())then
			call UnitAddAbilityBJ('A04D',udg_BJTable[1])
		else
			call DoNothing()
		endif
		if(Trig_BJ_Start_up_Func003Func010001())then
			call UnitAddAbilityBJ('A04E',udg_BJTable[1])
		else
			call DoNothing()
		endif
		if(Trig_BJ_Start_up_Func003Func011001())then
			call UnitAddAbilityBJ('A04F',udg_BJTable[1])
		else
			call DoNothing()
		endif
		if(Trig_BJ_Start_up_Func003Func012001())then
			call UnitAddAbilityBJ('A04G',udg_BJTable[1])
		else
			call DoNothing()
		endif
		if(Trig_BJ_Start_up_Func003Func013001())then
			call UnitAddAbilityBJ('A04H',udg_BJTable[1])
		else
			call DoNothing()
		endif
		if(Trig_BJ_Start_up_Func003Func014001())then
			call UnitAddAbilityBJ('A04I',udg_BJTable[1])
		else
			call DoNothing()
		endif
		if(Trig_BJ_Start_up_Func003Func015001())then
			set udg_BJDealersNO[1]=10
		else
			call DoNothing()
		endif
		set udg_BJp1stcard[1]=GetRandomInt(1,13)
		set udg_BJp2ndcard[1]=GetRandomInt(1,13)
		if(Trig_BJ_Start_up_Func003Func020C())then
			call CreateTextTagLocBJ("I got BlackJack!!",GetUnitLoc(GroupPickRandomUnit(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_BJTable[1]),'h045'))),0,10,100,100.00,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
			set udg_BJPfin[1]=true
			call UnitAddAbilityBJ('A054',udg_BJTable[1])
			set udg_BJPlayerNO[1]=22
		else
		endif
		if(Trig_BJ_Start_up_Func003Func021C())then
			call CreateTextTagLocBJ("I got BlackJack!!",GetUnitLoc(GroupPickRandomUnit(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_BJTable[1]),'h045'))),0,10,100,100.00,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
			set udg_BJPfin[1]=true
		...
		if(Trig_BJ_Start_up_Func003Func023C())then
			if(Trig_BJ_Start_up_Func003Func023Func001001())then
				set udg_BJPlayerNO[1]=(udg_BJPlayerNO[1]+udg_BJp1stcard[1])
			else
				call DoNothing()
			endif
			if(Trig_BJ_Start_up_Func003Func023Func002001())then
				set udg_BJPlayerNO[1]=(udg_BJPlayerNO[1]+udg_BJp2ndcard[1])
			else
				call DoNothing()
			endif
			if(Trig_BJ_Start_up_Func003Func023Func003001())then
				set udg_BJPlayerNO[1]=(udg_BJPlayerNO[1]+11)
			else
				call DoNothing()
			endif
			if(Trig_BJ_Start_up_Func003Func023Func005001())then
				set udg_BJPlayerNO[1]=(udg_BJPlayerNO[1]+10)
			else
				call DoNothing()
			endif
			if(Trig_BJ_Start_up_Func003Func023Func006001())then
				set udg_BJPlayerNO[1]=(udg_BJPlayerNO[1]+10)
			else
				call DoNothing()
			endif
			if(Trig_BJ_Start_up_Func003Func023Func007001())then
				set udg_BJPlayerNO[1]=13
			else
				call DoNothing()
			endif
			...
			loop
				exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
				if(Trig_BJ_Start_up_Func003Func023Func009003001())then
					call UnitAddAbilityBJ(udg_CardsP[GetForLoopIndexA()],udg_BJTable[1])
				else
					call DoNothing()
				endif
				set bj_forLoopAIndex=bj_forLoopAIndex+1
		...
		if(Trig_BJ_Start_up_Func003Func024C())then
			call CreateTextTagLocBJ(("I have "+I2S(udg_BJPlayerNO[1])),GetUnitLoc(GroupPickRandomUnit(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_BJTable[1]),'h045'))),0,10,100,100,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
		else
		endif
		if(Trig_BJ_Start_up_Func003Func025C())then
			call CreateTextTagLocBJ(("Dealer has "+I2S(udg_BJDealersNO[1])),GetUnitLoc(gg_unit_h048_0045),0,10,100,100,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
		else
		endif
		if(Trig_BJ_Start_up_Func003Func026C())then
			call CreateTextTagLocBJ("Dealer has an Ace!",GetUnitLoc(gg_unit_h048_0045),0,10,100,100,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
		else
		endif
...
function InitTrig_BJ_Start_up takes nothing returns nothing
	set gg_trg_BJ_Start_up=CreateTrigger()
	call TriggerRegisterUnitEvent(gg_trg_BJ_Start_up,gg_unit_h047_0044,EVENT_UNIT_TRAIN_FINISH)
	call TriggerAddCondition(gg_trg_BJ_Start_up,Condition(function Trig_BJ_Start_up_Conditions))
	call TriggerAddAction(gg_trg_BJ_Start_up,function Trig_BJ_Start_up_Actions)
endfunction
function Trig_BJ_Player_Hits_Conditions takes nothing returns boolean
	if(not(GetSpellAbilityId()=='A04K'))then
		return false
	endif
	if(not(udg_BJplayersTurnHit[1]==true))then
		return false
	endif
	if(not(udg_BJPlaying[1]==true))then
		return false
	endif
	if(not(udg_BJCanHit[1]==true))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Player_Hits_Func003C takes nothing returns boolean
	if(not(udg_BJPlayerNO[1]==21))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Player_Hits_Func004C takes nothing returns boolean
	if(not(udg_BJPlayerNO[1]==22))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Player_Hits_Func005Func007C takes nothing returns boolean
	if(not(udg_BJpAnotherCard[1]==1))then
		return false
	endif
	if(not(udg_BJPlayerNO[1]>=11))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Player_Hits_Func005Func008C takes nothing returns boolean
	if(not(udg_BJhitTurnFIN[1]==false))then
		return false
	endif
	if(not(udg_BJpAnotherCard[1]==1))then
		return false
	endif
	if(not(udg_BJPlayerNO[1]<=10))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Player_Hits_Func005Func010C takes nothing returns boolean
	if(not(udg_BJhitTurnFIN[1]==false))then
		return false
	endif
	if(not(udg_BJpAnotherCard[1]>=10))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Player_Hits_Func005Func012C takes nothing returns boolean
	if(not(udg_BJhitTurnFIN[1]==false))then
		return false
	endif
	if(not(udg_BJpAnotherCard[1]>=2))then
		return false
	endif
	if(not(udg_BJpAnotherCard[1]<=9))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Player_Hits_Func005Func015C takes nothing returns boolean
	if(not(udg_BJPlayerNO[1]>=22))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Player_Hits_Func005Func016Func006003001 takes nothing returns boolean
	return(udg_BJPlayerNO[1]==GetForLoopIndexA())
endfunction
function Trig_BJ_Player_Hits_Func005Func016C takes nothing returns boolean
	if(not(udg_BJPlayerNO[1]<=21))then
		return false
	endif
	if(not(udg_BJPlayerNO[1]!=0))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Player_Hits_Func005C takes nothing returns boolean
	if(not(udg_BJPfin[1]==false))then
		return false
	endif
	if(not(udg_BJPlayerNO[1]!=21))then
...
function Trig_BJ_Player_Hits_Actions takes nothing returns nothing
	set udg_BJhitTurnFIN[1]=false
	call PlaySoundAtPointBJ(gg_snd_Hit,100,GetUnitLoc(udg_BJTable[1]),0)
	if(Trig_BJ_Player_Hits_Func003C())then
		call CreateTextTagLocBJ("Can't Hit on 21",GetUnitLoc(gg_unit_h048_0045),0,10,100,100,0.00,0)
		call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
		call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
	else
	endif
	if(Trig_BJ_Player_Hits_Func004C())then
		call CreateTextTagLocBJ("Can't hit on Blackjack",GetUnitLoc(gg_unit_h048_0045),0,10,100,100,0.00,0)
		call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
		call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
	else
	endif
	if(Trig_BJ_Player_Hits_Func005C())then
		call CreateTextTagLocBJ("Hit me!",GetUnitLoc(GroupPickRandomUnit(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_BJTable[1]),'h045'))),0,10,100,100,0.00,0)
		call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
		call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
		set udg_BJpAnotherCard[1]=GetRandomInt(1,13)
		call TriggerSleepAction(0.25)
		if(Trig_BJ_Player_Hits_Func005Func007C())then
			set udg_BJPlayerNO[1]=(udg_BJPlayerNO[1]+1)
			call CreateTextTagLocBJ("Hits an Ace!",GetUnitLoc(udg_BJTable[1]),0,10,100,100,100.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),1.00)
			set udg_BJhitTurnFIN[1]=true
		else
		endif
		if(Trig_BJ_Player_Hits_Func005Func008C())then
			set udg_BJhitTurnFIN[1]=true
			set udg_BJPlayerNO[1]=(udg_BJPlayerNO[1]+11)
			call CreateTextTagLocBJ("Hits an Ace!",GetUnitLoc(udg_BJTable[1]),0,10,100,100,100.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
		...
		if(Trig_BJ_Player_Hits_Func005Func010C())then
			set udg_BJhitTurnFIN[1]=true
			set udg_BJPlayerNO[1]=(udg_BJPlayerNO[1]+10)
			call CreateTextTagLocBJ("Hits a 10",GetUnitLoc(udg_BJTable[1]),0,10,100,100,100.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),1.00)
		else
		endif
		if(Trig_BJ_Player_Hits_Func005Func012C())then
			set udg_BJhitTurnFIN[1]=true
			set udg_BJPlayerNO[1]=(udg_BJPlayerNO[1]+udg_BJpAnotherCard[1])
			call CreateTextTagLocBJ(("Hits a "+I2S(udg_BJpAnotherCard[1])),GetUnitLoc(udg_BJTable[1]),0,10,100,100,100.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),1.00)
		else
		endif
		call TriggerSleepAction(1.00)
		if(Trig_BJ_Player_Hits_Func005Func015C())then
			set udg_BJPfin[1]=false
			call CreateTextTagLocBJ("BUST!",GetUnitLoc(gg_unit_h048_0045),0,10,100,0.00,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
			call PlaySoundOnUnitBJ(gg_snd_PlayerBust,100,gg_unit_h048_0045)
			call TriggerSleepAction(2.00)
			call TriggerExecute(gg_trg_BJ_Reset_BJ_1)
		else
		endif
		if(Trig_BJ_Player_Hits_Func005Func016C())then
			call CreateTextTagLocBJ(("You have "+I2S(udg_BJPlayerNO[1])),GetUnitLoc(gg_unit_h048_0045),0,10,100,0.00,100.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
			set bj_forLoopAIndex=1
			...
			loop
				exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
				call UnitRemoveAbilityBJ(udg_CardsP[GetForLoopIndexA()],udg_BJTable[1])
				set bj_forLoopAIndex=bj_forLoopAIndex+1
			endloop
			...
			loop
				exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
				if(Trig_BJ_Player_Hits_Func005Func016Func006003001())then
					call UnitAddAbilityBJ(udg_CardsP[GetForLoopIndexA()],udg_BJTable[1])
				else
					call DoNothing()
				endif
...
function InitTrig_BJ_Player_Hits takes nothing returns nothing
	set gg_trg_BJ_Player_Hits=CreateTrigger()
	call TriggerRegisterUnitEvent(gg_trg_BJ_Player_Hits,gg_unit_h047_0044,EVENT_UNIT_SPELL_CAST)
	call TriggerAddCondition(gg_trg_BJ_Player_Hits,Condition(function Trig_BJ_Player_Hits_Conditions))
	call TriggerAddAction(gg_trg_BJ_Player_Hits,function Trig_BJ_Player_Hits_Actions)
endfunction
function Trig_BJ_Dealers_Hit_Conditions takes nothing returns boolean
...
function Trig_BJ_Dealers_Hit_Func008Func004001 takes nothing returns boolean
	return(udg_BJdanothCard[1]>=10)
endfunction
function Trig_BJ_Dealers_Hit_Func008Func009C takes nothing returns boolean
	if(not(udg_BJDealersNO[1]==1))then
		return false
	endif
	if(not(udg_BJdanothCard[1]==10))then
		return false
	endif
	if(not(udg_BJDfin[1]==false))then
		return false
	endif
	if(not(udg_BJDfinHit[1]==false))then
		return false
	endif
	if(not(udg_BJD1stHit[1]==true))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Dealers_Hit_Func008Func010C takes nothing returns boolean
	if(not(udg_BJDealersNO[1]==10))then
		return false
	endif
	if(not(udg_BJdanothCard[1]==1))then
		return false
	endif
	if(not(udg_BJD1stHit[1]==true))then
		return false
...
function Trig_BJ_Dealers_Hit_Func008Func013Func003003001 takes nothing returns boolean
	return(udg_BJDealersNO[1]==GetForLoopIndexA())
endfunction
function Trig_BJ_Dealers_Hit_Func008Func013Func007C takes nothing returns boolean
	if(not(udg_BJDealersNO[1]<=21))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Dealers_Hit_Func008Func013C takes nothing returns boolean
	if(not(udg_BJDealersNO[1]>=11))then
		return false
	endif
	if(not(udg_BJdanothCard[1]==1))then
		return false
...
function Trig_BJ_Dealers_Hit_Func008Func014Func003003001 takes nothing returns boolean
	return(udg_BJDealersNO[1]==GetForLoopIndexA())
endfunction
function Trig_BJ_Dealers_Hit_Func008Func014Func007C takes nothing returns boolean
	if(not(udg_BJDealersNO[1]<=21))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Dealers_Hit_Func008Func014C takes nothing returns boolean
	if(not(udg_BJDealersNO[1]<=10))then
		return false
	endif
	if(not(udg_BJdanothCard[1]==1))then
...
function Trig_BJ_Dealers_Hit_Func008Func016Func003001 takes nothing returns boolean
	return(udg_BJDealersNO[1]==1)
endfunction
function Trig_BJ_Dealers_Hit_Func008Func016Func006003001 takes nothing returns boolean
	return(udg_BJDealersNO[1]==GetForLoopIndexA())
endfunction
function Trig_BJ_Dealers_Hit_Func008Func016Func007001 takes nothing returns boolean
	return(udg_BJDealersNO[1]>=22)
endfunction
function Trig_BJ_Dealers_Hit_Func008Func016Func011C takes nothing returns boolean
	if(not(udg_BJDealersNO[1]<=21))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Dealers_Hit_Func008Func016C takes nothing returns boolean
	if(not(udg_BJDfin[1]==false))then
		return false
	endif
	if(not(udg_BJDfinHit[1]==false))then
...
function Trig_BJ_Dealers_Hit_Func008Func019Func005C takes nothing returns boolean
	if(not(udg_BJPlayerNO[1]==22))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Dealers_Hit_Func008Func019C takes nothing returns boolean
	if(not(udg_BJDfinHit[1]==true))then
		return false
	endif
	if(not(udg_BJDfin[1]==false))then
		return false
	endif
	if(not(udg_BJDealersNO[1]>=22))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Dealers_Hit_Func008Func021C takes nothing returns boolean
	if(not(udg_BJDfinHit[1]==true))then
		return false
	endif
	if(not(udg_BJDfin[1]==false))then
	...
	if(not(udg_BJDealersNO[1]<=16))then
		return false
	endif
	if(not(udg_BJDealersNO[1]!=0))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Dealers_Hit_Func008Func023C takes nothing returns boolean
	if(not(udg_BJDfinHit[1]==true))then
		return false
	endif
	if(not(udg_BJDealersNO[1]>=17))then
		return false
	endif
	if(not(udg_BJDealersNO[1]<=21))then
		return false
...
function Trig_BJ_Dealers_Hit_Func008C takes nothing returns boolean
	if(not(udg_BJDealersNO[1]>=1))then
		return false
	endif
	if(not(udg_BJDealersNO[1]<=16))then
...
function Trig_BJ_Dealers_Hit_Actions takes nothing returns nothing
	set udg_BJplayersTurnHit[1]=false
	set udg_BJCanHit[1]=false
	call DisableTrigger(GetTriggeringTrigger())
	if(Trig_BJ_Dealers_Hit_Func008C())then
		call TriggerSleepAction(1.75)
		set udg_BJDfinHit[1]=false
		set udg_BJdanothCard[1]=GetRandomInt(1,13)
		if(Trig_BJ_Dealers_Hit_Func008Func004001())then
			set udg_BJdanothCard[1]=10
		else
			call DoNothing()
		endif
		set bj_forLoopAIndex=1
		...
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			call UnitRemoveAbilityBJ(udg_CardsD[GetForLoopIndexA()],udg_BJTable[1])
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		endloop
		call TriggerSleepAction(0.25)
		call PlaySoundAtPointBJ(gg_snd_Hit,100,GetUnitLoc(udg_BJTable[1]),0)
		if(Trig_BJ_Dealers_Hit_Func008Func009C())then
			set udg_BJDfinHit[1]=true
			set udg_BJDealersNO[1]=22
			set udg_BJDfin[1]=true
			call UnitAddAbilityBJ('A056',udg_BJTable[1])
			call CreateTextTagLocBJ("I HAVE BLACKJACK!",GetUnitLoc(gg_unit_h048_0045),0,10,100,100.00,100.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
			call TriggerSleepAction(2)
			call ConditionalTriggerExecute(gg_trg_BJ_PlayerDealer_Runoff)
		else
		endif
		if(Trig_BJ_Dealers_Hit_Func008Func010C())then
			set udg_BJDfinHit[1]=true
			set udg_BJDfin[1]=true
			set udg_BJDealersNO[1]=22
			call UnitAddAbilityBJ('A056',udg_BJTable[1])
		...
		set udg_BJD1stHit[1]=false
		if(Trig_BJ_Dealers_Hit_Func008Func013C())then
			set udg_BJDealersNO[1]=(udg_BJDealersNO[1]+11)
			set udg_BJDfinHit[1]=true
			set bj_forLoopAIndex=1
			set bj_forLoopAIndexEnd=21
			loop
				exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
				if(Trig_BJ_Dealers_Hit_Func008Func013Func003003001())then
					call UnitAddAbilityBJ(udg_CardsD[GetForLoopIndexA()],udg_BJTable[1])
				else
					call DoNothing()
				endif
				set bj_forLoopAIndex=bj_forLoopAIndex+1
			endloop
			call CreateTextTagLocBJ("I hit an ace!",GetUnitLoc(gg_unit_h048_0045),0,10,100,100.00,100.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
			if(Trig_BJ_Dealers_Hit_Func008Func013Func007C())then
				call CreateTextTagLocBJ(("Dealer Has "+I2S(udg_BJDealersNO[1])),GetUnitLoc(udg_BJTable[1]),0,10,100,100.00,100.00,0)
				call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
				call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
			else
			endif
		...
		if(Trig_BJ_Dealers_Hit_Func008Func014C())then
			set udg_BJDealersNO[1]=(udg_BJDealersNO[1]+11)
			set udg_BJDfinHit[1]=true
			set bj_forLoopAIndex=1
			set bj_forLoopAIndexEnd=21
			loop
				exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
				if(Trig_BJ_Dealers_Hit_Func008Func014Func003003001())then
					call UnitAddAbilityBJ(udg_CardsD[GetForLoopIndexA()],udg_BJTable[1])
				else
					call DoNothing()
				endif
			...
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
			if(Trig_BJ_Dealers_Hit_Func008Func014Func007C())then
				call CreateTextTagLocBJ(("Dealer Has "+I2S(udg_BJDealersNO[1])),GetUnitLoc(udg_BJTable[1]),0,10,100,100.00,100.00,0)
				call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
				call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
			else
		...
		if(Trig_BJ_Dealers_Hit_Func008Func016C())then
			set udg_BJplayersTurnHit[1]=true
			set udg_BJDfinHit[1]=true
			if(Trig_BJ_Dealers_Hit_Func008Func016Func003001())then
				set udg_BJDealersNO[1]=11
			else
				call DoNothing()
			endif
			set udg_BJDealersNO[1]=(udg_BJDealersNO[1]+udg_BJdanothCard[1])
			call TriggerSleepAction(0.25)
			set bj_forLoopAIndex=1
			set bj_forLoopAIndexEnd=21
			loop
				exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
				if(Trig_BJ_Dealers_Hit_Func008Func016Func006003001())then
					call UnitAddAbilityBJ(udg_CardsD[GetForLoopIndexA()],udg_BJTable[1])
				else
					call DoNothing()
				endif
				set bj_forLoopAIndex=bj_forLoopAIndex+1
			endloop
			if(Trig_BJ_Dealers_Hit_Func008Func016Func007001())then
				call UnitAddAbilityBJ('A05I',udg_BJTable[1])
			else
				call DoNothing()
			endif
			call CreateTextTagLocBJ(("I hit a "+I2S(udg_BJdanothCard[1])),GetUnitLoc(gg_unit_h048_0045),0,10,100,100.00,100.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
			if(Trig_BJ_Dealers_Hit_Func008Func016Func011C())then
				call CreateTextTagLocBJ(("Dealer Has "+I2S(udg_BJDealersNO[1])),GetUnitLoc(udg_BJTable[1]),0,10,100,100.00,100.00,0)
				call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
				call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
			else
		...
		call TriggerSleepAction(2)
		if(Trig_BJ_Dealers_Hit_Func008Func019C())then
			call CreateTextTagLocBJ("I have Busted!",GetUnitLoc(gg_unit_h048_0045),0,10,100,0.00,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
			call PlaySoundOnUnitBJ(gg_snd_Gold3sym,100,udg_BJTable[1])
			if(Trig_BJ_Dealers_Hit_Func008Func019Func005C())then
				call AdjustPlayerStateBJ(25,GetOwningPlayer(udg_BJTable[1]),PLAYER_STATE_RESOURCE_GOLD)
				call CreateTextTagLocBJ("Blackjack Pays 3 to 2",GetUnitLoc(udg_BJTable[1]),0,10,100,100.00,100.00,0)
				call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
				call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
				call CreateTextTagLocBJ("+25",GetUnitLoc(GroupPickRandomUnit(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_BJTable[1]),'h045'))),0,10,100,100.00,0.00,0)
				call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
				call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
			else
				call AdjustPlayerStateBJ(20,GetOwningPlayer(udg_BJTable[1]),PLAYER_STATE_RESOURCE_GOLD)
				call CreateTextTagLocBJ("+20",GetUnitLoc(GroupPickRandomUnit(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_BJTable[1]),'h045'))),0,10,100,100.00,0.00,0)
				call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
				call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
			endif
			set udg_BJDfin[1]=true
			...
			set udg_BJDfin[1]=true
			call TriggerSleepAction(0.05)
			call ConditionalTriggerExecute(gg_trg_BJ_Reset_BJ_1)
		else
		endif
		if(Trig_BJ_Dealers_Hit_Func008Func021C())then
			call CreateTextTagLocBJ("I will hit again...",GetUnitLoc(gg_unit_h048_0045),0,10,100,0.00,100.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
			call EnableTrigger(GetTriggeringTrigger())
			call TriggerExecute(GetTriggeringTrigger())
		...
		if(Trig_BJ_Dealers_Hit_Func008Func023C())then
			set udg_BJDfin[1]=true
			call CreateTextTagLocBJ(("I will stay on "+I2S(udg_BJDealersNO[1])),GetUnitLoc(gg_unit_h048_0045),0,10,0.00,100.00,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
			call ConditionalTriggerExecute(gg_trg_BJ_PlayerDealer_Runoff)
		else
...
function InitTrig_BJ_Dealers_Hit takes nothing returns nothing
	set gg_trg_BJ_Dealers_Hit=CreateTrigger()
	call TriggerRegisterUnitEvent(gg_trg_BJ_Dealers_Hit,gg_unit_h047_0044,EVENT_UNIT_SPELL_CAST)
	call TriggerAddCondition(gg_trg_BJ_Dealers_Hit,Condition(function Trig_BJ_Dealers_Hit_Conditions))
	call TriggerAddAction(gg_trg_BJ_Dealers_Hit,function Trig_BJ_Dealers_Hit_Actions)
endfunction
function Trig_BJ_Reset_BJ_1_Actions takes nothing returns nothing
	set udg_BJplayersTurnHit[1]=true
	set udg_BJCanHit[1]=true
	set udg_BJD1stHit[1]=true
	set udg_BJhitTurnFIN[1]=false
	set udg_BJDealersNO[1]=0
	set udg_BJDfin[1]=false
	set udg_BJPfin[1]=false
	set udg_BJPlayerNO[1]=0
	set udg_BJPlaying[1]=false
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=25
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
	...
	loop
		...
		set bj_forLoopAIndex=bj_forLoopAIndex+1
	endloop
	call EnableTrigger(gg_trg_BJ_Player_Stays)
	call EnableTrigger(gg_trg_BJ_Dealers_Hit)
endfunction
function InitTrig_BJ_Reset_BJ_1 takes nothing returns nothing
	set gg_trg_BJ_Reset_BJ_1=CreateTrigger()
	call TriggerAddAction(gg_trg_BJ_Reset_BJ_1,function Trig_BJ_Reset_BJ_1_Actions)
endfunction
function Trig_BJ_Player_Stays_Conditions takes nothing returns boolean
	if(not(GetSpellAbilityId()=='A04L'))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Player_Stays_Func003C takes nothing returns boolean
	if(not(udg_BJDealersNO[1]==1))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Player_Stays_Func005C takes nothing returns boolean
	if(not(udg_BJPlayerNO[1]<=21))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Player_Stays_Func006C takes nothing returns boolean
	if(not(udg_BJPlayerNO[1]==22))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Player_Stays_Actions takes nothing returns nothing
	call DisableTrigger(GetTriggeringTrigger())
	call PlaySoundOnUnitBJ(gg_snd_Stay,100,udg_BJTable[1])
	if(Trig_BJ_Player_Stays_Func003C())then
		call CreateTextTagLocBJ("Dealer has an Ace",GetUnitLoc(udg_BJTable[1]),0,10,100,100.00,100.00,0)
		call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
		call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
	else
		call CreateTextTagLocBJ(("Dealer has "+I2S(udg_BJDealersNO[1])),GetUnitLoc(udg_BJTable[1]),0,10,100,100.00,100.00,0)
	...
	call TriggerSleepAction(0.50)
	if(Trig_BJ_Player_Stays_Func005C())then
		call CreateTextTagLocBJ(("I'll Stay on "+I2S(udg_BJPlayerNO[1])),GetUnitLoc(GroupPickRandomUnit(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_BJTable[1]),'h045'))),0,10,100,100.00,100.00,0)
		call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
		call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
	else
	endif
	if(Trig_BJ_Player_Stays_Func006C())then
		call CreateTextTagLocBJ("I'll Stay on BlackJack Ofcourse!",GetUnitLoc(GroupPickRandomUnit(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_BJTable[1]),'h045'))),0,10,100,100.00,100.00,0)
		call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
		call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
	else
	endif
endfunction
function InitTrig_BJ_Player_Stays takes nothing returns nothing
	set gg_trg_BJ_Player_Stays=CreateTrigger()
	call TriggerRegisterUnitEvent(gg_trg_BJ_Player_Stays,gg_unit_h047_0044,EVENT_UNIT_SPELL_CAST)
	call TriggerAddCondition(gg_trg_BJ_Player_Stays,Condition(function Trig_BJ_Player_Stays_Conditions))
	call TriggerAddAction(gg_trg_BJ_Player_Stays,function Trig_BJ_Player_Stays_Actions)
endfunction
function Trig_BJ_PlayerDealer_Runoff_Func003C takes nothing returns boolean
	if(not(udg_BJPlayerNO[1]!=22))then
		return false
	endif
	return true
endfunction
function Trig_BJ_PlayerDealer_Runoff_Func004C takes nothing returns boolean
	if(not(udg_BJPlayerNO[1]==22))then
		return false
	endif
	return true
endfunction
function Trig_BJ_PlayerDealer_Runoff_Func006C takes nothing returns boolean
	if(not(udg_BJDealersNO[1]==22))then
		return false
	endif
	return true
endfunction
function Trig_BJ_PlayerDealer_Runoff_Func007C takes nothing returns boolean
	if(not(udg_BJDealersNO[1]!=22))then
		return false
	endif
	return true
endfunction
function Trig_BJ_PlayerDealer_Runoff_Func010C takes nothing returns boolean
	if(not(udg_BJDealersNO[1]==udg_BJPlayerNO[1]))then
		return false
	endif
	return true
endfunction
function Trig_BJ_PlayerDealer_Runoff_Func012C takes nothing returns boolean
	if(not(udg_BJDealersNO[1]>udg_BJPlayerNO[1]))then
		return false
	endif
	return true
endfunction
function Trig_BJ_PlayerDealer_Runoff_Func014Func003C takes nothing returns boolean
	if(not(udg_BJPlayerNO[1]==22))then
		return false
	endif
	return true
endfunction
function Trig_BJ_PlayerDealer_Runoff_Func014Func004C takes nothing returns boolean
	if(not(udg_BJPlayerNO[1]!=22))then
		return false
	endif
	return true
endfunction
function Trig_BJ_PlayerDealer_Runoff_Func014C takes nothing returns boolean
	if(not(udg_BJDealersNO[1]<udg_BJPlayerNO[1]))then
		return false
	endif
	return true
endfunction
function Trig_BJ_PlayerDealer_Runoff_Actions takes nothing returns nothing
	call TriggerSleepAction(1.00)
	call TriggerSleepAction(1.00)
	if(Trig_BJ_PlayerDealer_Runoff_Func003C())then
		call CreateTextTagLocBJ(("You Have "+I2S(udg_BJPlayerNO[1])),GetUnitLoc(udg_BJTable[1]),0,10,100,100.00,100.00,0)
		call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
		call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
	else
	endif
	if(Trig_BJ_PlayerDealer_Runoff_Func004C())then
		call CreateTextTagLocBJ(("You Have "+"BLACKJACK!"),GetUnitLoc(udg_BJTable[1]),0,10,100,100.00,100.00,0)
		call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
		call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
	else
	endif
	call TriggerSleepAction(0.50)
	if(Trig_BJ_PlayerDealer_Runoff_Func006C())then
		call CreateTextTagLocBJ(("Dealer has "+"BLACKJACK"),GetUnitLoc(gg_unit_h048_0045),0,10,100,100.00,100.00,0)
		call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
		call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
	else
	endif
	if(Trig_BJ_PlayerDealer_Runoff_Func007C())then
		call CreateTextTagLocBJ(("Dealer has "+I2S(udg_BJDealersNO[1])),GetUnitLoc(gg_unit_h048_0045),0,10,100,100.00,100.00,0)
		call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
		call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
	else
	endif
	call TriggerSleepAction(2)
	if(Trig_BJ_PlayerDealer_Runoff_Func010C())then
		call TriggerSleepAction(1.00)
		call CreateTextTagLocBJ("+10 Gold",GetUnitLoc(GroupPickRandomUnit(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_BJTable[1]),'h045'))),0,10,100,100.00,0.00,0)
		call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
		call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
		call CreateTextTagLocBJ("Stand off - returning 10 gold",GetUnitLoc(gg_unit_h048_0045),0,10,100,100.00,100.00,0)
		call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
		call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
		call AdjustPlayerStateBJ(10,GetOwningPlayer(udg_BJTable[1]),PLAYER_STATE_RESOURCE_GOLD)
		call ConditionalTriggerExecute(gg_trg_BJ_Reset_BJ_1)
		call PlaySoundOnUnitBJ(gg_snd_StandOff,75.00,udg_BJTable[1])
	else
	endif
	if(Trig_BJ_PlayerDealer_Runoff_Func012C())then
		call TriggerSleepAction(1.00)
		call PlaySoundOnUnitBJ(gg_snd_PlayerBust,100,gg_unit_h048_0045)
		call CreateTextTagLocBJ("I WIN!!",GetUnitLoc(gg_unit_h048_0045),0,10,100,0.00,0.00,0)
		call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
		call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
		call ConditionalTriggerExecute(gg_trg_BJ_Reset_BJ_1)
	else
	endif
	if(Trig_BJ_PlayerDealer_Runoff_Func014C())then
		call TriggerSleepAction(1.00)
		call PlaySoundOnUnitBJ(gg_snd_Gold3sym,100,udg_BJTable[1])
		if(Trig_BJ_PlayerDealer_Runoff_Func014Func003C())then
			call CreateTextTagLocBJ("+25 Gold",GetUnitLoc(GroupPickRandomUnit(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_BJTable[1]),'h045'))),0,10,100,100.00,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
			call CreateTextTagLocBJ("BlackJack Pays 3 to 2! Nice!",GetUnitLoc(gg_unit_h048_0045),0,10,0.00,100.00,100.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
			call AdjustPlayerStateBJ(25,GetOwningPlayer(udg_BJTable[1]),PLAYER_STATE_RESOURCE_GOLD)
		else
		endif
		if(Trig_BJ_PlayerDealer_Runoff_Func014Func004C())then
			call CreateTextTagLocBJ("+20 Gold",GetUnitLoc(GroupPickRandomUnit(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_BJTable[1]),'h045'))),0,10,100,100.00,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
			call CreateTextTagLocBJ("You win, Well done!",GetUnitLoc(gg_unit_h048_0045),0,10,100,100.00,100.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
			call AdjustPlayerStateBJ(20,GetOwningPlayer(udg_BJTable[1]),PLAYER_STATE_RESOURCE_GOLD)
		else
...
function InitTrig_BJ_PlayerDealer_Runoff takes nothing returns nothing
	set gg_trg_BJ_PlayerDealer_Runoff=CreateTrigger()
	call TriggerAddAction(gg_trg_BJ_PlayerDealer_Runoff,function Trig_BJ_PlayerDealer_Runoff_Actions)
endfunction
function Trig_BJ_Leave_2_Conditions takes nothing returns boolean
	if(not(GetUnitTypeId(GetTrainedUnit())=='h046'))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Leave_2_Func002Func002002 takes nothing returns nothing
	call PauseUnitBJ(false,GetEnumUnit())
endfunction
function Trig_BJ_Leave_2_Func002Func004002 takes nothing returns nothing
	call IssuePointOrderLocBJ(GetEnumUnit(),"move",GetRectCenter(gg_rct_Slot_BJRUN_2))
endfunction
function Trig_BJ_Leave_2_Func002C takes nothing returns boolean
	if(not(udg_BJPlaying[2]==false))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Leave_2_Func003Func001001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_BJTable[2])==GetFilterPlayer())
endfunction
function Trig_BJ_Leave_2_Func003C takes nothing returns boolean
	if(not(udg_BJPlaying[2]==true))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Leave_2_Actions takes nothing returns nothing
	call RemoveUnit(GetTrainedUnit())
	if(Trig_BJ_Leave_2_Func002C())then
		set udg_WslotOccupied[5]=false
		call ForGroupBJ(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_BJTable[2]),'h045'),function Trig_BJ_Leave_2_Func002Func002002)
		call TriggerSleepAction(0.10)
		call ForGroupBJ(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_BJTable[2]),'h045'),function Trig_BJ_Leave_2_Func002Func004002)
		call TriggerSleepAction(0.40)
		call SetUnitOwner(udg_BJTable[2],Player(8),true)
		call EnableTrigger(gg_trg_BJ_Enter_2)
	else
	endif
	if(Trig_BJ_Leave_2_Func003C())then
		call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_BJ_Leave_2_Func003Func001001001)),"Can't Leave while Playing")
	else
	endif
endfunction
function InitTrig_BJ_Leave_2 takes nothing returns nothing
	set gg_trg_BJ_Leave_2=CreateTrigger()
	call TriggerRegisterUnitEvent(gg_trg_BJ_Leave_2,gg_unit_h047_0055,EVENT_UNIT_TRAIN_FINISH)
	call TriggerAddCondition(gg_trg_BJ_Leave_2,Condition(function Trig_BJ_Leave_2_Conditions))
	call TriggerAddAction(gg_trg_BJ_Leave_2,function Trig_BJ_Leave_2_Actions)
endfunction
function Trig_BJ_Enter_2_Conditions takes nothing returns boolean
	if(not(GetUnitTypeId(GetTriggerUnit())=='h045'))then
		return false
	endif
	if(not(udg_WslotOccupied[5]==false))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Enter_2_Actions takes nothing returns nothing
	call DisableTrigger(GetTriggeringTrigger())
	set udg_WslotOccupied[5]=true
	call PlaySoundOnUnitBJ(gg_snd_DealerGreet,100,gg_unit_h048_0056)
	call SetUnitOwner(udg_BJTable[2],GetOwningPlayer(GetTriggerUnit()),true)
	call SetUnitPositionLocFacingLocBJ(GetTriggerUnit(),GetUnitLoc(gg_unit_n007_0054),GetUnitLoc(udg_BJTable[2]))
	call PauseUnitBJ(true,GetTriggerUnit())
endfunction
function InitTrig_BJ_Enter_2 takes nothing returns nothing
	set gg_trg_BJ_Enter_2=CreateTrigger()
	call TriggerRegisterUnitInRangeSimple(gg_trg_BJ_Enter_2,50.00,gg_unit_n007_0054)
	call TriggerAddCondition(gg_trg_BJ_Enter_2,Condition(function Trig_BJ_Enter_2_Conditions))
	call TriggerAddAction(gg_trg_BJ_Enter_2,function Trig_BJ_Enter_2_Actions)
endfunction
function Trig_BJ_Start_up_2_Conditions takes nothing returns boolean
	if(not(GetUnitTypeId(GetTrainedUnit())=='h049'))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Start_up_2_Func002Func001001001 takes nothing returns boolean
	return(GetOwningPlayer(udg_BJTable[2])==GetFilterPlayer())
endfunction
function Trig_BJ_Start_up_2_Func002C takes nothing returns boolean
	if(not(udg_BJPlaying[2]==true))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Start_up_2_Func003Func001003001 takes nothing returns boolean
	return(GetOwningPlayer(udg_BJTable[2])==udg_Player[GetForLoopIndexA()])
endfunction
function Trig_BJ_Start_up_2_Func003Func005001 takes nothing returns boolean
	return(udg_BJDealersNO[2]==1)
endfunction
function Trig_BJ_Start_up_2_Func003Func006001 takes nothing returns boolean
	return(udg_BJDealersNO[2]==2)
endfunction
function Trig_BJ_Start_up_2_Func003Func007001 takes nothing returns boolean
	return(udg_BJDealersNO[2]==3)
endfunction
function Trig_BJ_Start_up_2_Func003Func008001 takes nothing returns boolean
	return(udg_BJDealersNO[2]==4)
endfunction
function Trig_BJ_Start_up_2_Func003Func009001 takes nothing returns boolean
	return(udg_BJDealersNO[2]==5)
endfunction
function Trig_BJ_Start_up_2_Func003Func010001 takes nothing returns boolean
	return(udg_BJDealersNO[2]==6)
endfunction
function Trig_BJ_Start_up_2_Func003Func011001 takes nothing returns boolean
	return(udg_BJDealersNO[2]==7)
endfunction
function Trig_BJ_Start_up_2_Func003Func012001 takes nothing returns boolean
	return(udg_BJDealersNO[2]==8)
endfunction
function Trig_BJ_Start_up_2_Func003Func013001 takes nothing returns boolean
	return(udg_BJDealersNO[2]==9)
endfunction
function Trig_BJ_Start_up_2_Func003Func014001 takes nothing returns boolean
	return(udg_BJDealersNO[2]>=10)
endfunction
function Trig_BJ_Start_up_2_Func003Func015001 takes nothing returns boolean
	return(udg_BJDealersNO[2]>=10)
endfunction
function Trig_BJ_Start_up_2_Func003Func020C takes nothing returns boolean
	if(not(udg_BJp1stcard[2]==1))then
		return false
	endif
	if(not(udg_BJp2ndcard[2]>=10))then
		return false
	endif
	if(not(udg_BJp2ndcard[2]<=13))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Start_up_2_Func003Func021C takes nothing returns boolean
	if(not(udg_BJp2ndcard[2]==1))then
		return false
	endif
	if(not(udg_BJp1stcard[2]>=10))then
		return false
	endif
	if(not(udg_BJp1stcard[2]<=13))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Start_up_2_Func003Func023Func001001001 takes nothing returns boolean
	return(udg_BJp1stcard[2]>=1)
endfunction
function Trig_BJ_Start_up_2_Func003Func023Func001001002 takes nothing returns boolean
	return(udg_BJp1stcard[2]<=9)
endfunction
function Trig_BJ_Start_up_2_Func003Func023Func001001 takes nothing returns boolean
	return GetBooleanAnd(Trig_BJ_Start_up_2_Func003Func023Func001001001(),Trig_BJ_Start_up_2_Func003Func023Func001001002())
endfunction
function Trig_BJ_Start_up_2_Func003Func023Func002001001 takes nothing returns boolean
	return(udg_BJp2ndcard[2]>=2)
endfunction
function Trig_BJ_Start_up_2_Func003Func023Func002001002 takes nothing returns boolean
	return(udg_BJp2ndcard[2]<=9)
endfunction
function Trig_BJ_Start_up_2_Func003Func023Func002001 takes nothing returns boolean
	return GetBooleanAnd(Trig_BJ_Start_up_2_Func003Func023Func002001001(),Trig_BJ_Start_up_2_Func003Func023Func002001002())
endfunction
function Trig_BJ_Start_up_2_Func003Func023Func003001 takes nothing returns boolean
	return(udg_BJp2ndcard[2]==1)
endfunction
function Trig_BJ_Start_up_2_Func003Func023Func005001 takes nothing returns boolean
	return(udg_BJp1stcard[2]>=10)
endfunction
function Trig_BJ_Start_up_2_Func003Func023Func006001 takes nothing returns boolean
	return(udg_BJp2ndcard[2]>=10)
endfunction
function Trig_BJ_Start_up_2_Func003Func023Func007001 takes nothing returns boolean
	return(udg_BJPlayerNO[2]==3)
endfunction
function Trig_BJ_Start_up_2_Func003Func023Func009003001 takes nothing returns boolean
	return(udg_BJPlayerNO[2]==GetForLoopIndexA())
endfunction
function Trig_BJ_Start_up_2_Func003Func023C takes nothing returns boolean
	if(not(udg_BJPfin[2]==false))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Start_up_2_Func003Func024C takes nothing returns boolean
	if(not(udg_BJPlayerNO[2]<=21))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Start_up_2_Func003Func025C takes nothing returns boolean
	if(not(udg_BJDealersNO[2]>=2))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Start_up_2_Func003Func026C takes nothing returns boolean
	if(not(udg_BJDealersNO[2]==1))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Start_up_2_Func003C takes nothing returns boolean
	if(not(udg_BJPlaying[2]==false))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Start_up_2_Actions takes nothing returns nothing
	call RemoveUnit(GetTrainedUnit())
	if(Trig_BJ_Start_up_2_Func002C())then
		call DisplayTextToForce(GetPlayersMatching(Condition(function Trig_BJ_Start_up_2_Func002Func001001001)),"Already Playing, Adding Back 10 gold")
		call AdjustPlayerStateBJ(10,GetOwningPlayer(udg_BJTable[2]),PLAYER_STATE_RESOURCE_GOLD)
	else
	endif
	if(Trig_BJ_Start_up_2_Func003C())then
		set bj_forLoopAIndex=1
		set bj_forLoopAIndexEnd=8
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			if(Trig_BJ_Start_up_2_Func003Func001003001())then
				set udg_CountGambler[GetForLoopIndexA()]=(udg_CountGambler[GetForLoopIndexA()]+1)
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		endloop
		set udg_BJPlaying[2]=true
		set udg_BJDealersNO[2]=GetRandomInt(1,13)
		if(Trig_BJ_Start_up_2_Func003Func005001())then
			call UnitAddAbilityBJ('A04J',udg_BJTable[2])
		else
			call DoNothing()
		endif
		if(Trig_BJ_Start_up_2_Func003Func006001())then
			call UnitAddAbilityBJ('A04A',udg_BJTable[2])
		else
			call DoNothing()
		endif
		if(Trig_BJ_Start_up_2_Func003Func007001())then
			call UnitAddAbilityBJ('A04B',udg_BJTable[2])
		else
			call DoNothing()
		endif
		if(Trig_BJ_Start_up_2_Func003Func008001())then
			call UnitAddAbilityBJ('A04C',udg_BJTable[2])
		else
			call DoNothing()
		endif
		if(Trig_BJ_Start_up_2_Func003Func009001())then
			call UnitAddAbilityBJ('A04D',udg_BJTable[2])
		else
			call DoNothing()
		endif
		if(Trig_BJ_Start_up_2_Func003Func010001())then
			call UnitAddAbilityBJ('A04E',udg_BJTable[2])
		else
			call DoNothing()
		endif
		if(Trig_BJ_Start_up_2_Func003Func011001())then
			call UnitAddAbilityBJ('A04F',udg_BJTable[2])
		else
			call DoNothing()
		endif
		if(Trig_BJ_Start_up_2_Func003Func012001())then
			call UnitAddAbilityBJ('A04G',udg_BJTable[2])
		else
			call DoNothing()
		endif
		if(Trig_BJ_Start_up_2_Func003Func013001())then
			call UnitAddAbilityBJ('A04H',udg_BJTable[2])
		else
			call DoNothing()
		endif
		if(Trig_BJ_Start_up_2_Func003Func014001())then
			call UnitAddAbilityBJ('A04I',udg_BJTable[2])
		else
			call DoNothing()
		endif
		if(Trig_BJ_Start_up_2_Func003Func015001())then
			set udg_BJDealersNO[2]=10
		else
			call DoNothing()
		endif
		set udg_BJp1stcard[2]=GetRandomInt(1,13)
		set udg_BJp2ndcard[2]=GetRandomInt(1,13)
		if(Trig_BJ_Start_up_2_Func003Func020C())then
			call CreateTextTagLocBJ("I got BlackJack!!",GetUnitLoc(GroupPickRandomUnit(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_BJTable[2]),'h045'))),0,10,100,100.00,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
			set udg_BJPfin[2]=true
			call UnitAddAbilityBJ('A054',udg_BJTable[2])
			set udg_BJPlayerNO[2]=22
		else
		endif
		if(Trig_BJ_Start_up_2_Func003Func021C())then
			call CreateTextTagLocBJ("I got BlackJack!!",GetUnitLoc(GroupPickRandomUnit(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_BJTable[2]),'h045'))),0,10,100,100.00,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
			set udg_BJPfin[2]=true
		...
		if(Trig_BJ_Start_up_2_Func003Func023C())then
			if(Trig_BJ_Start_up_2_Func003Func023Func001001())then
				set udg_BJPlayerNO[2]=(udg_BJPlayerNO[2]+udg_BJp1stcard[2])
			else
				call DoNothing()
			endif
			if(Trig_BJ_Start_up_2_Func003Func023Func002001())then
				set udg_BJPlayerNO[2]=(udg_BJPlayerNO[2]+udg_BJp2ndcard[2])
			else
				call DoNothing()
			endif
			if(Trig_BJ_Start_up_2_Func003Func023Func003001())then
				set udg_BJPlayerNO[2]=(udg_BJPlayerNO[2]+11)
			else
				call DoNothing()
			endif
			if(Trig_BJ_Start_up_2_Func003Func023Func005001())then
				set udg_BJPlayerNO[2]=(udg_BJPlayerNO[2]+10)
			else
				call DoNothing()
			endif
			if(Trig_BJ_Start_up_2_Func003Func023Func006001())then
				set udg_BJPlayerNO[2]=(udg_BJPlayerNO[2]+10)
			else
				call DoNothing()
			endif
			if(Trig_BJ_Start_up_2_Func003Func023Func007001())then
				set udg_BJPlayerNO[2]=13
			else
				call DoNothing()
			endif
			set bj_forLoopAIndex=4
			...
			loop
				exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
				if(Trig_BJ_Start_up_2_Func003Func023Func009003001())then
					call UnitAddAbilityBJ(udg_CardsP[GetForLoopIndexA()],udg_BJTable[2])
				else
					call DoNothing()
				endif
				set bj_forLoopAIndex=bj_forLoopAIndex+1
		...
		if(Trig_BJ_Start_up_2_Func003Func024C())then
			call CreateTextTagLocBJ(("I have "+I2S(udg_BJPlayerNO[2])),GetUnitLoc(GroupPickRandomUnit(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_BJTable[2]),'h045'))),0,10,100,100,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
		else
		endif
		if(Trig_BJ_Start_up_2_Func003Func025C())then
			call CreateTextTagLocBJ(("Dealer has "+I2S(udg_BJDealersNO[2])),GetUnitLoc(gg_unit_h048_0056),0,10,100,100,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
		else
		endif
		if(Trig_BJ_Start_up_2_Func003Func026C())then
			call CreateTextTagLocBJ("Dealer has an Ace!",GetUnitLoc(gg_unit_h048_0056),0,10,100,100,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
		else
		endif
...
function InitTrig_BJ_Start_up_2 takes nothing returns nothing
	set gg_trg_BJ_Start_up_2=CreateTrigger()
	call TriggerRegisterUnitEvent(gg_trg_BJ_Start_up_2,gg_unit_h047_0055,EVENT_UNIT_TRAIN_FINISH)
	call TriggerAddCondition(gg_trg_BJ_Start_up_2,Condition(function Trig_BJ_Start_up_2_Conditions))
	call TriggerAddAction(gg_trg_BJ_Start_up_2,function Trig_BJ_Start_up_2_Actions)
endfunction
function Trig_BJ_Player_Hits_2_Conditions takes nothing returns boolean
	if(not(GetSpellAbilityId()=='A04K'))then
		return false
	endif
	if(not(udg_BJplayersTurnHit[2]==true))then
		return false
	endif
	if(not(udg_BJPlaying[2]==true))then
		return false
	endif
	if(not(udg_BJCanHit[2]==true))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Player_Hits_2_Func003C takes nothing returns boolean
	if(not(udg_BJPlayerNO[2]==21))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Player_Hits_2_Func004C takes nothing returns boolean
	if(not(udg_BJPlayerNO[2]==22))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Player_Hits_2_Func005Func007C takes nothing returns boolean
	if(not(udg_BJpAnotherCard[2]==1))then
		return false
	endif
	if(not(udg_BJPlayerNO[2]>=11))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Player_Hits_2_Func005Func008C takes nothing returns boolean
	if(not(udg_BJhitTurnFIN[2]==false))then
		return false
	endif
	if(not(udg_BJpAnotherCard[2]==1))then
		return false
	endif
	if(not(udg_BJPlayerNO[2]<=10))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Player_Hits_2_Func005Func010C takes nothing returns boolean
	if(not(udg_BJhitTurnFIN[2]==false))then
		return false
	endif
	if(not(udg_BJpAnotherCard[2]>=10))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Player_Hits_2_Func005Func012C takes nothing returns boolean
	if(not(udg_BJhitTurnFIN[2]==false))then
		return false
	endif
	if(not(udg_BJpAnotherCard[2]>=2))then
		return false
	endif
	if(not(udg_BJpAnotherCard[2]<=9))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Player_Hits_2_Func005Func015C takes nothing returns boolean
	if(not(udg_BJPlayerNO[2]>=22))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Player_Hits_2_Func005Func016Func006003001 takes nothing returns boolean
	return(udg_BJPlayerNO[2]==GetForLoopIndexA())
endfunction
function Trig_BJ_Player_Hits_2_Func005Func016C takes nothing returns boolean
	if(not(udg_BJPlayerNO[2]<=21))then
		return false
	endif
	if(not(udg_BJPlayerNO[2]!=0))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Player_Hits_2_Func005C takes nothing returns boolean
	if(not(udg_BJPfin[2]==false))then
		return false
	endif
	if(not(udg_BJPlayerNO[2]!=21))then
...
function Trig_BJ_Player_Hits_2_Actions takes nothing returns nothing
	set udg_BJhitTurnFIN[2]=false
	call PlaySoundAtPointBJ(gg_snd_Hit,100,GetUnitLoc(udg_BJTable[2]),0)
	if(Trig_BJ_Player_Hits_2_Func003C())then
		call CreateTextTagLocBJ("Can't Hit on 21",GetUnitLoc(gg_unit_h048_0056),0,10,100,100,0.00,0)
		call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
		call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
	else
	endif
	if(Trig_BJ_Player_Hits_2_Func004C())then
		call CreateTextTagLocBJ("Can't hit on Blackjack",GetUnitLoc(gg_unit_h048_0056),0,10,100,100,0.00,0)
		call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
		call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
	else
	endif
	if(Trig_BJ_Player_Hits_2_Func005C())then
		call CreateTextTagLocBJ("Hit me!",GetUnitLoc(GroupPickRandomUnit(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_BJTable[2]),'h045'))),0,10,100,100,0.00,0)
		call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
		call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
		set udg_BJpAnotherCard[2]=GetRandomInt(1,13)
		call TriggerSleepAction(0.25)
		if(Trig_BJ_Player_Hits_2_Func005Func007C())then
			set udg_BJPlayerNO[2]=(udg_BJPlayerNO[2]+1)
			call CreateTextTagLocBJ("Hits an Ace!",GetUnitLoc(udg_BJTable[2]),0,10,100,100,100.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),1.00)
			set udg_BJhitTurnFIN[2]=true
		else
		endif
		if(Trig_BJ_Player_Hits_2_Func005Func008C())then
			set udg_BJhitTurnFIN[2]=true
			set udg_BJPlayerNO[2]=(udg_BJPlayerNO[2]+11)
			call CreateTextTagLocBJ("Hits an Ace!",GetUnitLoc(udg_BJTable[2]),0,10,100,100,100.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
		...
		if(Trig_BJ_Player_Hits_2_Func005Func010C())then
			set udg_BJhitTurnFIN[2]=true
			set udg_BJPlayerNO[2]=(udg_BJPlayerNO[2]+10)
			call CreateTextTagLocBJ("Hits a 10",GetUnitLoc(udg_BJTable[2]),0,10,100,100,100.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),1.00)
		else
		endif
		if(Trig_BJ_Player_Hits_2_Func005Func012C())then
			set udg_BJhitTurnFIN[2]=true
			set udg_BJPlayerNO[2]=(udg_BJPlayerNO[2]+udg_BJpAnotherCard[2])
			call CreateTextTagLocBJ(("Hits a "+I2S(udg_BJpAnotherCard[2])),GetUnitLoc(udg_BJTable[2]),0,10,100,100,100.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),1.00)
		else
		endif
		call TriggerSleepAction(1.00)
		if(Trig_BJ_Player_Hits_2_Func005Func015C())then
			set udg_BJPfin[2]=false
			call CreateTextTagLocBJ("BUST!",GetUnitLoc(gg_unit_h048_0056),0,10,100,0.00,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
			call PlaySoundOnUnitBJ(gg_snd_PlayerBust,100,gg_unit_h048_0056)
			call TriggerSleepAction(2.00)
			call TriggerExecute(gg_trg_BJ_Reset_BJ_2)
		else
		endif
		if(Trig_BJ_Player_Hits_2_Func005Func016C())then
			call CreateTextTagLocBJ(("You have "+I2S(udg_BJPlayerNO[2])),GetUnitLoc(gg_unit_h048_0056),0,10,100,0.00,100.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
			set bj_forLoopAIndex=1
			set bj_forLoopAIndexEnd=25
			loop
				exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
				call UnitRemoveAbilityBJ(udg_CardsP[GetForLoopIndexA()],udg_BJTable[2])
				set bj_forLoopAIndex=bj_forLoopAIndex+1
			endloop
			call TriggerSleepAction(0.15)
			set bj_forLoopAIndex=4
			...
			loop
				exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
				if(Trig_BJ_Player_Hits_2_Func005Func016Func006003001())then
					call UnitAddAbilityBJ(udg_CardsP[GetForLoopIndexA()],udg_BJTable[2])
				else
					call DoNothing()
				endif
...
function InitTrig_BJ_Player_Hits_2 takes nothing returns nothing
	set gg_trg_BJ_Player_Hits_2=CreateTrigger()
	call TriggerRegisterUnitEvent(gg_trg_BJ_Player_Hits_2,gg_unit_h047_0055,EVENT_UNIT_SPELL_CAST)
	call TriggerAddCondition(gg_trg_BJ_Player_Hits_2,Condition(function Trig_BJ_Player_Hits_2_Conditions))
	call TriggerAddAction(gg_trg_BJ_Player_Hits_2,function Trig_BJ_Player_Hits_2_Actions)
endfunction
function Trig_BJ_Dealers_Hit_2_Conditions takes nothing returns boolean
	if(not(GetSpellAbilityId()=='A04L'))then
		return false
	endif
	if(not(udg_BJPlaying[2]==true))then
...
function Trig_BJ_Dealers_Hit_2_Func008Func004001 takes nothing returns boolean
	return(udg_BJdanothCard[2]>=10)
endfunction
function Trig_BJ_Dealers_Hit_2_Func008Func009C takes nothing returns boolean
	if(not(udg_BJDealersNO[2]==1))then
		return false
	endif
	if(not(udg_BJdanothCard[2]==10))then
		return false
	endif
	if(not(udg_BJDfin[2]==false))then
		return false
	endif
	if(not(udg_BJDfinHit[2]==false))then
		return false
	endif
	if(not(udg_BJD1stHit[2]==true))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Dealers_Hit_2_Func008Func010C takes nothing returns boolean
	if(not(udg_BJDealersNO[2]==10))then
		return false
	endif
	if(not(udg_BJdanothCard[2]==1))then
		return false
	endif
	if(not(udg_BJD1stHit[2]==true))then
		return false
...
function Trig_BJ_Dealers_Hit_2_Func008Func013Func003003001 takes nothing returns boolean
	return(udg_BJDealersNO[2]==GetForLoopIndexA())
endfunction
function Trig_BJ_Dealers_Hit_2_Func008Func013Func007C takes nothing returns boolean
	if(not(udg_BJDealersNO[2]<=21))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Dealers_Hit_2_Func008Func013C takes nothing returns boolean
	if(not(udg_BJDealersNO[2]>=11))then
		return false
	endif
	if(not(udg_BJdanothCard[2]==1))then
		return false
...
function Trig_BJ_Dealers_Hit_2_Func008Func014Func003003001 takes nothing returns boolean
	return(udg_BJDealersNO[2]==GetForLoopIndexA())
endfunction
function Trig_BJ_Dealers_Hit_2_Func008Func014Func007C takes nothing returns boolean
	if(not(udg_BJDealersNO[2]<=21))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Dealers_Hit_2_Func008Func014C takes nothing returns boolean
	if(not(udg_BJDealersNO[2]<=10))then
		return false
	endif
	if(not(udg_BJdanothCard[2]==1))then
...
function Trig_BJ_Dealers_Hit_2_Func008Func016Func003001 takes nothing returns boolean
	return(udg_BJDealersNO[2]==1)
endfunction
function Trig_BJ_Dealers_Hit_2_Func008Func016Func006003001 takes nothing returns boolean
	return(udg_BJDealersNO[2]==GetForLoopIndexA())
endfunction
function Trig_BJ_Dealers_Hit_2_Func008Func016Func007001 takes nothing returns boolean
	return(udg_BJDealersNO[2]>=22)
endfunction
function Trig_BJ_Dealers_Hit_2_Func008Func016Func011C takes nothing returns boolean
	if(not(udg_BJDealersNO[2]<=21))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Dealers_Hit_2_Func008Func016C takes nothing returns boolean
	if(not(udg_BJDfin[2]==false))then
		return false
	endif
	if(not(udg_BJDfinHit[2]==false))then
...
function Trig_BJ_Dealers_Hit_2_Func008Func019Func005C takes nothing returns boolean
	if(not(udg_BJPlayerNO[2]==22))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Dealers_Hit_2_Func008Func019C takes nothing returns boolean
	if(not(udg_BJDfinHit[2]==true))then
		return false
	endif
	if(not(udg_BJDfin[2]==false))then
		return false
	endif
	if(not(udg_BJDealersNO[2]>=22))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Dealers_Hit_2_Func008Func021C takes nothing returns boolean
	if(not(udg_BJDfinHit[2]==true))then
		return false
	endif
	if(not(udg_BJDfin[2]==false))then
	...
	if(not(udg_BJDealersNO[2]<=16))then
		return false
	endif
	if(not(udg_BJDealersNO[2]!=0))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Dealers_Hit_2_Func008Func023C takes nothing returns boolean
	if(not(udg_BJDfinHit[2]==true))then
		return false
	endif
	if(not(udg_BJDealersNO[2]>=17))then
		return false
	endif
	if(not(udg_BJDealersNO[2]<=21))then
		return false
...
function Trig_BJ_Dealers_Hit_2_Func008C takes nothing returns boolean
	if(not(udg_BJDealersNO[2]>=1))then
		return false
	endif
	if(not(udg_BJDealersNO[2]<=16))then
...
function Trig_BJ_Dealers_Hit_2_Actions takes nothing returns nothing
	set udg_BJplayersTurnHit[2]=false
	set udg_BJCanHit[2]=false
	call DisableTrigger(GetTriggeringTrigger())
	if(Trig_BJ_Dealers_Hit_2_Func008C())then
		call TriggerSleepAction(1.75)
		set udg_BJDfinHit[2]=false
		set udg_BJdanothCard[2]=GetRandomInt(1,13)
		if(Trig_BJ_Dealers_Hit_2_Func008Func004001())then
			set udg_BJdanothCard[2]=10
		else
			call DoNothing()
		endif
		set bj_forLoopAIndex=1
		...
		loop
			exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
			call UnitRemoveAbilityBJ(udg_CardsD[GetForLoopIndexA()],udg_BJTable[2])
			set bj_forLoopAIndex=bj_forLoopAIndex+1
		endloop
		call TriggerSleepAction(0.25)
		call PlaySoundAtPointBJ(gg_snd_Hit,100,GetUnitLoc(udg_BJTable[2]),0)
		if(Trig_BJ_Dealers_Hit_2_Func008Func009C())then
			set udg_BJDfinHit[2]=true
			set udg_BJDealersNO[2]=22
			set udg_BJDfin[2]=true
			call UnitAddAbilityBJ('A056',udg_BJTable[2])
			call CreateTextTagLocBJ("I HAVE BLACKJACK!",GetUnitLoc(gg_unit_h048_0056),0,10,100,100.00,100.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
			call TriggerSleepAction(2)
			call ConditionalTriggerExecute(gg_trg_BJ_PlayerDealer_Runoff_2)
		else
		endif
		if(Trig_BJ_Dealers_Hit_2_Func008Func010C())then
			set udg_BJDfinHit[2]=true
			set udg_BJDfin[2]=true
			set udg_BJDealersNO[2]=22
			call UnitAddAbilityBJ('A056',udg_BJTable[2])
		...
		set udg_BJD1stHit[2]=false
		if(Trig_BJ_Dealers_Hit_2_Func008Func013C())then
			set udg_BJDealersNO[2]=(udg_BJDealersNO[2]+11)
			set udg_BJDfinHit[2]=true
			set bj_forLoopAIndex=1
			set bj_forLoopAIndexEnd=21
			loop
				exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
				if(Trig_BJ_Dealers_Hit_2_Func008Func013Func003003001())then
					call UnitAddAbilityBJ(udg_CardsD[GetForLoopIndexA()],udg_BJTable[2])
				else
					call DoNothing()
				endif
				set bj_forLoopAIndex=bj_forLoopAIndex+1
			endloop
			call CreateTextTagLocBJ("I hit an ace!",GetUnitLoc(gg_unit_h048_0056),0,10,100,100.00,100.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
			if(Trig_BJ_Dealers_Hit_2_Func008Func013Func007C())then
				call CreateTextTagLocBJ(("Dealer Has "+I2S(udg_BJDealersNO[2])),GetUnitLoc(udg_BJTable[2]),0,10,100,100.00,100.00,0)
				call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
				call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
			else
			endif
		...
		if(Trig_BJ_Dealers_Hit_2_Func008Func014C())then
			set udg_BJDealersNO[2]=(udg_BJDealersNO[2]+11)
			set udg_BJDfinHit[2]=true
			set bj_forLoopAIndex=1
			set bj_forLoopAIndexEnd=21
			loop
				exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
				if(Trig_BJ_Dealers_Hit_2_Func008Func014Func003003001())then
					call UnitAddAbilityBJ(udg_CardsD[GetForLoopIndexA()],udg_BJTable[2])
				else
					call DoNothing()
				endif
			...
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
			if(Trig_BJ_Dealers_Hit_2_Func008Func014Func007C())then
				call CreateTextTagLocBJ(("Dealer Has "+I2S(udg_BJDealersNO[2])),GetUnitLoc(udg_BJTable[2]),0,10,100,100.00,100.00,0)
				call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
				call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
			else
		...
		if(Trig_BJ_Dealers_Hit_2_Func008Func016C())then
			set udg_BJplayersTurnHit[2]=true
			set udg_BJDfinHit[2]=true
			if(Trig_BJ_Dealers_Hit_2_Func008Func016Func003001())then
				set udg_BJDealersNO[2]=11
			else
				call DoNothing()
			endif
			set udg_BJDealersNO[2]=(udg_BJDealersNO[2]+udg_BJdanothCard[2])
			call TriggerSleepAction(0.25)
			set bj_forLoopAIndex=1
			set bj_forLoopAIndexEnd=21
			loop
				exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
				if(Trig_BJ_Dealers_Hit_2_Func008Func016Func006003001())then
					call UnitAddAbilityBJ(udg_CardsD[GetForLoopIndexA()],udg_BJTable[2])
				else
					call DoNothing()
				endif
				set bj_forLoopAIndex=bj_forLoopAIndex+1
			endloop
			if(Trig_BJ_Dealers_Hit_2_Func008Func016Func007001())then
				call UnitAddAbilityBJ('A05I',udg_BJTable[2])
			else
				call DoNothing()
			endif
			call CreateTextTagLocBJ(("I hit a "+I2S(udg_BJdanothCard[2])),GetUnitLoc(gg_unit_h048_0056),0,10,100,100.00,100.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
			if(Trig_BJ_Dealers_Hit_2_Func008Func016Func011C())then
				call CreateTextTagLocBJ(("Dealer Has "+I2S(udg_BJDealersNO[2])),GetUnitLoc(udg_BJTable[2]),0,10,100,100.00,100.00,0)
				call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
				call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
			else
		...
		call TriggerSleepAction(2)
		if(Trig_BJ_Dealers_Hit_2_Func008Func019C())then
			call CreateTextTagLocBJ("I have Busted!",GetUnitLoc(gg_unit_h048_0056),0,10,100,0.00,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
			call PlaySoundOnUnitBJ(gg_snd_Gold3sym,100,udg_BJTable[2])
			if(Trig_BJ_Dealers_Hit_2_Func008Func019Func005C())then
				call AdjustPlayerStateBJ(25,GetOwningPlayer(udg_BJTable[2]),PLAYER_STATE_RESOURCE_GOLD)
				call CreateTextTagLocBJ("Blackjack Pays 3 to 2",GetUnitLoc(udg_BJTable[2]),0,10,100,100.00,100.00,0)
				call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
				call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
				call CreateTextTagLocBJ("+25",GetUnitLoc(GroupPickRandomUnit(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_BJTable[2]),'h045'))),0,10,100,100.00,0.00,0)
				call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
				call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
			else
				call AdjustPlayerStateBJ(20,GetOwningPlayer(udg_BJTable[2]),PLAYER_STATE_RESOURCE_GOLD)
				call CreateTextTagLocBJ("+20",GetUnitLoc(GroupPickRandomUnit(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_BJTable[2]),'h045'))),0,10,100,100.00,0.00,0)
				call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
				call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
			endif
			set udg_BJDfin[2]=true
			...
			set udg_BJDfin[2]=true
			call TriggerSleepAction(0.05)
			call ConditionalTriggerExecute(gg_trg_BJ_Reset_BJ_2)
		else
		endif
		if(Trig_BJ_Dealers_Hit_2_Func008Func021C())then
			call CreateTextTagLocBJ("I will hit again...",GetUnitLoc(gg_unit_h048_0056),0,10,100,0.00,100.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
			call EnableTrigger(GetTriggeringTrigger())
			call TriggerExecute(GetTriggeringTrigger())
		...
		if(Trig_BJ_Dealers_Hit_2_Func008Func023C())then
			set udg_BJDfin[2]=true
			call CreateTextTagLocBJ(("I will stay on "+I2S(udg_BJDealersNO[2])),GetUnitLoc(gg_unit_h048_0056),0,10,0.00,100.00,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
			call ConditionalTriggerExecute(gg_trg_BJ_PlayerDealer_Runoff_2)
		else
...
function InitTrig_BJ_Dealers_Hit_2 takes nothing returns nothing
	set gg_trg_BJ_Dealers_Hit_2=CreateTrigger()
	call TriggerRegisterUnitEvent(gg_trg_BJ_Dealers_Hit_2,gg_unit_h047_0055,EVENT_UNIT_SPELL_CAST)
	call TriggerAddCondition(gg_trg_BJ_Dealers_Hit_2,Condition(function Trig_BJ_Dealers_Hit_2_Conditions))
	call TriggerAddAction(gg_trg_BJ_Dealers_Hit_2,function Trig_BJ_Dealers_Hit_2_Actions)
endfunction
function Trig_BJ_Reset_BJ_2_Actions takes nothing returns nothing
	set udg_BJplayersTurnHit[2]=true
	set udg_BJCanHit[2]=true
	set udg_BJD1stHit[2]=true
	set udg_BJhitTurnFIN[2]=false
	set udg_BJDealersNO[2]=0
	set udg_BJDfin[2]=false
	set udg_BJPfin[2]=false
	set udg_BJPlayerNO[2]=0
	set udg_BJPlaying[2]=false
	set bj_forLoopAIndex=1
	set bj_forLoopAIndexEnd=25
	loop
		exitwhen bj_forLoopAIndex>bj_forLoopAIndexEnd
	...
	loop
		...
		set bj_forLoopAIndex=bj_forLoopAIndex+1
	endloop
	call EnableTrigger(gg_trg_BJ_Player_Stays_2)
	call EnableTrigger(gg_trg_BJ_Dealers_Hit_2)
endfunction
function InitTrig_BJ_Reset_BJ_2 takes nothing returns nothing
	set gg_trg_BJ_Reset_BJ_2=CreateTrigger()
	call TriggerAddAction(gg_trg_BJ_Reset_BJ_2,function Trig_BJ_Reset_BJ_2_Actions)
endfunction
function Trig_BJ_Player_Stays_2_Conditions takes nothing returns boolean
	if(not(GetSpellAbilityId()=='A04L'))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Player_Stays_2_Func003C takes nothing returns boolean
	if(not(udg_BJDealersNO[2]==1))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Player_Stays_2_Func005C takes nothing returns boolean
	if(not(udg_BJPlayerNO[2]<=21))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Player_Stays_2_Func006C takes nothing returns boolean
	if(not(udg_BJPlayerNO[2]==22))then
		return false
	endif
	return true
endfunction
function Trig_BJ_Player_Stays_2_Actions takes nothing returns nothing
	call DisableTrigger(GetTriggeringTrigger())
	call PlaySoundOnUnitBJ(gg_snd_Stay,100,udg_BJTable[2])
	if(Trig_BJ_Player_Stays_2_Func003C())then
		call CreateTextTagLocBJ("Dealer has an Ace",GetUnitLoc(udg_BJTable[2]),0,10,100,100.00,100.00,0)
		call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
		call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
	else
		call CreateTextTagLocBJ(("Dealer has "+I2S(udg_BJDealersNO[2])),GetUnitLoc(udg_BJTable[2]),0,10,100,100.00,100.00,0)
	...
	call TriggerSleepAction(0.50)
	if(Trig_BJ_Player_Stays_2_Func005C())then
		call CreateTextTagLocBJ(("I'll Stay on "+I2S(udg_BJPlayerNO[2])),GetUnitLoc(GroupPickRandomUnit(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_BJTable[2]),'h045'))),0,10,100,100.00,100.00,0)
		call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
		call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
	else
	endif
	if(Trig_BJ_Player_Stays_2_Func006C())then
		call CreateTextTagLocBJ("I'll Stay on BlackJack Ofcourse!",GetUnitLoc(GroupPickRandomUnit(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_BJTable[2]),'h045'))),0,10,100,100.00,100.00,0)
		call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
		call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
	else
	endif
endfunction
function InitTrig_BJ_Player_Stays_2 takes nothing returns nothing
	set gg_trg_BJ_Player_Stays_2=CreateTrigger()
	call TriggerRegisterUnitEvent(gg_trg_BJ_Player_Stays_2,gg_unit_h047_0055,EVENT_UNIT_SPELL_CAST)
	call TriggerAddCondition(gg_trg_BJ_Player_Stays_2,Condition(function Trig_BJ_Player_Stays_2_Conditions))
	call TriggerAddAction(gg_trg_BJ_Player_Stays_2,function Trig_BJ_Player_Stays_2_Actions)
endfunction
function Trig_BJ_PlayerDealer_Runoff_2_Func003C takes nothing returns boolean
	if(not(udg_BJPlayerNO[2]!=22))then
		return false
	endif
	return true
endfunction
function Trig_BJ_PlayerDealer_Runoff_2_Func004C takes nothing returns boolean
	if(not(udg_BJPlayerNO[2]==22))then
		return false
	endif
	return true
endfunction
function Trig_BJ_PlayerDealer_Runoff_2_Func006C takes nothing returns boolean
	if(not(udg_BJDealersNO[2]==22))then
		return false
	endif
	return true
endfunction
function Trig_BJ_PlayerDealer_Runoff_2_Func007C takes nothing returns boolean
	if(not(udg_BJDealersNO[2]!=22))then
		return false
	endif
	return true
endfunction
function Trig_BJ_PlayerDealer_Runoff_2_Func010C takes nothing returns boolean
	if(not(udg_BJDealersNO[2]==udg_BJPlayerNO[2]))then
		return false
	endif
	return true
endfunction
function Trig_BJ_PlayerDealer_Runoff_2_Func012C takes nothing returns boolean
	if(not(udg_BJDealersNO[2]>udg_BJPlayerNO[2]))then
		return false
	endif
	return true
endfunction
function Trig_BJ_PlayerDealer_Runoff_2_Func014Func003C takes nothing returns boolean
	if(not(udg_BJPlayerNO[2]==22))then
		return false
	endif
	return true
endfunction
function Trig_BJ_PlayerDealer_Runoff_2_Func014Func004C takes nothing returns boolean
	if(not(udg_BJPlayerNO[2]!=22))then
		return false
	endif
	return true
endfunction
function Trig_BJ_PlayerDealer_Runoff_2_Func014C takes nothing returns boolean
	if(not(udg_BJDealersNO[2]<udg_BJPlayerNO[2]))then
		return false
	endif
	return true
endfunction
function Trig_BJ_PlayerDealer_Runoff_2_Actions takes nothing returns nothing
	call TriggerSleepAction(1.00)
	call TriggerSleepAction(1.00)
	if(Trig_BJ_PlayerDealer_Runoff_2_Func003C())then
		call CreateTextTagLocBJ(("You Have "+I2S(udg_BJPlayerNO[2])),GetUnitLoc(udg_BJTable[2]),0,10,100,100.00,100.00,0)
		call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
		call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
	else
	endif
	if(Trig_BJ_PlayerDealer_Runoff_2_Func004C())then
		call CreateTextTagLocBJ(("You Have "+"BLACKJACK!"),GetUnitLoc(udg_BJTable[2]),0,10,100,100.00,100.00,0)
		call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
		call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
	else
	endif
	call TriggerSleepAction(0.50)
	if(Trig_BJ_PlayerDealer_Runoff_2_Func006C())then
		call CreateTextTagLocBJ(("Dealer has "+"BLACKJACK"),GetUnitLoc(gg_unit_h048_0056),0,10,100,100.00,100.00,0)
		call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
		call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
	else
	endif
	if(Trig_BJ_PlayerDealer_Runoff_2_Func007C())then
		call CreateTextTagLocBJ(("Dealer has "+I2S(udg_BJDealersNO[2])),GetUnitLoc(gg_unit_h048_0056),0,10,100,100.00,100.00,0)
		call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
		call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
	else
	endif
	call TriggerSleepAction(2)
	if(Trig_BJ_PlayerDealer_Runoff_2_Func010C())then
		call TriggerSleepAction(1.00)
		call CreateTextTagLocBJ("+10 Gold",GetUnitLoc(GroupPickRandomUnit(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_BJTable[2]),'h045'))),0,10,100,100.00,0.00,0)
		call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
		call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
		call CreateTextTagLocBJ("Stand off - returning 10 gold",GetUnitLoc(gg_unit_h048_0056),0,10,100,100.00,100.00,0)
		call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
		call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
		call AdjustPlayerStateBJ(10,GetOwningPlayer(udg_BJTable[2]),PLAYER_STATE_RESOURCE_GOLD)
		call ConditionalTriggerExecute(gg_trg_BJ_Reset_BJ_2)
		call PlaySoundOnUnitBJ(gg_snd_StandOff,75.00,udg_BJTable[2])
	else
	endif
	if(Trig_BJ_PlayerDealer_Runoff_2_Func012C())then
		call TriggerSleepAction(1.00)
		call PlaySoundOnUnitBJ(gg_snd_PlayerBust,100,gg_unit_h048_0056)
		call CreateTextTagLocBJ("I WIN!!",GetUnitLoc(gg_unit_h048_0056),0,10,100,0.00,0.00,0)
		call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
		call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
		call ConditionalTriggerExecute(gg_trg_BJ_Reset_BJ_2)
	else
	endif
	if(Trig_BJ_PlayerDealer_Runoff_2_Func014C())then
		call TriggerSleepAction(1.00)
		call PlaySoundOnUnitBJ(gg_snd_Gold3sym,100,udg_BJTable[2])
		if(Trig_BJ_PlayerDealer_Runoff_2_Func014Func003C())then
			call CreateTextTagLocBJ("+25 Gold",GetUnitLoc(GroupPickRandomUnit(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_BJTable[2]),'h045'))),0,10,100,100.00,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
			call CreateTextTagLocBJ("BlackJack Pays 3 to 2! Nice!",GetUnitLoc(gg_unit_h048_0056),0,10,0.00,100.00,100.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
			call AdjustPlayerStateBJ(25,GetOwningPlayer(udg_BJTable[2]),PLAYER_STATE_RESOURCE_GOLD)
		else
		endif
		if(Trig_BJ_PlayerDealer_Runoff_2_Func014Func004C())then
			call CreateTextTagLocBJ("+20 Gold",GetUnitLoc(GroupPickRandomUnit(GetUnitsOfPlayerAndTypeId(GetOwningPlayer(udg_BJTable[2]),'h045'))),0,10,100,100.00,0.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),2.00)
			call CreateTextTagLocBJ("You win, Well done!",GetUnitLoc(gg_unit_h048_0056),0,10,100,100.00,100.00,0)
			call SetTextTagPermanentBJ(GetLastCreatedTextTag(),false)
			call SetTextTagLifespanBJ(GetLastCreatedTextTag(),3.00)
			call AdjustPlayerStateBJ(20,GetOwningPlayer(udg_BJTable[2]),PLAYER_STATE_RESOURCE_GOLD)
		else
...
function InitTrig_BJ_PlayerDealer_Runoff_2 takes nothing returns nothing
	set gg_trg_BJ_PlayerDealer_Runoff_2=CreateTrigger()
...
function Trig_Finish_Build_Race_P1_Func017002001002001002001 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h045')
endfunction
function Trig_Finish_Build_Race_P1_Func017002001002001002002001 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h047')
endfunction
function Trig_Finish_Build_Race_P1_Func017002001002001002002002 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h043')
endfunction
function Trig_Finish_Build_Race_P1_Func017002001002001002002 takes nothing returns boolean
	return GetBooleanAnd(Trig_Finish_Build_Race_P1_Func017002001002001002002001(),Trig_Finish_Build_Race_P1_Func017002001002001002002002())
endfunction
function Trig_Finish_Build_Race_P1_Func017002001002001002 takes nothing returns boolean
	return GetBooleanAnd(Trig_Finish_Build_Race_P1_Func017002001002001002001(),Trig_Finish_Build_Race_P1_Func017002001002001002002())
endfunction
function Trig_Finish_Build_Race_P1_Func017002001002001 takes nothing returns boolean
	return GetBooleanAnd(Trig_Finish_Build_Race_P1_Func017002001002001001(),Trig_Finish_Build_Race_P1_Func017002001002001002())
endfunction
...
function Trig_Finish_Build_Race_P2_Func017002001002001002001 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h045')
endfunction
function Trig_Finish_Build_Race_P2_Func017002001002001002002001 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h047')
endfunction
function Trig_Finish_Build_Race_P2_Func017002001002001002002002 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h043')
endfunction
function Trig_Finish_Build_Race_P2_Func017002001002001002002 takes nothing returns boolean
	return GetBooleanAnd(Trig_Finish_Build_Race_P2_Func017002001002001002002001(),Trig_Finish_Build_Race_P2_Func017002001002001002002002())
endfunction
function Trig_Finish_Build_Race_P2_Func017002001002001002 takes nothing returns boolean
	return GetBooleanAnd(Trig_Finish_Build_Race_P2_Func017002001002001002001(),Trig_Finish_Build_Race_P2_Func017002001002001002002())
endfunction
function Trig_Finish_Build_Race_P2_Func017002001002001 takes nothing returns boolean
	return GetBooleanAnd(Trig_Finish_Build_Race_P2_Func017002001002001001(),Trig_Finish_Build_Race_P2_Func017002001002001002())
endfunction
...
function Trig_Finish_Build_Race_P3_Func017002001002001002001 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h045')
endfunction
function Trig_Finish_Build_Race_P3_Func017002001002001002002001 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h047')
endfunction
function Trig_Finish_Build_Race_P3_Func017002001002001002002002 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h043')
endfunction
function Trig_Finish_Build_Race_P3_Func017002001002001002002 takes nothing returns boolean
	return GetBooleanAnd(Trig_Finish_Build_Race_P3_Func017002001002001002002001(),Trig_Finish_Build_Race_P3_Func017002001002001002002002())
endfunction
function Trig_Finish_Build_Race_P3_Func017002001002001002 takes nothing returns boolean
	return GetBooleanAnd(Trig_Finish_Build_Race_P3_Func017002001002001002001(),Trig_Finish_Build_Race_P3_Func017002001002001002002())
endfunction
function Trig_Finish_Build_Race_P3_Func017002001002001 takes nothing returns boolean
	return GetBooleanAnd(Trig_Finish_Build_Race_P3_Func017002001002001001(),Trig_Finish_Build_Race_P3_Func017002001002001002())
endfunction
...
function Trig_Finish_Build_Race_P4_Func017002001002001002001 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h045')
endfunction
function Trig_Finish_Build_Race_P4_Func017002001002001002002001 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h047')
endfunction
function Trig_Finish_Build_Race_P4_Func017002001002001002002002 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h043')
endfunction
function Trig_Finish_Build_Race_P4_Func017002001002001002002 takes nothing returns boolean
	return GetBooleanAnd(Trig_Finish_Build_Race_P4_Func017002001002001002002001(),Trig_Finish_Build_Race_P4_Func017002001002001002002002())
endfunction
function Trig_Finish_Build_Race_P4_Func017002001002001002 takes nothing returns boolean
	return GetBooleanAnd(Trig_Finish_Build_Race_P4_Func017002001002001002001(),Trig_Finish_Build_Race_P4_Func017002001002001002002())
endfunction
function Trig_Finish_Build_Race_P4_Func017002001002001 takes nothing returns boolean
	return GetBooleanAnd(Trig_Finish_Build_Race_P4_Func017002001002001001(),Trig_Finish_Build_Race_P4_Func017002001002001002())
endfunction
...
function Trig_Finish_Build_Race_P5_Func017002001002001002001 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h045')
endfunction
function Trig_Finish_Build_Race_P5_Func017002001002001002002001 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h047')
endfunction
function Trig_Finish_Build_Race_P5_Func017002001002001002002002 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h043')
endfunction
function Trig_Finish_Build_Race_P5_Func017002001002001002002 takes nothing returns boolean
	return GetBooleanAnd(Trig_Finish_Build_Race_P5_Func017002001002001002002001(),Trig_Finish_Build_Race_P5_Func017002001002001002002002())
endfunction
function Trig_Finish_Build_Race_P5_Func017002001002001002 takes nothing returns boolean
	return GetBooleanAnd(Trig_Finish_Build_Race_P5_Func017002001002001002001(),Trig_Finish_Build_Race_P5_Func017002001002001002002())
endfunction
function Trig_Finish_Build_Race_P5_Func017002001002001 takes nothing returns boolean
	return GetBooleanAnd(Trig_Finish_Build_Race_P5_Func017002001002001001(),Trig_Finish_Build_Race_P5_Func017002001002001002())
endfunction
...
function Trig_Finish_Build_Race_P6_Func017002001002001002001 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h045')
endfunction
function Trig_Finish_Build_Race_P6_Func017002001002001002002001 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h047')
endfunction
function Trig_Finish_Build_Race_P6_Func017002001002001002002002 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h043')
endfunction
function Trig_Finish_Build_Race_P6_Func017002001002001002002 takes nothing returns boolean
	return GetBooleanAnd(Trig_Finish_Build_Race_P6_Func017002001002001002002001(),Trig_Finish_Build_Race_P6_Func017002001002001002002002())
endfunction
function Trig_Finish_Build_Race_P6_Func017002001002001002 takes nothing returns boolean
	return GetBooleanAnd(Trig_Finish_Build_Race_P6_Func017002001002001002001(),Trig_Finish_Build_Race_P6_Func017002001002001002002())
endfunction
function Trig_Finish_Build_Race_P6_Func017002001002001 takes nothing returns boolean
	return GetBooleanAnd(Trig_Finish_Build_Race_P6_Func017002001002001001(),Trig_Finish_Build_Race_P6_Func017002001002001002())
endfunction
...
function Trig_Finish_Build_Race_P7_Func017002001002001002001 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h045')
endfunction
function Trig_Finish_Build_Race_P7_Func017002001002001002002001 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h047')
endfunction
function Trig_Finish_Build_Race_P7_Func017002001002001002002002 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h043')
endfunction
function Trig_Finish_Build_Race_P7_Func017002001002001002002 takes nothing returns boolean
	return GetBooleanAnd(Trig_Finish_Build_Race_P7_Func017002001002001002002001(),Trig_Finish_Build_Race_P7_Func017002001002001002002002())
endfunction
function Trig_Finish_Build_Race_P7_Func017002001002001002 takes nothing returns boolean
	return GetBooleanAnd(Trig_Finish_Build_Race_P7_Func017002001002001002001(),Trig_Finish_Build_Race_P7_Func017002001002001002002())
endfunction
function Trig_Finish_Build_Race_P7_Func017002001002001 takes nothing returns boolean
	return GetBooleanAnd(Trig_Finish_Build_Race_P7_Func017002001002001001(),Trig_Finish_Build_Race_P7_Func017002001002001002())
endfunction
...
function Trig_Finish_Build_Race_P8_Func017002001002001002001 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h045')
endfunction
function Trig_Finish_Build_Race_P8_Func017002001002001002002001 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h047')
endfunction
function Trig_Finish_Build_Race_P8_Func017002001002001002002002 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h043')
endfunction
function Trig_Finish_Build_Race_P8_Func017002001002001002002 takes nothing returns boolean
	return GetBooleanAnd(Trig_Finish_Build_Race_P8_Func017002001002001002002001(),Trig_Finish_Build_Race_P8_Func017002001002001002002002())
endfunction
function Trig_Finish_Build_Race_P8_Func017002001002001002 takes nothing returns boolean
	return GetBooleanAnd(Trig_Finish_Build_Race_P8_Func017002001002001002001(),Trig_Finish_Build_Race_P8_Func017002001002001002002())
endfunction
function Trig_Finish_Build_Race_P8_Func017002001002001 takes nothing returns boolean
	return GetBooleanAnd(Trig_Finish_Build_Race_P8_Func017002001002001001(),Trig_Finish_Build_Race_P8_Func017002001002001002())
endfunction
...
function Trig_New_Level_P1_Func016001002001002002001 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h045')
endfunction
function Trig_New_Level_P1_Func016001002001002002002001 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h043')
endfunction
function Trig_New_Level_P1_Func016001002001002002002002 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h047')
endfunction
function Trig_New_Level_P1_Func016001002001002002002 takes nothing returns boolean
	return GetBooleanAnd(Trig_New_Level_P1_Func016001002001002002002001(),Trig_New_Level_P1_Func016001002001002002002002())
endfunction
function Trig_New_Level_P1_Func016001002001002002 takes nothing returns boolean
	return GetBooleanAnd(Trig_New_Level_P1_Func016001002001002002001(),Trig_New_Level_P1_Func016001002001002002002())
endfunction
function Trig_New_Level_P1_Func016001002001002 takes nothing returns boolean
	return GetBooleanAnd(Trig_New_Level_P1_Func016001002001002001(),Trig_New_Level_P1_Func016001002001002002())
endfunction
...
function Trig_New_Level_P2_Func016001002001002002001 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h045')
endfunction
function Trig_New_Level_P2_Func016001002001002002002001 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h043')
endfunction
function Trig_New_Level_P2_Func016001002001002002002002 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h047')
endfunction
function Trig_New_Level_P2_Func016001002001002002002 takes nothing returns boolean
	return GetBooleanAnd(Trig_New_Level_P2_Func016001002001002002002001(),Trig_New_Level_P2_Func016001002001002002002002())
endfunction
function Trig_New_Level_P2_Func016001002001002002 takes nothing returns boolean
	return GetBooleanAnd(Trig_New_Level_P2_Func016001002001002002001(),Trig_New_Level_P2_Func016001002001002002002())
endfunction
function Trig_New_Level_P2_Func016001002001002 takes nothing returns boolean
	return GetBooleanAnd(Trig_New_Level_P2_Func016001002001002001(),Trig_New_Level_P2_Func016001002001002002())
endfunction
...
function Trig_New_Level_P3_Func016001002001002002001 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h045')
endfunction
function Trig_New_Level_P3_Func016001002001002002002001 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h043')
endfunction
function Trig_New_Level_P3_Func016001002001002002002002 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h047')
endfunction
function Trig_New_Level_P3_Func016001002001002002002 takes nothing returns boolean
	return GetBooleanAnd(Trig_New_Level_P3_Func016001002001002002002001(),Trig_New_Level_P3_Func016001002001002002002002())
endfunction
function Trig_New_Level_P3_Func016001002001002002 takes nothing returns boolean
	return GetBooleanAnd(Trig_New_Level_P3_Func016001002001002002001(),Trig_New_Level_P3_Func016001002001002002002())
endfunction
function Trig_New_Level_P3_Func016001002001002 takes nothing returns boolean
	return GetBooleanAnd(Trig_New_Level_P3_Func016001002001002001(),Trig_New_Level_P3_Func016001002001002002())
endfunction
...
function Trig_New_Level_P4_Func016001002001002002001 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h045')
endfunction
function Trig_New_Level_P4_Func016001002001002002002001 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h043')
endfunction
function Trig_New_Level_P4_Func016001002001002002002002 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h047')
endfunction
function Trig_New_Level_P4_Func016001002001002002002 takes nothing returns boolean
	return GetBooleanAnd(Trig_New_Level_P4_Func016001002001002002002001(),Trig_New_Level_P4_Func016001002001002002002002())
endfunction
function Trig_New_Level_P4_Func016001002001002002 takes nothing returns boolean
	return GetBooleanAnd(Trig_New_Level_P4_Func016001002001002002001(),Trig_New_Level_P4_Func016001002001002002002())
endfunction
function Trig_New_Level_P4_Func016001002001002 takes nothing returns boolean
	return GetBooleanAnd(Trig_New_Level_P4_Func016001002001002001(),Trig_New_Level_P4_Func016001002001002002())
endfunction
...
function Trig_New_Level_P5_Func016001002001002002001 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h045')
endfunction
function Trig_New_Level_P5_Func016001002001002002002001 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h043')
endfunction
function Trig_New_Level_P5_Func016001002001002002002002 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h047')
endfunction
function Trig_New_Level_P5_Func016001002001002002002 takes nothing returns boolean
	return GetBooleanAnd(Trig_New_Level_P5_Func016001002001002002002001(),Trig_New_Level_P5_Func016001002001002002002002())
endfunction
function Trig_New_Level_P5_Func016001002001002002 takes nothing returns boolean
	return GetBooleanAnd(Trig_New_Level_P5_Func016001002001002002001(),Trig_New_Level_P5_Func016001002001002002002())
endfunction
function Trig_New_Level_P5_Func016001002001002 takes nothing returns boolean
	return GetBooleanAnd(Trig_New_Level_P5_Func016001002001002001(),Trig_New_Level_P5_Func016001002001002002())
endfunction
...
function Trig_New_Level_P6_Func016001002001002002001 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h045')
endfunction
function Trig_New_Level_P6_Func016001002001002002002001 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h043')
endfunction
function Trig_New_Level_P6_Func016001002001002002002002 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h047')
endfunction
function Trig_New_Level_P6_Func016001002001002002002 takes nothing returns boolean
	return GetBooleanAnd(Trig_New_Level_P6_Func016001002001002002002001(),Trig_New_Level_P6_Func016001002001002002002002())
endfunction
function Trig_New_Level_P6_Func016001002001002002 takes nothing returns boolean
	return GetBooleanAnd(Trig_New_Level_P6_Func016001002001002002001(),Trig_New_Level_P6_Func016001002001002002002())
endfunction
function Trig_New_Level_P6_Func016001002001002 takes nothing returns boolean
	return GetBooleanAnd(Trig_New_Level_P6_Func016001002001002001(),Trig_New_Level_P6_Func016001002001002002())
endfunction
...
function Trig_New_Level_P7_Func016001002001002002001 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h045')
endfunction
function Trig_New_Level_P7_Func016001002001002002002001 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h043')
endfunction
function Trig_New_Level_P7_Func016001002001002002002002 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h047')
endfunction
function Trig_New_Level_P7_Func016001002001002002002 takes nothing returns boolean
	return GetBooleanAnd(Trig_New_Level_P7_Func016001002001002002002001(),Trig_New_Level_P7_Func016001002001002002002002())
endfunction
function Trig_New_Level_P7_Func016001002001002002 takes nothing returns boolean
	return GetBooleanAnd(Trig_New_Level_P7_Func016001002001002002001(),Trig_New_Level_P7_Func016001002001002002002())
endfunction
function Trig_New_Level_P7_Func016001002001002 takes nothing returns boolean
	return GetBooleanAnd(Trig_New_Level_P7_Func016001002001002001(),Trig_New_Level_P7_Func016001002001002002())
endfunction
...
function Trig_New_Level_P8_Func016001002001002002001 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h045')
endfunction
function Trig_New_Level_P8_Func016001002001002002002001 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h043')
endfunction
function Trig_New_Level_P8_Func016001002001002002002002 takes nothing returns boolean
	return(GetUnitTypeId(GetFilterUnit())!='h047')
endfunction
function Trig_New_Level_P8_Func016001002001002002002 takes nothing returns boolean
	return GetBooleanAnd(Trig_New_Level_P8_Func016001002001002002002001(),Trig_New_Level_P8_Func016001002001002002002002())
endfunction
function Trig_New_Level_P8_Func016001002001002002 takes nothing returns boolean
	return GetBooleanAnd(Trig_New_Level_P8_Func016001002001002002001(),Trig_New_Level_P8_Func016001002001002002002())
endfunction
function Trig_New_Level_P8_Func016001002001002 takes nothing returns boolean
	return GetBooleanAnd(Trig_New_Level_P8_Func016001002001002001(),Trig_New_Level_P8_Func016001002001002002())
endfunction
